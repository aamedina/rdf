...
(def alternate
  ...
  {:db/ident :xhv/alternate,
   :rdf/type :rdf/Property,
   :rdfa/term #xsd/string "alternate",
   :rdfa/uri #xsd/string "http://www.w3.org/1999/xhtml/vocab#alternate",
   :rdfs/comment
   #xsd/string "alternate \n    designates alternate versions for a resource.",
...
(def appendix
  ...
  {:db/ident :xhv/appendix,
   :rdf/type :rdf/Property,
   :rdfa/term #xsd/string "appendix",
   :rdfa/uri #xsd/string "http://www.w3.org/1999/xhtml/vocab#appendix",
   :rdfs/comment
   #xsd/string
    "appendix refers to a resource serving\n      as an appendix in a collection. ",
   :rdfs/member :xhv/relrev-properties})
...
(def bookmark
  ...
  {:db/ident :xhv/bookmark,
   :rdf/type :rdf/Property,
   :rdfa/term #xsd/string "bookmark",
   :rdfa/uri #xsd/string "http://www.w3.org/1999/xhtml/vocab#bookmark",
   :rdfs/comment
   #xsd/string
    "bookmark refers to a bookmark - a link\n      to a key entry point within an extended document. ",
   :rdfs/member :xhv/relrev-properties})
...
(def chapter
  ...
  {:db/ident :xhv/chapter,
   :rdf/type :rdf/Property,
   :rdfa/term #xsd/string "chapter",
   :rdfa/uri #xsd/string "http://www.w3.org/1999/xhtml/vocab#chapter",
   :rdfs/comment
   #xsd/string
    "chapter refers to a resource serving\n      as a chapter in a collection. ",
   :rdfs/member :xhv/relrev-properties})
...
(def cite
  ...
  {:db/ident     :xhv/cite,
   :rdf/type     :rdf/Property,
   :rdfa/term    #xsd/string "cite",
   :rdfa/uri     #xsd/string "http://www.w3.org/1999/xhtml/vocab#cite",
...
(def contents
  ...
  {:db/ident :xhv/contents,
   :rdf/type :rdf/Property,
   :rdfa/term #xsd/string "contents",
   :rdfa/uri #xsd/string "http://www.w3.org/1999/xhtml/vocab#contents",
   :rdfs/comment
   #xsd/string
    "contents refers to a resource serving\n      as a table of contents. ",
   :rdfs/member :xhv/relrev-properties})
...
(def copyright
  ...
  {:db/ident :xhv/copyright,
   :rdf/type :rdf/Property,
   :rdfa/term #xsd/string "copyright",
   :rdfa/uri #xsd/string "http://www.w3.org/1999/xhtml/vocab#copyright",
   :rdfs/comment
   #xsd/string
    "copyright refers to a copyright\n      statement for the resource. ",
   :rdfs/member :xhv/relrev-properties})
...
(def definition
  ...
  {:db/ident     :xhv/definition,
   :rdf/type     :rdf/Property,
   :rdfs/comment #xsd/string "indicates the definition of a term or concept.",
   :rdfs/member  :xhv/role-properties})
...
(def first
  ...
  {:db/ident :xhv/first,
   :rdf/type :rdf/Property,
   :rdfa/term #xsd/string "first",
   :rdfa/uri #xsd/string "http://www.w3.org/1999/xhtml/vocab#first",
   :rdfs/comment
   #xsd/string
    "first refers the first item in a\n      collection (see also start and top).",
   :rdfs/member :xhv/relrev-properties})
...
(def glossary
  ...
  {:db/ident :xhv/glossary,
   :rdf/type :rdf/Property,
   :rdfa/term #xsd/string "glossary",
   :rdfa/uri #xsd/string "http://www.w3.org/1999/xhtml/vocab#glossary",
   :rdfs/comment
   #xsd/string
    "glossary refers to a resource\n      providing a glossary of terms. ",
   :rdfs/member :xhv/relrev-properties})
...
(def gridcell
  ...
  {:db/ident     :xhv/gridcell,
   :rdf/type     :rdf/Property,
   :rdfs/comment #xsd/string "A cell\n      in a grid or treegrid."})
...
(def heading
  ...
  {:db/ident     :xhv/heading,
   :rdf/type     :rdf/Property,
   :rdfs/comment #xsd/string "A heading\n      for a section of the page."})

(def help
  "help refers to a resource offering\n      help. "
  {:db/ident     :xhv/help,
   :rdf/type     :rdf/Property,
   :rdfa/term    #xsd/string "help",
   :rdfa/uri     #xsd/string "http://www.w3.org/1999/xhtml/vocab#help",
   :rdfs/comment #xsd/string "help refers to a resource offering\n      help. ",
   :rdfs/member  :xhv/relrev-properties})
...
(def icon
  ...
  {:db/ident     :xhv/icon,
   :rdf/type     :rdf/Property,
   :rdfa/term    #xsd/string "icon",
   :rdfa/uri     #xsd/string "http://www.w3.org/1999/xhtml/vocab#icon",
   :rdfs/comment #xsd/string
                  "icon refers to a resource that\n      represents an icon. ",
   :rdfs/member  :xhv/relrev-properties})
...
(def index
  ...
  {:db/ident     :xhv/index,
   :rdf/type     :rdf/Property,
   :rdfa/term    #xsd/string "index",
   :rdfa/uri     #xsd/string "http://www.w3.org/1999/xhtml/vocab#index",
   :rdfs/comment #xsd/string
                  "index refers to a resource providing\n      an index. ",
   :rdfs/member  :xhv/relrev-properties})
...
(def itsRules
  ...
  {:db/ident :xhv/itsRules,
   :rdf/type :rdf/Property,
   :rdfa/term #xsd/string "itsRules",
   :rdfa/uri #xsd/string "http://www.w3.org/1999/xhtml/vocab#itsRules",
   :rdfs/comment
   #xsd/string
    "itsRules indicates that the designated\n      resource is an [ITS] rule set.",
   :rdfs/member :xhv/relrev-properties})
...
(def last
  ...
  {:db/ident :xhv/last,
   :rdf/type :rdf/Property,
   :rdfa/term #xsd/string "last",
   :rdfa/uri #xsd/string "http://www.w3.org/1999/xhtml/vocab#last",
   :rdfs/comment
   #xsd/string
    "last refers to the last resource in a\n      collection of resources. ",
   :rdfs/member :xhv/relrev-properties})
...
(def license
  ...
  {:db/ident :xhv/license,
   :rdf/type :rdf/Property,
   :rdfa/term #xsd/string "license",
   :rdfa/uri #xsd/string "http://www.w3.org/1999/xhtml/vocab#license",
   :rdfs/comment
   #xsd/string
    "license refers to a resource that\n      defines the associated license. ",
   :rdfs/member :xhv/relrev-properties})
...
(def listitem
  ...
  {:db/ident     :xhv/listitem,
   :rdf/type     :rdf/Property,
   :rdfs/comment #xsd/string "A single\n      item in a list or directory."})
...
(def meta
  ...
  {:db/ident     :xhv/meta,
   :rdf/type     :rdf/Property,
   :rdfa/term    #xsd/string "meta",
   :rdfa/uri     #xsd/string "http://www.w3.org/1999/xhtml/vocab#meta",
   :rdfs/comment #xsd/string
                  "meta refers to a resource that\n      provides metadata. ",
   :rdfs/member  :xhv/relrev-properties})
...
(def next
  ...
  {:db/ident :xhv/next,
   :rdf/type :rdf/Property,
   :rdfa/term #xsd/string "next",
   :rdfa/uri #xsd/string "http://www.w3.org/1999/xhtml/vocab#next",
   :rdfs/comment
   #xsd/string
    "next refers to the next resource\n      (after the current one) in an ordered collection of resources. ",
   :rdfs/member :xhv/relrev-properties})
...
(def option
  ...
  {:db/ident     :xhv/option,
   :rdf/type     :rdf/Property,
   :rdfs/comment #xsd/string "A selectable\n      item in a select list."})

(def p3pv1
  "p3pv1 refers to a P3P Policy Reference\n      File [P3P]. "
  {:db/ident     :xhv/p3pv1,
   :rdf/type     :rdf/Property,
   :rdfa/term    #xsd/string "p3pv1",
   :rdfa/uri     #xsd/string "http://www.w3.org/1999/xhtml/vocab#p3pv1",
   :rdfs/comment #xsd/string
                  "p3pv1 refers to a P3P Policy Reference\n      File [P3P]. ",
   :rdfs/member  :xhv/relrev-properties})
...
(def prev
  ...
  {:db/ident :xhv/prev,
   :rdf/type :rdf/Property,
   :rdfa/term #xsd/string "prev",
   :rdfa/uri #xsd/string "http://www.w3.org/1999/xhtml/vocab#prev",
   :rdfs/comment
   #xsd/string
    "prev refers to a previous resource\n      (before the current one) in an ordered collection of resources. ",
   :rdfs/member :xhv/relrev-properties})
...
(def radiogroup
  ...
  {:db/ident     :xhv/radiogroup,
   :rdf/type     :rdf/Property,
   :rdfs/comment #xsd/string "A group\n      of radio buttons."})
...
(def role
  ...
  {:db/ident :xhv/role,
   ...
   :rdfa/term #xsd/string "role",
   :rdfa/uri #xsd/string "http://www.w3.org/1999/xhtml/vocab#role",
   :rdfs/comment
   #xsd/string
    "role indicates the purpose of the\n      resource. See the XHTML Role\n      Vocabulary for roles in this vocabulary space, and XHTMLROLE for information on extending the\n      collection of roles. ",
   :rdfs/member :xhv/relrev-properties})
...
(def row
  ...
  {:db/ident     :xhv/row,
   :rdf/type     :rdf/Property,
   :rdfs/comment #xsd/string "A row of cells\n      in a grid."})
...
(def section
  ...
  {:db/ident :xhv/section,
   :rdf/type :rdf/Property,
   :rdfa/term #xsd/string "section",
   :rdfa/uri #xsd/string "http://www.w3.org/1999/xhtml/vocab#section",
   :rdfs/comment
   #xsd/string
    "section refers to a resource serving\n      as a section in a collection. ",
   :rdfs/member :xhv/relrev-properties})
...
(def start
  ...
  {:db/ident :xhv/start,
   :rdf/type :rdf/Property,
   :rdfa/term #xsd/string "start",
   :rdfa/uri #xsd/string "http://www.w3.org/1999/xhtml/vocab#start",
   :rdfs/comment
   #xsd/string
    "start refers to the first resource in\n      a collection of resources. ",
   :rdfs/member :xhv/relrev-properties})
...
(def stylesheet
  ...
  {:db/ident :xhv/stylesheet,
   :rdf/type :rdf/Property,
   :rdfa/term #xsd/string "stylesheet",
   :rdfa/uri #xsd/string "http://www.w3.org/1999/xhtml/vocab#stylesheet",
   :rdfs/comment
   #xsd/string
    "stylesheet refers to a resource\n      serving as a stylesheet for a resource. ",
   :rdfs/member :xhv/relrev-properties})
...
(def subsection
  ...
  {:db/ident :xhv/subsection,
   :rdf/type :rdf/Property,
   :rdfa/term #xsd/string "subsection",
   :rdfa/uri #xsd/string "http://www.w3.org/1999/xhtml/vocab#subsection",
   :rdfs/comment
   #xsd/string
    "subsection refers to a resource\n      serving as a subsection in a collection. ",
   :rdfs/member :xhv/relrev-properties})
...
(def top
  ...
  {:db/ident     :xhv/top,
   :rdf/type     :rdf/Property,
   :rdfa/term    #xsd/string "top",
   :rdfa/uri     #xsd/string "http://www.w3.org/1999/xhtml/vocab#top",
   :rdfs/comment #xsd/string "top is a synonym for start. ",
   :rdfs/member  :xhv/relrev-properties})
...
(def up
  ...
  {:db/ident :xhv/up,
   :rdf/type :rdf/Property,
   :rdfa/term #xsd/string "up",
   :rdfa/uri #xsd/string "http://www.w3.org/1999/xhtml/vocab#up",
   :rdfs/comment
   #xsd/string
    "up refers to a resource \"above\" in a\n      hierarchically structured set. ",
   :rdfs/member :xhv/relrev-properties})