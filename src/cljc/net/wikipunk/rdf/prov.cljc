...
(def Person
  ...
  {:db/ident :prov/Person,
   :prov/category "expanded",
   :prov/component "agents-responsibility",
   :prov/definition #rdf/langString "Person agents are people.@en",
   :prov/dm {:rdfa/uri
             "http://www.w3.org/TR/2013/REC-prov-dm-20130430/#term-agent"},
   :prov/n {:rdfa/uri
            "http://www.w3.org/TR/2013/REC-prov-n-20130430/#expression-types"},
...
(def SoftwareAgent
  ...
  {:db/ident :prov/SoftwareAgent,
   :prov/category "expanded",
   :prov/component "agents-responsibility",
   :prov/definition #rdf/langString "A software agent is running software.@en",
   :prov/dm {:rdfa/uri
             "http://www.w3.org/TR/2013/REC-prov-dm-20130430/#term-agent"},
   :prov/n {:rdfa/uri
            "http://www.w3.org/TR/2013/REC-prov-n-20130430/#expression-types"},
...
(def atLocation
  ...
  {:db/ident :prov/atLocation,
   ...
   :rdf/type :owl/ObjectProperty,
   :rdfs/comment
   [#rdf/langString "The Location of any resource.@en"
...
(def wasAttributedTo
  ...
  {:db/ident :prov/wasAttributedTo,
   ...
   :prov/component "agents-responsibility",
   :prov/definition
   #rdf/langString "Attribution is the ascribing of an entity to an agent.@en",
