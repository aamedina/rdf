(ns net.wikipunk.rdf.cco
  ...
  {:dc11/creator
   ...
   :dc11/title #xsd/langString "Cognitive Characteristics Ontology@en",
   :dcat/downloadURL
...
(def CharacteristicDynamics
  ...
  {:db/ident :cco/CharacteristicDynamics,
   ...
   :rdfs/label #xsd/langString "Characteristic Dynamics@en",
...
(def CognitiveCharacteristic
  ...
  {:db/ident :cco/CognitiveCharacteristic,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://purl.org/ontology/cco/core#"},
   :rdfs/label #xsd/langString "Cognitive Characteristic@en",
...
(def ExplicitMining
  ...
  {:db/ident         :cco/ExplicitMining,
   :dc11/description #xsd/langString "An explicitly mined cognitive pattern@en",
   :dc11/title       #xsd/langString "Explicit Mining@en",
...
(def ImplicitMining
  ...
  {:db/ident         :cco/ImplicitMining,
   :dc11/description #xsd/langString "An implicitly mined cognitive pattern@en",
   :dc11/title       #xsd/langString "Implicit Mining@en",
   :rdf/type         :scovo/Dimension,
   :rdfs/isDefinedBy {:rdfa/uri "http://purl.org/ontology/cco/core#"},
   :vs/term_status   #xsd/langString "testing@en"})
...
(def activity
  ...
  {:db/ident :cco/activity,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://purl.org/ontology/cco/core#"},
   :rdfs/label #xsd/langString "has activity@en",
...
(def appear_time
  ...
  {:db/ident :cco/appear_time,
   ...
   :rdfs/domain {:owl/unionOf [:cco/CognitiveCharacteristic
                 ...
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy {:rdfa/uri "http://purl.org/ontology/cco/core#"},
   :rdfs/label #xsd/langString "has appear time@en",
...
(def attention_duration
  ...
  {:db/ident           :cco/attention_duration,
   ...
   :rdfs/domain        :cco/CognitiveCharacteristic,
   :rdfs/isDefinedBy   {:rdfa/uri "http://purl.org/ontology/cco/core#"},
   :rdfs/label         #xsd/langString "has attention duration@en",
...
(def belief
  ...
  {:db/ident :cco/belief,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://purl.org/ontology/cco/core#"},
   :rdfs/label #xsd/langString "has belief@en",
...
(def characteristic
  ...
  {:db/ident :cco/characteristic,
   ...
   :rdfs/domain :cco/CognitiveCharacteristic,
   :rdfs/isDefinedBy {:rdfa/uri "http://purl.org/ontology/cco/core#"},
   :rdfs/label #xsd/langString "has characteristic@en",
...
(def characteristic_dynamics
  ...
  {:db/ident :cco/characteristic_dynamics,
   ...
   :rdfs/domain :cco/CognitiveCharacteristic,
   :rdfs/isDefinedBy {:rdfa/uri "http://purl.org/ontology/cco/core#"},
   :rdfs/label #xsd/langString "has characteristic dynamics@en",
...
(def cognitive_characteristic
  ...
  {:db/ident :cco/cognitive_characteristic,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://purl.org/ontology/cco/core#"},
   :rdfs/label #xsd/langString "has cognitive characteristic@en",
...
(def competence
  ...
  {:db/ident :cco/competence,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://purl.org/ontology/cco/core#"},
   :rdfs/label #xsd/langString "has competence@en",
...
(def evidence
  ...
  {:db/ident :cco/evidence,
   ...
   :rdfs/domain {:owl/unionOf [:cco/CognitiveCharacteristic
                 ...
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy {:rdfa/uri "http://purl.org/ontology/cco/core#"},
   :rdfs/label #xsd/langString "has evidence@en",
...
(def expertise
  ...
  {:db/ident :cco/expertise,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://purl.org/ontology/cco/core#"},
   :rdfs/label #xsd/langString "has expertise@en",
   :rdfs/subPropertyOf [:cco/competence :cco/cognitive_characteristic],
   :vs/term_status #xsd/langString "testing@en"})
...
(def habit
  ...
  {:db/ident :cco/habit,
   ...
   :rdfs/domain :foaf/Agent,
   :rdfs/isDefinedBy {:rdfa/uri "http://purl.org/ontology/cco/core#"},
   :rdfs/label #xsd/langString "has habit@en",
...
(def interest
  ...
  {:db/ident :cco/interest,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://purl.org/ontology/cco/core#"},
   :rdfs/label #xsd/langString "has interest@en",
   :rdfs/subPropertyOf :cco/cognitive_characteristic,
   :vs/term_status #xsd/langString "testing@en"})
...
(def longest_duration
  ...
  {:db/ident :cco/longest_duration,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://purl.org/ontology/cco/core#"},
   :rdfs/label #xsd/langString "has longest duration@en",
...
(def not_interested_in
  ...
  {:db/ident :cco/not_interested_in,
   ...
   :rdfs/domain :foaf/Agent,
   :rdfs/isDefinedBy {:rdfa/uri "http://purl.org/ontology/cco/core#"},
   :rdfs/label #xsd/langString "is not interested in@en",
   :rdfs/range :owl/Thing,
   :vs/term_status #xsd/langString "unstable@en"})
...
(def overall_weight
  ...
  {:db/ident :cco/overall_weight,
   ...
   :rdfs/domain :cco/CognitiveCharacteristic,
   :rdfs/isDefinedBy {:rdfa/uri "http://purl.org/ontology/cco/core#"},
   :rdfs/label #xsd/langString "has overall weight@en",
...
(def setting
  ...
  {:db/ident :cco/setting,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://purl.org/ontology/cco/core#"},
   :rdfs/label #xsd/langString "has setting@en",
   :rdfs/subPropertyOf :cco/cognitive_characteristic,
   :vs/term_status #xsd/langString "testing@en"})
...
(def skill
  ...
  {:db/ident :cco/skill,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://purl.org/ontology/cco/core#"},
   :rdfs/label #xsd/langString "has skill@en",
   :rdfs/subPropertyOf [:cco/competence :cco/cognitive_characteristic],
   :vs/term_status #xsd/langString "testing@en"})
...
(def statistical_item
  ...
  {:db/ident :cco/statistical_item,
   ...
   :rdfs/domain :cco/CognitiveCharacteristic,
   :rdfs/isDefinedBy {:rdfa/uri "http://purl.org/ontology/cco/core#"},
   :rdfs/label #xsd/langString "has statistical item@en",
...
(def topic
  ...
  {:db/ident           :cco/topic,
   ...
   :rdfs/domain        :cco/CognitiveCharacteristic,
   :rdfs/isDefinedBy   {:rdfa/uri "http://purl.org/ontology/cco/core#"},
   :rdfs/label         #xsd/langString "has topic@en",
   :rdfs/range         :owl/Thing,
...
(def ultimative_duration
  ...
  {:db/ident :cco/ultimative_duration,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://purl.org/ontology/cco/core#"},
   :rdfs/label #xsd/langString "has ultimative duration@en",
   :rdfs/subPropertyOf [:cco/attention_duration :scovo/dimension :event/time],
   :vs/term_status #xsd/langString "testing@en"})