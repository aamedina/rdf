(ns net.wikipunk.rdf.http
  ...
  {:dcat/downloadURL "resources/http.rdf",
   ...
   :rdfs/label #rdf/langString "HTTP in RDF@en",
...
(def Connection
  ...
  {:db/ident         :http/Connection,
   ...
   :rdfs/comment     #rdf/langString "A connection used for HTTP transfer.@en",
...
(def EntityHeader
  ...
  {:db/ident        :http/EntityHeader,
   :rdf/type        [:owl/Class :rdfs/Class],
   :rdfs/comment    #rdf/langString "An entity header in an HTTP message.@en",
   :rdfs/label      #rdf/langString "Entity Header@en",
...
(def GeneralHeader
  ...
  {:db/ident        :http/GeneralHeader,
   :rdf/type        [:owl/Class :rdfs/Class],
   :rdfs/comment    #rdf/langString "A general header in an HTTP message.@en",
   :rdfs/label      #rdf/langString "General Header@en",
...
(def HeaderElement
  ...
  {:db/ident        :http/HeaderElement,
   ...
   :rdfs/label      #rdf/langString "Header Element@en",
   :rdfs/subClassOf :rdfs/Resource})
...
(def HeaderName
  ...
  {:db/ident        :http/HeaderName,
   :rdf/type        [:owl/Class :rdfs/Class],
   :rdfs/comment    #rdf/langString "A header name.@en",
   :rdfs/label      #rdf/langString "Header Name@en",
   :rdfs/subClassOf :rdfs/Resource})
...
(def Message
  ...
  {:db/ident         :http/Message,
   :rdf/type         [:owl/Class :rdfs/Class],
   :rdfs/comment     #rdf/langString "An HTTP message.@en",
   :rdfs/isDefinedBy {:rdfa/uri "http://www.ietf.org/rfc/rfc2616.txt"},
...
(def MessageHeader
  ...
  {:db/ident        :http/MessageHeader,
   :rdf/type        [:owl/Class :rdfs/Class],
   :rdfs/comment    #rdf/langString "A header in an HTTP message.@en",
   :rdfs/label      #rdf/langString "Message Header@en",
   :rdfs/subClassOf :rdfs/Resource})
...
(def Method
  ...
  {:db/ident         :http/Method,
   :rdf/type         [:owl/Class :rdfs/Class],
   :rdfs/comment     #rdf/langString "The HTTP method used for the request.@en",
   :rdfs/isDefinedBy {:rdfa/uri "http://www.ietf.org/rfc/rfc2616.txt"},
   :rdfs/label       #rdf/langString "Method@en",
   :rdfs/subClassOf  :rdfs/Resource})
...
(def Request
  ...
  {:db/ident         :http/Request,
   :rdf/type         [:owl/Class :rdfs/Class],
   :rdfs/comment     #rdf/langString "An HTTP request.@en",
   :rdfs/isDefinedBy {:rdfa/uri "http://www.ietf.org/rfc/rfc2616.txt"},
...
(def RequestHeader
  ...
  {:db/ident        :http/RequestHeader,
   :rdf/type        [:owl/Class :rdfs/Class],
   :rdfs/comment    #rdf/langString "A header in an HTTP request message.@en",
   :rdfs/label      #rdf/langString "Request Header@en",
   :rdfs/subClassOf [:http/MessageHeader :rdfs/Resource]})
...
(def Response
  ...
  {:db/ident         :http/Response,
   :rdf/type         [:owl/Class :rdfs/Class],
   :rdfs/comment     #rdf/langString "An HTTP response.@en",
   :rdfs/isDefinedBy {:rdfa/uri "http://www.ietf.org/rfc/rfc2616.txt"},
   :rdfs/label       #rdf/langString "Response@en",
...
(def ResponseHeader
  ...
  {:db/ident        :http/ResponseHeader,
   :rdf/type        [:owl/Class :rdfs/Class],
   :rdfs/comment    #rdf/langString "A header in an HTTP response message.@en",
   :rdfs/label      #rdf/langString "Response Header@en",
   :rdfs/subClassOf [:http/MessageHeader :rdfs/Resource]})
...
(def StatusCode
  ...
  {:db/ident         :http/StatusCode,
   :rdf/type         [:owl/Class :rdfs/Class],
   :rdfs/comment     #rdf/langString "The status code of an HTTP response.@en",
   :rdfs/isDefinedBy {:rdfa/uri "http://www.ietf.org/rfc/rfc2616.txt"},
   :rdfs/label       #rdf/langString "Status code@en",
   :rdfs/subClassOf  :rdfs/Resource})
...
(def absolutePath
  ...
  {:db/ident           :http/absolutePath,
   ...
   :rdfs/label         #rdf/langString "Absolute path@en",
...
(def absoluteURI
  ...
  {:db/ident           :http/absoluteURI,
   :rdf/type           :rdf/Property,
   :rdfs/comment       #rdf/langString "The absolute request URI.@en",
   :rdfs/label         #rdf/langString "Absolute URI@en",
   :rdfs/subPropertyOf :http/requestURI})
...
(def authority
  ...
  {:db/ident           :http/authority,
   :rdf/type           :rdf/Property,
   :rdfs/comment       #rdf/langString "The authority sort of request URI.@en",
...
(def body
  ...
  {:db/ident         :http/body,
   ...
   :rdfs/comment     #rdf/langString "The entity body of an HTTP message.@en",
   :rdfs/domain      :http/Message,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.ietf.org/rfc/rfc2616.txt"},
   :rdfs/label       #rdf/langString "Entity Body@en",
...
(def connectionAuthority
  ...
  {:db/ident :http/connectionAuthority,
   ...
   :rdfs/label #rdf/langString "Connection authority@en",
...
(def elementName
  ...
  {:db/ident     :http/elementName,
   :rdf/type     [:owl/ObjectProperty :rdf/Property],
   :rdfs/comment #rdf/langString "The name of a header element.@en",
   :rdfs/domain  :http/HeaderElement,
   :rdfs/label   #rdf/langString "Header element name@en",
   :rdfs/range   :rdfs/Literal})
...
(def elementValue
  ...
  {:db/ident     :http/elementValue,
   :rdf/type     [:owl/ObjectProperty :rdf/Property],
   :rdfs/comment #rdf/langString "The value of a header element.@en",
   :rdfs/domain  :http/HeaderElement,
   :rdfs/label   #rdf/langString "Header element value@en",
   :rdfs/range   :rdfs/Literal})
...
(def fieldName
  ...
  {:db/ident     :http/fieldName,
   :rdf/type     [:owl/ObjectProperty :rdf/Property],
   :rdfs/comment #rdf/langString "The name of an HTTP header field.@en",
   :rdfs/domain  :http/MessageHeader,
   :rdfs/label   #rdf/langString "Field name@en",
   :rdfs/range   :rdfs/Literal})
...
(def fieldValue
  ...
  {:db/ident     :http/fieldValue,
   :rdf/type     [:owl/ObjectProperty :rdf/Property],
   :rdfs/comment #rdf/langString "The value of an HTTP header field.@en",
   :rdfs/domain  :http/MessageHeader,
   :rdfs/label   #rdf/langString "Field value@en",
   :rdfs/range   :rdfs/Literal})
...
(def hdrName
  ...
  {:db/ident     :http/hdrName,
   :rdf/type     [:owl/ObjectProperty :rdf/Property],
   :rdfs/comment #rdf/langString "The name of an HTTP header.@en",
   :rdfs/domain  :http/MessageHeader,
   :rdfs/label   #rdf/langString "Header name@en",
...
(def headerElements
  ...
  {:db/ident     :http/headerElements,
   ...
   :rdfs/domain  :http/MessageHeader,
   :rdfs/label   #rdf/langString "Header elements@en"})

(def headers
  "The headers in an HTTP message."
  {:db/ident         :http/headers,
   :rdf/type         [:owl/ObjectProperty :rdf/Property],
   :rdfs/comment     #rdf/langString "The headers in an HTTP message.@en",
   :rdfs/domain      :http/Message,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.ietf.org/rfc/rfc2616.txt"},
   :rdfs/label       #rdf/langString "Headers@en"})

(def httpVersion
  "The HTTP version of an HTTP message."
  {:db/ident         :http/httpVersion,
   :rdf/type         [:owl/ObjectProperty :rdf/Property],
   :rdfs/comment     #rdf/langString "The HTTP version of an HTTP message.@en",
   :rdfs/domain      :http/Message,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.ietf.org/rfc/rfc2616.txt"},
   :rdfs/label       #rdf/langString "HTTP version@en",
   :rdfs/range       :rdfs/Literal})
...
(def methodName
  ...
  {:db/ident         :http/methodName,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://www.ietf.org/rfc/rfc2616.txt"},
   :rdfs/label       #rdf/langString "Method name@en",
   :rdfs/range       :rdfs/Literal})
...
(def paramName
  ...
  {:db/ident :http/paramName,
   ...
   :rdfs/label #rdf/langString "Parameter name@en",
   :rdfs/range :rdfs/Literal})
...
(def paramValue
  ...
  {:db/ident :http/paramValue,
   ...
   :rdfs/domain :http/Parameter,
   :rdfs/label #rdf/langString "Parameter value@en",
   :rdfs/range :rdfs/Literal})
...
(def params
  ...
  {:db/ident :http/params,
   ...
   :rdfs/domain :http/HeaderElement,
   :rdfs/label #rdf/langString "Header parameters@en"})
...
(def reasonPhrase
  ...
  {:db/ident         :http/reasonPhrase,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://www.ietf.org/rfc/rfc2616.txt"},
   :rdfs/label       #rdf/langString "Reason phrase@en",
   :rdfs/range       :rdfs/Literal})
...
(def requestURI
  ...
  {:db/ident         :http/requestURI,
   :rdf/type         [:owl/ObjectProperty :rdf/Property],
   :rdfs/comment     #rdf/langString "The request URI of an HTTP request.@en",
   :rdfs/domain      :http/Request,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.ietf.org/rfc/rfc2616.txt"},
   :rdfs/label       #rdf/langString "Request URI@en",
   :rdfs/range       :rdfs/Literal})
...
(def requests
  ...
  {:db/ident         :http/requests,
   ...
   :rdfs/domain      :http/Connection,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.ietf.org/rfc/rfc2616.txt"},
   :rdfs/label       #rdf/langString "Requests@en"})
...
(def statusCodeNumber
  ...
  {:db/ident           :http/statusCodeNumber,
   :rdf/type           [:owl/ObjectProperty :rdf/Property],
   :rdfs/comment       #rdf/langString "The status code number.@en",
