(ns net.wikipunk.rdf.formats
  ...
  {:namespaces  {"dcterms" "http://purl.org/dc/terms/",
   ...
   :base        "http://www.w3.org/ns/formats/"
...
(def JSON-LD
  ...
  {:db/ident                 :formats/JSON-LD,
   ...
   :rdfs/isDefinedBy         {:xsd/anyURI "http://www.w3.org/TR/json-ld-syntax/"},
   :rdfs/seeAlso             {:xsd/anyURI "http://www.w3.org/TR/json-ld-syntax/#iana-considerations"}})

(def LD_Patch
  "Unique identifier for the LD Patch Format"
  {:db/ident                 :formats/LD_Patch,
   :dcterms/created          #inst "2015-02-07",
   :dcterms/creator          {:xsd/anyURI "https://deiu.rww.io/profile/card#me"},
   ...
   :rdfs/isDefinedBy         {:xsd/anyURI "http://www.w3.org/TR/ldpatch/"},
   :rdfs/seeAlso             {:xsd/anyURI "http://www.w3.org/TR/ldpatch/#media-registration"}})
...
(def N-Quads
  ...
  {:db/ident                 :formats/N-Quads,
   ...
   :rdfs/isDefinedBy         {:xsd/anyURI "http://www.w3.org/TR/n-quads/"}})
...
(def N-Triples
  ...
  {:db/ident                 :formats/N-Triples,
   ...
   :rdfs/isDefinedBy         {:xsd/anyURI "http://www.w3.org/TR/n-triples/"}})
...
(def N3
  ...
  {:db/ident            :formats/N3,
   ...
   :rdfs/isDefinedBy    {:xsd/anyURI "http://www.w3.org/TeamSubmission/n3/"},
   :rdfs/seeAlso        {:xsd/anyURI "http://www.w3.org/TeamSubmission/n3/#mimetype"}})
...
(def OWL_Functional
  ...
  {:db/ident                 :formats/OWL_Functional,
   ...
   :rdfs/isDefinedBy         {:xsd/anyURI "http://www.w3.org/TR/owl-syntax/"},
   :rdfs/seeAlso             {:xsd/anyURI "http://www.w3.org/TR/owl-syntax/#Appendix:_Internet_Media_Type.2C_File_Extension.2C_and_Macintosh_File_Type"}})
...
(def OWL_XML
  ...
  {:db/ident                 :formats/OWL_XML,
   ...
   :rdfs/isDefinedBy         {:xsd/anyURI "http://www.w3.org/TR/owl-xml-serialization/"},
   :rdfs/seeAlso             {:xsd/anyURI "http://www.w3.org/TR/owl-xml-serialization/#Appendix:_Internet_Media_Type.2C_File_Extension.2C_and_Macintosh_File_Type"}})
...
(def POWDER
  ...
  {:db/ident            :formats/POWDER,
   ...
   :rdfs/isDefinedBy    {:xsd/anyURI "http://www.w3.org/TR/powder-dr/"},
   :rdfs/seeAlso        {:xsd/anyURI "http://www.w3.org/TR/powder-dr/#appB"}})
...
(def POWDER-S
  ...
  {:db/ident            :formats/POWDER-S,
   ...
   :rdfs/isDefinedBy    {:xsd/anyURI "http://www.w3.org/TR/powder-dr/"},
   :rdfs/seeAlso        {:xsd/anyURI "http://www.w3.org/TR/powder-dr/#appC"}})
...
(def PROV-N
  ...
  {:db/ident                 :formats/PROV-N,
   ...
   :rdfs/isDefinedBy         {:xsd/anyURI "http://www.w3.org/TR/prov-n/"},
   :rdfs/seeAlso             {:xsd/anyURI "http://www.w3.org/TR/prov-n/#media-type"}})
...
(def PROV-XML
  ...
  {:db/ident                 :formats/PROV-XML,
   ...
   :rdfs/isDefinedBy         {:xsd/anyURI "http://www.w3.org/TR/prov-xml/"},
   :rdfs/seeAlso             {:xsd/anyURI "http://www.w3.org/TR/prov-xml/#media-type"}})
...
(def RDF_JSON
  ...
  {:db/ident                 :formats/RDF_JSON,
   ...
   :rdfs/isDefinedBy         {:xsd/anyURI "http://www.w3.org/TR/rdf-json/"},
   :rdfs/seeAlso             {:xsd/anyURI "http://www.w3.org/TR/rdf-json/#sec-mediaReg"}})
...
(def RDF_XML
  ...
  {:db/ident                 :formats/RDF_XML,
   ...
   :rdfs/isDefinedBy         {:xsd/anyURI "http://www.w3.org/TR/rdf-syntax-grammar/"},
   :rdfs/seeAlso {:xsd/anyURI "http://www.w3.org/TR/rdf-syntax-grammar/#section-MIME-Type"}})
...
(def RIF_XML
  ...
  {:db/ident                 :formats/RIF_XML,
   ...
   :rdfs/isDefinedBy         {:xsd/anyURI "http://www.w3.org/TR/rif-core/"},
   :rdfs/seeAlso {:xsd/anyURI "http://www.w3.org/TR/rif-core/#Appendix:_RIF_Media_Type_Registration"}})
...
(def SPARQL_Results_CSV
  ...
  {:db/ident                 :formats/SPARQL_Results_CSV,
   ...
   :rdfs/isDefinedBy         {:xsd/anyURI "http://www.w3.org/TR/sparql11-results-csv-tsv/"},
   :rdfs/seeAlso             {:xsd/anyURI "http://www.rfc-editor.org/rfc/rfc4180.txt"}})
...
(def SPARQL_Results_JSON
  ...
  {:db/ident                 :formats/SPARQL_Results_JSON,
   ...
   :rdfs/isDefinedBy         {:xsd/anyURI "http://www.w3.org/TR/sparql11-results-json/"},
   :rdfs/seeAlso             {:xsd/anyURI "http://www.w3.org/TR/sparql11-results-json/#content-type"}})
...
(def SPARQL_Results_TSV
  ...
  {:db/ident           :formats/SPARQL_Results_TSV,
   ...
   :rdfs/isDefinedBy   {:xsd/anyURI "http://www.w3.org/TR/sparql11-results-csv-tsv/"},
   :rdfs/seeAlso {:xsd/anyURI "http://www.iana.org/assignments/media-types/text/tab-separated-values"}})
...
(def TriG
  ...
  {:db/ident                 :formats/TriG,
   ...
   :rdfs/isDefinedBy         {:xsd/anyURI "http://www.w3.org/TR/trig/"},
   :rdfs/seeAlso             {:xsd/anyURI "http://www.w3.org/TR/trig/#sec-mediaReg"}})
...
(def Turtle
  ...
  {:db/ident                 :formats/Turtle,
   ...
   :rdfs/isDefinedBy         {:xsd/anyURI "http://www.w3.org/TR/turtle/"},
   :rdfs/seeAlso             {:xsd/anyURI "http://www.w3.org/TR/turtle/#sec-mediaReg"}})
...
(def microdata
  ...
  {:db/ident            :formats/microdata,
   ...
   :rdfs/isDefinedBy    {:xsd/anyURI "http://www.w3.org/TR/microdata/"},
   :rdfs/seeAlso        {:xsd/anyURI "http://www.w3.org/TR/microdata-rdf/"}})
