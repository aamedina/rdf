...
(def Cash
  ...
  {:db/ident         :gr/Cash,
   :rdf/type         :gr/PaymentMethod,
   :rdfs/comment     "Payment by cash upon delivery or pickup.",
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
...
(def DHL
  ...
  {:db/ident         :gr/DHL,
   ...
   :rdfs/comment     "Delivery via the parcel service DHL.",
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
...
(def FederalExpress
  ...
  {:db/ident         :gr/FederalExpress,
   :rdf/type         [:gr/DeliveryModeParcelService :gr/DeliveryMethod],
   :rdfs/comment     "Delivery via the parcel service Federal Express.",
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
...
(def Friday
  ...
  {:db/ident           :gr/Friday,
   ...
   :rdfs/comment       "Friday as a day of the week.",
   :rdfs/isDefinedBy   "http://purl.org/goodrelations/v1",
...
(def GoogleCheckout
  ...
  {:db/ident         :gr/GoogleCheckout,
   :rdf/type         :gr/PaymentMethod,
   :rdfs/comment     "Payment via the Google Checkout payment service.",
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
...
(def JCB
  ...
  {:db/ident :gr/JCB,
   :rdf/type [:gr/PaymentMethodCreditCard :gr/PaymentMethod],
   :rdfs/comment "Payment by credit or debit cards issued by the JCB network.",
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
...
(def Monday
  ...
  {:db/ident           :gr/Monday,
   ...
   :rdf/type           :gr/DayOfWeek,
   :rdfs/comment       "Monday as a day of the week.",
   :rdfs/isDefinedBy   "http://purl.org/goodrelations/v1",
...
(def PayPal
  ...
  {:db/ident         :gr/PayPal,
   :rdf/type         :gr/PaymentMethod,
   :rdfs/comment     "Payment via the PayPal payment service.",
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
...
(def PaySwarm
  ...
  {:db/ident :gr/PaySwarm,
   :rdf/type :gr/PaymentMethod,
   :rdfs/comment "Payment via the PaySwarm distributed micropayment service.",
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
...
(def PriceSpecification
  ...
  {:db/ident         :gr/PriceSpecification,
   :owl/disjointWith [:gr/Location
                      ...
                      :gr/Offering],
   :rdf/type         :owl/Class,
   :rdfs/comment     "The superclass of all price specifications.",
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
...
(def Saturday
  ...
  {:db/ident           :gr/Saturday,
   ...
   :rdf/type           :gr/DayOfWeek,
   :rdfs/comment       "Saturday as a day of the week.",
   :rdfs/isDefinedBy   "http://purl.org/goodrelations/v1",
...
(def Sunday
  ...
  {:db/ident           :gr/Sunday,
   ...
   :rdf/type           :gr/DayOfWeek,
   :rdfs/comment       "Sunday as a day of the week.",
   :rdfs/isDefinedBy   "http://purl.org/goodrelations/v1",
...
(def Thursday
  ...
  {:db/ident           :gr/Thursday,
   ...
   :rdf/type           :gr/DayOfWeek,
   :rdfs/comment       "Thursday as a day of the week.",
   :rdfs/isDefinedBy   "http://purl.org/goodrelations/v1",
...
(def Tuesday
  ...
  {:db/ident           :gr/Tuesday,
   ...
   :rdf/type           :gr/DayOfWeek,
   :rdfs/comment       "Tuesday as a day of the week.",
   :rdfs/isDefinedBy   "http://purl.org/goodrelations/v1",
...
(def UPS
  ...
  {:db/ident         :gr/UPS,
   :rdf/type         [:gr/DeliveryModeParcelService :gr/DeliveryMethod],
   :rdfs/comment     "Delivery via the parcel service UPS.",
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
...
(def VISA
  ...
  {:db/ident :gr/VISA,
   :rdf/type [:gr/PaymentMethodCreditCard :gr/PaymentMethod],
   :rdfs/comment "Payment by credit or debit cards issued by the VISA network.",
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
...
(def Wednesday
  ...
  {:db/ident           :gr/Wednesday,
   ...
   :rdf/type           :gr/DayOfWeek,
   :rdfs/comment       "Wednesday as a day of the week.",
   :rdfs/isDefinedBy   "http://purl.org/goodrelations/v1",
...
(def legalName
  ...
  {:db/ident         :gr/legalName,
   :rdf/type         :owl/DatatypeProperty,
   :rdfs/comment     "The legal name of the gr:BusinessEntity.",
   :rdfs/domain      {:owl/unionOf [:gr/BusinessEntity :schema/Organization],
                      :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
