(ns net.wikipunk.rdf.gr
  ...
  {:dc11/contributor
   ...
   :dc11/creator #voc/lstr "Martin Hepp@en",
   :dc11/rights
   #voc/lstr
   ...
   :foaf/homepage "http://purl.org/goodrelations/",
   :owl/versionInfo #voc/lstr "V 1.0, Release 2011-10-01@en",
   ...
   :rdfs/label #voc/lstr "GoodRelations Ontology@en"}
...
(def ActualProductOrServiceInstance
  ...
  {:db/ident :gr/ActualProductOrServiceInstance,
   ...
   :rdfs/label #voc/lstr "Actual product or service instance (DEPRECATED)@en",
   :rdfs/subClassOf [:gr/ProductOrService :gr/ActualProductOrServiceInstance]})
...
(def AmericanExpress
  ...
  {:db/ident :gr/AmericanExpress,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "American Express (payment method)@en"})
...
(def Business
  ...
  {:db/ident :gr/Business,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Business (business entity type)@en"})
...
(def BusinessEntity
  ...
  {:db/ident :gr/BusinessEntity,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Business entity@en",
...
(def BusinessEntityType
  ...
  {:db/ident :gr/BusinessEntityType,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Business entity type@en"})
...
(def BusinessFunction
  ...
  {:db/ident :gr/BusinessFunction,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Business function@en",
...
(def Buy
  ...
  {:db/ident :gr/Buy,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Buy (business function, DEPRECATED)@en"})
...
(def ByBankTransferInAdvance
  ...
  {:db/ident :gr/ByBankTransferInAdvance,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "By bank transfer in advance (payment method)@en"})
...
(def ByInvoice
  ...
  {:db/ident :gr/ByInvoice,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "By invoice (payment method)@en"})
...
(def COD
  ...
  {:db/ident :gr/COD,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "COD (payment method)@en"})

(def Cash
  "Payment by cash upon delivery or pickup."
  {:db/ident         :gr/Cash,
   :rdf/type         :gr/PaymentMethod,
   :rdfs/comment     #voc/lstr "Payment by cash upon delivery or pickup.@en",
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label       #voc/lstr "Cash (payment method)@en"})
...
(def CheckInAdvance
  ...
  {:db/ident :gr/CheckInAdvance,
   ...
   #voc/lstr
    "Payment by sending a check in advance, i.e., the offering gr:BusinessEntity will deliver the goods upon receipt of a check over the due amount. There are variations in handling payment by check - sometimes, shipment will be upon receipt of the check as a document, sometimes the shipment will take place only upon successful crediting of the check.@en",
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Check in advance (payment method)@en"})
...
(def ConstructionInstallation
  ...
  {:db/ident :gr/ConstructionInstallation,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Construction / installation (business function)@en"})

(def DHL
  "Delivery via the parcel service DHL."
  {:db/ident         :gr/DHL,
   :rdf/type         [:gr/DeliveryModeParcelService :gr/DeliveryMethod],
   :rdfs/comment     #voc/lstr "Delivery via the parcel service DHL.@en",
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label       #voc/lstr "DHL (delivery method)@en"})
...
(def DayOfWeek
  ...
  {:db/ident :gr/DayOfWeek,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Day of week@en"})
...
(def DeliveryChargeSpecification
  ...
  {:db/ident :gr/DeliveryChargeSpecification,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Delivery charge specification@en",
   :rdfs/subClassOf [:gr/PriceSpecification :gr/DeliveryChargeSpecification]})
...
(def DeliveryModeDirectDownload
  ...
  {:db/ident :gr/DeliveryModeDirectDownload,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Delivery mode direct download (delivery method)@en"})
...
(def DeliveryModeFreight
  ...
  {:db/ident :gr/DeliveryModeFreight,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Delivery mode freight (delivery method)@en"})
...
(def DeliveryModeMail
  ...
  {:db/ident :gr/DeliveryModeMail,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Delivery mode mail (delivery method)@en"})
...
(def DeliveryModeOwnFleet
  ...
  {:db/ident :gr/DeliveryModeOwnFleet,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Delivery mode own fleet (delivery method)@en"})
...
(def DeliveryModeParcelService
  ...
  {:db/ident :gr/DeliveryModeParcelService,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Delivery mode parcel service@en",
   :rdfs/subClassOf [:gr/DeliveryMethod :gr/DeliveryModeParcelService]})
...
(def DeliveryModePickUp
  ...
  {:db/ident :gr/DeliveryModePickUp,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Delivery mode pick up (delivery method)@en"})
...
(def DinersClub
  ...
  {:db/ident :gr/DinersClub,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Diners Club (payment method)@en"})
...
(def DirectDebit
  ...
  {:db/ident :gr/DirectDebit,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Direct debit (payment method)@en"})
...
(def Discover
  ...
  {:db/ident :gr/Discover,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Discover (payment method)@en"})
...
(def Dispose
  ...
  {:db/ident :gr/Dispose,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Dispose (business function)@en"})
...
(def Enduser
  ...
  {:db/ident :gr/Enduser,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Enduser (business entity type)@en"})
...
(def FederalExpress
  ...
  {:db/ident         :gr/FederalExpress,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label       #voc/lstr "Federal Express (delivery method)@en"})
...
(def Friday
  ...
  {:db/ident           :gr/Friday,
   ...
   :rdfs/comment       #voc/lstr "Friday as a day of the week.@en",
   :rdfs/isDefinedBy   "http://purl.org/goodrelations/v1",
   :rdfs/label         #voc/lstr "Friday (day of week)@en"})
...
(def GoogleCheckout
  ...
  {:db/ident         :gr/GoogleCheckout,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label       #voc/lstr "Google Checkout (payment method)@en"})
...
(def Individual
  ...
  {:db/ident :gr/Individual,
   ...
   :rdfs/subClassOf [:gr/ProductOrService :schema/Product :gr/Individual]})
...
(def JCB
  ...
  {:db/ident :gr/JCB,
   :rdf/type [:gr/PaymentMethodCreditCard :gr/PaymentMethod],
   :rdfs/comment
   #voc/lstr "Payment by credit or debit cards issued by the JCB network.@en",
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "JCB (payment method)@en"})
...
(def Labor-BringIn
  ...
  {:db/ident :gr/Labor-BringIn,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Labor / bring-in (warranty scope)@en"})
...
(def LeaseOut
  ...
  {:db/ident :gr/LeaseOut,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Lease Out (business function)@en"})
...
(def License
  ...
  {:db/ident :gr/License,
   ...
   :rdfs/subClassOf [:gr/BusinessFunction :gr/License]})
...
(def Maintain
  ...
  {:db/ident :gr/Maintain,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Maintain (business function)@en"})
...
(def MasterCard
  ...
  {:db/ident :gr/MasterCard,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "MasterCard (payment method)@en"})
...
(def Monday
  ...
  {:db/ident           :gr/Monday,
   ...
   :rdf/type           :gr/DayOfWeek,
   :rdfs/comment       #voc/lstr "Monday as a day of the week.@en",
   :rdfs/isDefinedBy   "http://purl.org/goodrelations/v1",
   :rdfs/label         #voc/lstr "Monday (day of week)@en"})
...
(def N-Ary-Relations
  ...
  {:db/ident :gr/N-Ary-Relations,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "N-ary relations (DEPRECATED)@en"})
...
(def OpeningHoursSpecification
  ...
  {:db/ident :gr/OpeningHoursSpecification,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Opening hours specification@en"})
...
(def PartsAndLabor-BringIn
  ...
  {:db/ident :gr/PartsAndLabor-BringIn,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Parts and labor / bring-in (warranty scope)@en"})
...
(def PartsAndLabor-PickUp
  ...
  {:db/ident :gr/PartsAndLabor-PickUp,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Parts and labor / pick up (warranty scope)@en"})

(def PayPal
  "Payment via the PayPal payment service."
  {:db/ident         :gr/PayPal,
   :rdf/type         :gr/PaymentMethod,
   :rdfs/comment     #voc/lstr "Payment via the PayPal payment service.@en",
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label       #voc/lstr "PayPal (payment method)@en"})
...
(def PaySwarm
  ...
  {:db/ident :gr/PaySwarm,
   :rdf/type :gr/PaymentMethod,
   :rdfs/comment
   #voc/lstr "Payment via the PaySwarm distributed micropayment service.@en",
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "PaySwarm (payment method)@en"})
...
(def PaymentChargeSpecification
  ...
  {:db/ident :gr/PaymentChargeSpecification,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Payment charge specification@en",
   :rdfs/subClassOf [:gr/PriceSpecification :gr/PaymentChargeSpecification]})
...
(def PaymentMethod
  ...
  {:db/ident :gr/PaymentMethod,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Payment method@en",
...
(def PaymentMethodCreditCard
  ...
  {:db/ident :gr/PaymentMethodCreditCard,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Payment method credit card@en",
   :rdfs/subClassOf [:gr/PaymentMethod :gr/PaymentMethodCreditCard]})
...
(def PriceSpecification
  ...
  {:db/ident         :gr/PriceSpecification,
   :owl/disjointWith [:gr/Location
                      ...
                      :gr/Offering],
   :rdf/type         :owl/Class,
   :rdfs/comment     #voc/lstr "The superclass of all price specifications.@en",
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label       #voc/lstr "Price specification@en",
...
(def ProductOrService
  ...
  {:db/ident :gr/ProductOrService,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Product or service@en",
...
(def ProductOrServiceModel
  ...
  {:db/ident :gr/ProductOrServiceModel,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Product or service model@en",
   :rdfs/subClassOf
   [:schema/Product :gr/ProductOrService :gr/ProductOrServiceModel]})
...
(def ProductOrServicesSomeInstancesPlaceholder
  ...
  {:db/ident :gr/ProductOrServicesSomeInstancesPlaceholder,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label
   #voc/lstr "Product or services some instances placeholder (DEPRECATED)@en",
   :rdfs/subClassOf [:gr/ProductOrService
...
(def ProvideService
  ...
  {:db/ident :gr/ProvideService,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Provide service (business function)@en"})
...
(def PublicHolidays
  ...
  {:db/ident :gr/PublicHolidays,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Public holidays (day of week)@en"})
...
(def PublicInstitution
  ...
  {:db/ident :gr/PublicInstitution,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Public institution (business entity type)@en"})
...
(def QualitativeValue
  ...
  {:db/ident :gr/QualitativeValue,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Qualitative value@en"})
...
(def QuantitativeValue
  ...
  {:db/ident :gr/QuantitativeValue,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Quantitative value@en",
...
(def QuantitativeValueFloat
  ...
  {:db/ident :gr/QuantitativeValueFloat,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Quantitative value float@en",
   :rdfs/subClassOf [:gr/QuantitativeValue :gr/QuantitativeValueFloat]})
...
(def QuantitativeValueInteger
  ...
  {:db/ident :gr/QuantitativeValueInteger,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Quantitative value integer@en",
   :rdfs/subClassOf [:gr/QuantitativeValue :gr/QuantitativeValueInteger]})
...
(def Repair
  ...
  {:db/ident :gr/Repair,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Repair (business function)@en"})
...
(def Reseller
  ...
  {:db/ident :gr/Reseller,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Reseller (business entity type)@en"})
...
(def Saturday
  ...
  {:db/ident           :gr/Saturday,
   ...
   :rdf/type           :gr/DayOfWeek,
   :rdfs/comment       #voc/lstr "Saturday as a day of the week.@en",
   :rdfs/isDefinedBy   "http://purl.org/goodrelations/v1",
   :rdfs/label         #voc/lstr "Saturday (day of week)@en"})
...
(def Sell
  ...
  {:db/ident :gr/Sell,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Sell (business function)@en"})
...
(def SomeItems
  ...
  {:db/ident :gr/SomeItems,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Some items@en",
   :rdfs/subClassOf [:gr/ProductOrService :schema/Product :gr/SomeItems]})
...
(def Sunday
  ...
  {:db/ident           :gr/Sunday,
   ...
   :rdf/type           :gr/DayOfWeek,
   :rdfs/comment       #voc/lstr "Sunday as a day of the week.@en",
   :rdfs/isDefinedBy   "http://purl.org/goodrelations/v1",
   :rdfs/label         #voc/lstr "Sunday (day of week)@en"})
...
(def Thursday
  ...
  {:db/ident           :gr/Thursday,
   ...
   :rdf/type           :gr/DayOfWeek,
   :rdfs/comment       #voc/lstr "Thursday as a day of the week.@en",
   :rdfs/isDefinedBy   "http://purl.org/goodrelations/v1",
   :rdfs/label         #voc/lstr "Thursday (day of week)@en"})
...
(def Tuesday
  ...
  {:db/ident           :gr/Tuesday,
   ...
   :rdf/type           :gr/DayOfWeek,
   :rdfs/comment       #voc/lstr "Tuesday as a day of the week.@en",
   :rdfs/isDefinedBy   "http://purl.org/goodrelations/v1",
   :rdfs/label         #voc/lstr "Tuesday (day of week)@en"})
...
(def TypeAndQuantityNode
  ...
  {:db/ident :gr/TypeAndQuantityNode,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Type and quantity node@en"})

(def UPS
  "Delivery via the parcel service UPS."
  {:db/ident         :gr/UPS,
   :rdf/type         [:gr/DeliveryModeParcelService :gr/DeliveryMethod],
   :rdfs/comment     #voc/lstr "Delivery via the parcel service UPS.@en",
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label       #voc/lstr "UPS (delivery method)@en"})
...
(def UnitPriceSpecification
  ...
  {:db/ident :gr/UnitPriceSpecification,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Unit price specification@en",
   :rdfs/subClassOf [:gr/PriceSpecification :gr/UnitPriceSpecification]})
...
(def VISA
  ...
  {:db/ident :gr/VISA,
   :rdf/type [:gr/PaymentMethodCreditCard :gr/PaymentMethod],
   :rdfs/comment
   #voc/lstr "Payment by credit or debit cards issued by the VISA network.@en",
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "VISA (payment method)@en"})
...
(def WarrantyPromise
  ...
  {:db/ident :gr/WarrantyPromise,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Warranty promise@en"})
...
(def WarrantyScope
  ...
  {:db/ident :gr/WarrantyScope,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Warranty scope@en"})
...
(def Wednesday
  ...
  {:db/ident           :gr/Wednesday,
   ...
   :rdf/type           :gr/DayOfWeek,
   :rdfs/comment       #voc/lstr "Wednesday as a day of the week.@en",
   :rdfs/isDefinedBy   "http://purl.org/goodrelations/v1",
   :rdfs/label         #voc/lstr "Wednesday (day of week)@en"})
...
(def acceptedPaymentMethods
  ...
  {:db/ident :gr/acceptedPaymentMethods,
   ...
   :rdfs/domain {:owl/unionOf [:gr/Offering :schema/Offer],
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "accepted payment methods (0..*)@en",
...
(def addOn
  ...
  {:db/ident :gr/addOn,
   ...
   :rdfs/domain {:owl/unionOf [:gr/Offering :schema/Offer],
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "add-on (0..*)@en",
...
(def advanceBookingRequirement
  ...
  {:db/ident :gr/advanceBookingRequirement,
   ...
   :rdfs/domain {:owl/unionOf [:gr/Offering :schema/Offer],
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "advance booking requirement (0..1)@en",
...
(def amountOfThisGood
  ...
  {:db/ident :gr/amountOfThisGood,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "amount of this good (1..1)@en",
...
(def appliesToDeliveryMethod
  ...
  {:db/ident :gr/appliesToDeliveryMethod,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "applies to delivery method (0..*)@en",
...
(def appliesToPaymentMethod
  ...
  {:db/ident :gr/appliesToPaymentMethod,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "applies to payment method (1..*)@en",
   :rdfs/range :gr/PaymentMethod})
...
(def availabilityEnds
  ...
  {:db/ident :gr/availabilityEnds,
   ...
   :rdfs/domain {:owl/unionOf [:gr/Offering :schema/Offer],
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "availability ends (0..1)@en",
...
(def availabilityStarts
  ...
  {:db/ident :gr/availabilityStarts,
   ...
   :rdfs/domain {:owl/unionOf [:gr/Offering :schema/Offer],
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "availability starts (0..1)@en",
   :rdfs/range :xsd/dateTime})
...
(def availableAtOrFrom
  ...
  {:db/ident :gr/availableAtOrFrom,
   ...
   :rdfs/domain {:owl/unionOf [:gr/Offering :schema/Offer],
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "available at or from (0..*)@en",
...
(def availableDeliveryMethods
  ...
  {:db/ident :gr/availableDeliveryMethods,
   ...
   :rdfs/domain {:owl/unionOf [:gr/Offering :schema/Offer],
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "available delivery methods (0..*)@en",
   :rdfs/range :gr/DeliveryMethod})
...
(def billingIncrement
  ...
  {:db/ident :gr/billingIncrement,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "billing increment (0..1)@en",
   :rdfs/range :xsd/float})
...
(def category
  ...
  {:db/ident :gr/category,
   ...
   :rdfs/domain {:owl/unionOf [:gr/ProductOrService
                 ...
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "category (0..*)@en",
...
(def closes
  ...
  {:db/ident :gr/closes,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "closes (1..1)@en",
   :rdfs/range :xsd/time})
...
(def color
  ...
  {:db/ident           :gr/color,
   :rdf/type           :owl/DatatypeProperty,
   :rdfs/comment       #voc/lstr "The color of the product.@en",
   :rdfs/domain        {:owl/unionOf [:gr/ProductOrService :schema/Product],
                        :rdf/type    :owl/Class},
   :rdfs/isDefinedBy   "http://purl.org/goodrelations/v1",
   :rdfs/label         #voc/lstr "color (0..1)@en",
   :rdfs/range         :rdfs/Literal,
   :rdfs/subPropertyOf [:gr/datatypeProductOrServiceProperty :gr/color]})
...
(def condition
  ...
  {:db/ident :gr/condition,
   ...
   {:owl/unionOf [:gr/Offering :gr/ProductOrService :schema/Product],
    :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "condition (0..1)@en",
   :rdfs/range :rdfs/Literal})
...
(def datatypeProductOrServiceProperty
  ...
  {:db/ident :gr/datatypeProductOrServiceProperty,
   ...
   :rdfs/domain {:owl/unionOf [:gr/ProductOrService :schema/Product],
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "datatype product or service property (0..*)@en",
   :rdfs/range :rdfs/Literal,
...
(def deliveryLeadTime
  ...
  {:db/ident :gr/deliveryLeadTime,
   ...
   :rdfs/domain {:owl/unionOf [:gr/Offering :schema/Offer],
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "delivery lead time (0..1)@en",
   :rdfs/range :gr/QuantitativeValueInteger})
...
(def depth
  ...
  {:db/ident :gr/depth,
   ...
   :rdfs/domain {:owl/unionOf [:gr/ProductOrService :schema/Product],
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "depth (0..1)@en",
   :rdfs/range :gr/QuantitativeValue,
   :rdfs/subPropertyOf [:gr/quantitativeProductOrServiceProperty :gr/depth]})
...
(def description
  ...
  {:db/ident :gr/description,
   ...
   :rdfs/domain {:owl/unionOf [:owl/Thing
                 ...
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "description (0..1)@en",
   :rdfs/range :rdfs/Literal})
...
(def displayPosition
  ...
  {:db/ident :gr/displayPosition,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "display position (0..1)@en"})
...
(def durationOfWarrantyInMonths
  ...
  {:db/ident :gr/durationOfWarrantyInMonths,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "duration of warranty in months (0..1)@en",
   :rdfs/range :xsd/int})
...
(def eligibleCustomerTypes
  ...
  {:db/ident :gr/eligibleCustomerTypes,
   ...
   :rdfs/domain {:owl/unionOf [:gr/Offering :schema/Offer],
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "eligible customer types (0..*)@en",
...
(def eligibleDuration
  ...
  {:db/ident :gr/eligibleDuration,
   ...
   :rdfs/domain {:owl/unionOf [:gr/Offering :gr/License :schema/Offer],
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "eligible duration (0..1)@en",
   :rdfs/range :gr/QuantitativeValue})
...
(def eligibleRegions
  ...
  {:db/ident :gr/eligibleRegions,
   ...
   :rdfs/domain {:owl/unionOf [:gr/DeliveryChargeSpecification
                 ...
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "eligible regions (0..*)@en",
...
(def eligibleTransactionVolume
  ...
  {:db/ident :gr/eligibleTransactionVolume,
   ...
   {:owl/unionOf [:gr/Offering :gr/PriceSpecification :schema/Offer],
    :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "eligible transaction volume (0..1)@en",
...
(def equal
  ...
  {:db/ident :gr/equal,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "equal (0..*)@en",
...
(def greater
  ...
  {:db/ident :gr/greater,
   ...
   :rdfs/domain :gr/QualitativeValue,
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "greater (0..*)@en",
   :rdfs/range :gr/QualitativeValue})
...
(def greaterOrEqual
  ...
  {:db/ident :gr/greaterOrEqual,
   ...
   :rdfs/domain :gr/QualitativeValue,
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "greater or equal (0..*)@en",
   :rdfs/range :gr/QualitativeValue})
...
(def hasBrand
  ...
  {:db/ident :gr/hasBrand,
   ...
   :rdfs/domain {:owl/unionOf [:gr/BusinessEntity
                 ...
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "has brand (0..*)@en",
   :rdfs/range :gr/Brand})
...
(def hasBusinessFunction
  ...
  {:db/ident :gr/hasBusinessFunction,
   ...
   {:owl/unionOf [:gr/Offering :gr/TypeAndQuantityNode :schema/Offer],
    :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "has business function (1..*)@en",
...
(def hasCurrency
  ...
  {:db/ident :gr/hasCurrency,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "has currency (1..1)@en",
   :rdfs/range :xsd/string})
...
(def hasCurrencyValue
  ...
  {:db/ident :gr/hasCurrencyValue,
   ...
   :rdfs/domain :gr/PriceSpecification,
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "has currency value (0..1)@en",
   :rdfs/range :xsd/float,
   :rdfs/subPropertyOf
   [:gr/hasMinCurrencyValue :gr/hasMaxCurrencyValue :gr/hasCurrencyValue]})
...
(def hasDUNS
  ...
  {:db/ident :gr/hasDUNS,
   ...
   :rdfs/domain {:owl/unionOf [:gr/BusinessEntity :schema/Organization],
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "has DUNS (0..1)@en",
   :rdfs/range :xsd/string})
...
(def hasEAN_UCC-13
  ...
  {:db/ident :gr/hasEAN_UCC-13,
   ...
   {:owl/unionOf [:gr/Offering :gr/ProductOrService :schema/Product],
    :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "has EAN/UCC-13 (0..*)@en",
   :rdfs/range :xsd/string,
   :rdfs/subPropertyOf [:schema/productID :gr/hasEAN_UCC-13]})
...
(def hasEligibleQuantity
  ...
  {:db/ident :gr/hasEligibleQuantity,
   ...
   {:owl/unionOf [:gr/Offering :gr/PriceSpecification :schema/Offer],
    :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "has eligible quantity (0..1)@en",
   :rdfs/range :gr/QuantitativeValue})
...
(def hasGTIN-14
  ...
  {:db/ident :gr/hasGTIN-14,
   ...
   {:owl/unionOf [:gr/Offering :gr/ProductOrService :schema/Product],
    :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "has GTIN-14 (0..*)@en",
   :rdfs/range :xsd/string,
   :rdfs/subPropertyOf [:schema/productID :gr/hasGTIN-14]})
...
(def hasGTIN-8
  ...
  {:db/ident :gr/hasGTIN-8,
   ...
   {:owl/unionOf [:gr/Offering :gr/ProductOrService :schema/Product],
    :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "has GTIN-8 (0..*)@en",
   :rdfs/range :xsd/string,
   :rdfs/subPropertyOf [:schema/productID :gr/hasGTIN-8]})
...
(def hasGlobalLocationNumber
  ...
  {:db/ident :gr/hasGlobalLocationNumber,
   ...
   :rdfs/domain {:owl/unionOf [:gr/BusinessEntity
                 ...
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "has Global Location Number (0..1)@en",
   :rdfs/range :xsd/string})
...
(def hasISICv4
  ...
  {:db/ident :gr/hasISICv4,
   ...
   :rdfs/domain {:owl/unionOf [:gr/BusinessEntity
                 ...
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "has ISIC v4 (0..*)@en",
   :rdfs/range :xsd/int})
...
(def hasInventoryLevel
  ...
  {:db/ident :gr/hasInventoryLevel,
   ...
   :rdfs/domain {:owl/unionOf [:gr/Offering :gr/SomeItems :schema/Offer],
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "has inventory level (0..1)@en",
...
(def hasMPN
  ...
  {:db/ident :gr/hasMPN,
   ...
   {:owl/unionOf [:gr/Offering :gr/ProductOrService :schema/Product],
    :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "has MPN (0..*)@en",
   :rdfs/range :xsd/string,
   :rdfs/subPropertyOf [:schema/productID :gr/hasMPN]})
...
(def hasMakeAndModel
  ...
  {:db/ident :gr/hasMakeAndModel,
   ...
   :rdfs/domain {:owl/unionOf [:gr/Individual :gr/SomeItems :schema/Product],
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "has make and model (0..1)@en",
...
(def hasManufacturer
  ...
  {:db/ident :gr/hasManufacturer,
   ...
   :rdfs/domain {:owl/unionOf [:gr/ProductOrService :schema/Product],
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "has manufacturer (0..1)@en",
...
(def hasMaxCurrencyValue
  ...
  {:db/ident :gr/hasMaxCurrencyValue,
   ...
   :rdfs/domain :gr/PriceSpecification,
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "has max currency value (1..1)@en",
   :rdfs/range :xsd/float,
   :rdfs/subPropertyOf :gr/hasMaxCurrencyValue})
...
(def hasMaxValue
  ...
  {:db/ident :gr/hasMaxValue,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "has max value (0..1)@en",
   :rdfs/range :rdfs/Literal,
...
(def hasMaxValueFloat
  ...
  {:db/ident :gr/hasMaxValueFloat,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "has max value float (1..1)@en",
   :rdfs/range :xsd/float,
   :rdfs/subPropertyOf [:gr/hasMaxValue :gr/hasMaxValueFloat]})
...
(def hasMaxValueInteger
  ...
  {:db/ident :gr/hasMaxValueInteger,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "has max value integer (1..1)@en",
   :rdfs/range :xsd/int,
   :rdfs/subPropertyOf [:gr/hasMaxValue :gr/hasMaxValueInteger]})
...
(def hasMinCurrencyValue
  ...
  {:db/ident :gr/hasMinCurrencyValue,
   ...
   :rdfs/domain :gr/PriceSpecification,
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "has min currency value (1..1)@en",
   :rdfs/range :xsd/float,
...
(def hasMinValue
  ...
  {:db/ident :gr/hasMinValue,
   ...
   :rdfs/domain :gr/QuantitativeValue,
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "has min value (0..1)@en",
   :rdfs/range :rdfs/Literal,
...
(def hasMinValueFloat
  ...
  {:db/ident :gr/hasMinValueFloat,
   ...
   :rdfs/domain :gr/QuantitativeValueFloat,
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "has min value float (1..1)@en",
   :rdfs/range :xsd/float,
   :rdfs/subPropertyOf [:gr/hasMinValue :gr/hasMinValueFloat]})
...
(def hasMinValueInteger
  ...
  {:db/ident :gr/hasMinValueInteger,
   ...
   :rdfs/domain :gr/QuantitativeValueInteger,
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "has min value integer (1..1)@en",
   :rdfs/range :xsd/int,
   :rdfs/subPropertyOf [:gr/hasMinValue :gr/hasMinValueInteger]})
...
(def hasNAICS
  ...
  {:db/ident :gr/hasNAICS,
   ...
   :rdfs/domain {:owl/unionOf [:gr/BusinessEntity :schema/Organization],
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "has NAICS (0..*)@en",
   :rdfs/range :xsd/int})
...
(def hasNext
  ...
  {:db/ident :gr/hasNext,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "has next (0..1)@en",
...
(def hasOpeningHoursDayOfWeek
  ...
  {:db/ident :gr/hasOpeningHoursDayOfWeek,
   ...
   :rdfs/domain :gr/OpeningHoursSpecification,
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "has opening hours day of week (1..*)@en",
   :rdfs/range :gr/DayOfWeek})
...
(def hasOpeningHoursSpecification
  ...
  {:db/ident :gr/hasOpeningHoursSpecification,
   ...
   :rdfs/domain {:owl/unionOf [:gr/Location :schema/Place],
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "has opening hours specification (0..*)@en",
...
(def hasPOS
  ...
  {:db/ident :gr/hasPOS,
   ...
   :rdfs/domain {:owl/unionOf [:gr/BusinessEntity :schema/Organization],
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "has POS (0..*)@en",
   :rdfs/range :gr/Location})
...
(def hasPrevious
  ...
  {:db/ident :gr/hasPrevious,
   ...
   :rdfs/domain :gr/DayOfWeek,
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "has previous (0..1)@en",
   :rdfs/range :gr/DayOfWeek})
...
(def hasPriceSpecification
  ...
  {:db/ident :gr/hasPriceSpecification,
   ...
   :rdfs/domain {:owl/unionOf [:gr/Offering :schema/Offer],
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "has price specification (0..*)@en",
   :rdfs/range :gr/PriceSpecification})
...
(def hasStockKeepingUnit
  ...
  {:db/ident :gr/hasStockKeepingUnit,
   ...
   :rdfs/domain {:owl/unionOf [:gr/Offering
                 ...
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "has Stock Keeping Unit (0..*)@en",
   :rdfs/range :xsd/string,
   :rdfs/subPropertyOf [:schema/productID :gr/hasStockKeepingUnit]})
...
(def hasUnitOfMeasurement
  ...
  {:db/ident :gr/hasUnitOfMeasurement,
   ...
   :rdfs/domain {:owl/unionOf [:gr/QuantitativeValue
                 ...
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "has unit of measurement (1..1)@en",
   :rdfs/range :xsd/string})
...
(def hasValue
  ...
  {:db/ident :gr/hasValue,
   ...
   :rdfs/domain :gr/QuantitativeValue,
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "has value (0..1)@en",
   :rdfs/range :rdfs/Literal,
   :rdfs/subPropertyOf [:gr/hasMaxValue :gr/hasMinValue :gr/hasValue]})
...
(def hasValueFloat
  ...
  {:db/ident :gr/hasValueFloat,
   ...
   :rdfs/domain :gr/QuantitativeValueFloat,
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "has value float (0..1)@en",
   :rdfs/range :xsd/float,
...
(def hasValueInteger
  ...
  {:db/ident :gr/hasValueInteger,
   ...
   :rdfs/domain :gr/QuantitativeValueInteger,
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "has value integer (0..1)@en",
   :rdfs/range :xsd/int,
...
(def hasWarrantyPromise
  ...
  {:db/ident :gr/hasWarrantyPromise,
   ...
   :rdfs/domain {:owl/unionOf [:gr/Offering :schema/Offer],
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "has warranty promise (0..*)@en",
...
(def hasWarrantyScope
  ...
  {:db/ident :gr/hasWarrantyScope,
   ...
   :rdfs/domain :gr/WarrantyPromise,
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "has warranty scope (0..1)@en",
...
(def height
  ...
  {:db/ident :gr/height,
   ...
   :rdfs/domain {:owl/unionOf [:gr/ProductOrService :schema/Product],
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "height (0..1)@en",
   :rdfs/range :gr/QuantitativeValue,
   :rdfs/subPropertyOf [:gr/quantitativeProductOrServiceProperty :gr/height]})
...
(def includes
  ...
  {:db/ident :gr/includes,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "includes (0..1)@en",
...
(def includesObject
  ...
  {:db/ident :gr/includesObject,
   ...
   :rdfs/domain {:owl/unionOf [:gr/Offering :schema/Offer],
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "includes object (0..*)@en",
...
(def isAccessoryOrSparePartFor
  ...
  {:db/ident :gr/isAccessoryOrSparePartFor,
   ...
   :rdfs/domain {:owl/unionOf [:gr/ProductOrService :schema/Product],
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "is accessory or spare part for (0..*)@en",
   :rdfs/range :gr/ProductOrService})
...
(def isConsumableFor
  ...
  {:db/ident :gr/isConsumableFor,
   ...
   :rdfs/domain {:owl/unionOf [:gr/ProductOrService :schema/Product],
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "is consumable for (0..*)@en",
   :rdfs/range :gr/ProductOrService})
...
(def isListPrice
  ...
  {:db/ident :gr/isListPrice,
   ...
   :rdfs/domain :gr/UnitPriceSpecification,
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "is list price (DEPRECATED)@en",
...
(def isSimilarTo
  ...
  {:db/ident :gr/isSimilarTo,
   ...
   :rdfs/domain {:owl/unionOf [:gr/ProductOrService :schema/Product],
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "is similar to (0..*)@en",
   :rdfs/range :gr/ProductOrService})
...
(def isVariantOf
  ...
  {:db/ident :gr/isVariantOf,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "is variant of (0..1)@en",
   :rdfs/range :gr/ProductOrServiceModel})
...
(def legalName
  ...
  {:db/ident         :gr/legalName,
   :rdf/type         :owl/DatatypeProperty,
   :rdfs/comment     #voc/lstr "The legal name of the gr:BusinessEntity.@en",
   :rdfs/domain      {:owl/unionOf [:gr/BusinessEntity :schema/Organization],
                      :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label       #voc/lstr "legal name (0..1)@en",
   :rdfs/range       :rdfs/Literal})
...
(def lesser
  ...
  {:db/ident :gr/lesser,
   ...
   :rdfs/domain :gr/QualitativeValue,
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "lesser (0..*)@en",
   :rdfs/range :gr/QualitativeValue})
...
(def lesserOrEqual
  ...
  {:db/ident :gr/lesserOrEqual,
   ...
   :rdfs/domain :gr/QualitativeValue,
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "lesser or equal (0..*)@en",
   :rdfs/range :gr/QualitativeValue})
...
(def name
  ...
  {:db/ident :gr/name,
   ...
   :rdfs/domain {:owl/unionOf [:owl/Thing
                 ...
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "name (0..1)@en",
   :rdfs/range :rdfs/Literal})
...
(def nonEqual
  ...
  {:db/ident :gr/nonEqual,
   ...
   :rdfs/domain :gr/QualitativeValue,
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "non equal (0..*)@en",
   :rdfs/range :gr/QualitativeValue})
...
(def offers
  ...
  {:db/ident :gr/offers,
   ...
   :rdfs/domain {:owl/unionOf [:gr/BusinessEntity :schema/Organization],
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "offers (0..*)@en",
   :rdfs/range :gr/Offering})
...
(def opens
  ...
  {:db/ident :gr/opens,
   ...
   :rdfs/domain :gr/OpeningHoursSpecification,
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "opens (1..1)@en",
   :rdfs/range :xsd/time})
...
(def predecessorOf
  ...
  {:db/ident :gr/predecessorOf,
   ...
   :rdfs/domain :gr/ProductOrServiceModel,
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "predecessor of (0..*)@en",
   :rdfs/range :gr/ProductOrServiceModel})
...
(def priceType
  ...
  {:db/ident :gr/priceType,
   ...
   :rdfs/domain :gr/UnitPriceSpecification,
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "price type (0..1)@en",
   :rdfs/range :xsd/string})
...
(def qualitativeProductOrServiceProperty
  ...
  {:db/ident :gr/qualitativeProductOrServiceProperty,
   ...
   :rdfs/domain {:owl/unionOf [:gr/ProductOrService :schema/Product],
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "qualitative product or service property (0..*)@en",
   :rdfs/range :gr/QualitativeValue})
...
(def quantitativeProductOrServiceProperty
  ...
  {:db/ident :gr/quantitativeProductOrServiceProperty,
   ...
   :rdfs/domain {:owl/unionOf [:gr/ProductOrService :schema/Product],
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "quantitative product or service property (0..*)@en",
   :rdfs/range :gr/QuantitativeValue,
...
(def relatedWebService
  ...
  {:db/ident :gr/relatedWebService,
   ...
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "related Web Service (0..*)@en"})
...
(def seeks
  ...
  {:db/ident :gr/seeks,
   ...
   {:owl/unionOf [:gr/BusinessEntity :schema/Organization :schema/Person],
    :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "seeks (0..*)@en",
   :rdfs/range :gr/Offering})
...
(def serialNumber
  ...
  {:db/ident :gr/serialNumber,
   ...
   :rdfs/domain {:owl/unionOf [:gr/Individual :gr/Offering :schema/Product],
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "serial number (0..*)@en",
   :rdfs/range :xsd/string})
...
(def successorOf
  ...
  {:db/ident :gr/successorOf,
   ...
   :rdfs/domain :gr/ProductOrServiceModel,
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "successor of (0..*)@en",
   :rdfs/range :gr/ProductOrServiceModel})
...
(def taxID
  ...
  {:db/ident :gr/taxID,
   ...
   {:owl/unionOf [:gr/BusinessEntity :schema/Organization :schema/Person],
    :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "Tax ID (0..1)@en",
   :rdfs/range :xsd/string})
...
(def typeOfGood
  ...
  {:db/ident :gr/typeOfGood,
   ...
   :rdfs/domain :gr/TypeAndQuantityNode,
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "type of good (1..1)@en",
...
(def validFrom
  ...
  {:db/ident :gr/validFrom,
   ...
   :rdfs/domain {:owl/unionOf [:gr/Offering
                 ...
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "valid from (0..1)@en",
   :rdfs/range :xsd/dateTime})
...
(def validThrough
  ...
  {:db/ident :gr/validThrough,
   ...
   :rdfs/domain {:owl/unionOf [:gr/Offering
                 ...
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "valid through (0..1)@en",
   :rdfs/range :xsd/dateTime})
...
(def valueAddedTaxIncluded
  ...
  {:db/ident :gr/valueAddedTaxIncluded,
   ...
   :rdfs/domain :gr/PriceSpecification,
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "value added tax included (0..1)@en",
   :rdfs/range :xsd/boolean})
...
(def valueReference
  ...
  {:db/ident :gr/valueReference,
   ...
   :rdfs/domain {:owl/unionOf [:gr/QualitativeValue :gr/QuantitativeValue],
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "value reference (0..*)@en",
...
(def vatID
  ...
  {:db/ident :gr/vatID,
   ...
   {:owl/unionOf [:gr/BusinessEntity :schema/Organization :schema/Person],
    :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "VAT ID (0..1)@en",
   :rdfs/range :xsd/string})
...
(def weight
  ...
  {:db/ident :gr/weight,
   ...
   :rdfs/domain {:owl/unionOf [:gr/ProductOrService :schema/Product],
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "weight (0..1)@en",
   :rdfs/range :gr/QuantitativeValue,
   :rdfs/subPropertyOf [:gr/quantitativeProductOrServiceProperty :gr/weight]})
...
(def width
  ...
  {:db/ident :gr/width,
   ...
   :rdfs/domain {:owl/unionOf [:gr/ProductOrService :schema/Product],
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy "http://purl.org/goodrelations/v1",
   :rdfs/label #voc/lstr "width (0..1)@en",
   :rdfs/range :gr/QuantitativeValue,
