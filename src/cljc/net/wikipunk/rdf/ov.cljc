...
(def AfricanRedSlip
  ...
  {:db/ident :ov/AfricanRedSlip,
   ...
   {:rdf/language "en",
    :rdf/value    "Identifies the ware of any African Red-Slip vessel."},
...
(def AmateurRadioContact
  ...
  {:db/ident :ov/AmateurRadioContact,
   ...
   :label/plural
   {:rdf/language "en",
    :rdf/value "Events that are a contact between two AmateurRadioOperators"},
   :rdf/type :owl/Class,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def AmateurRadioOperator
  ...
  {:db/ident :ov/AmateurRadioOperator,
   ...
   :label/plural {:rdf/language "en",
                  :rdf/value    "Amateur Radio Operators"},
   :rdf/type :owl/Class,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
   ...
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "Amateur Radio Operator"},
...
(def AutomobileCataologType
  ...
  {:db/ident :ov/AutomobileCataologType,
   :label/plural {:rdf/language "en",
                  :rdf/value    "Automobile Catalog Types"},
   :rdf/type :owl/Class,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
   ...
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "Automobile Catalog Type"},
   :vs/term_status "unstable",
...
(def BiologicalDatabase
  ...
  {:db/ident               :ov/BiologicalDatabase,
   :label/plural           {:rdf/language "en",
                            :rdf/value    "Biological Databases"},
   :ov/markdownDescription {:rdf/language "en",
                            :rdf/value
                            "A Database for Biologists (Bioinformatics)"},
   :rdf/type               :owl/Class,
...
(def DOMBoundaryPointPosition
  ...
  {:db/ident :ov/DOMBoundaryPointPosition,
   :label/plural {:rdf/language "en",
                  :rdf/value    "DOMBoundaryPointPositions"},
   :rdf/type :owl/Class,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
   ...
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "DOMBoundaryPointPosition"},
   :vs/term_status "unstable",
...
(def DOMOffset
  ...
  {:db/ident         :ov/DOMOffset,
   ...
   :rdf/type         :owl/Class,
   :rdfs/comment     {:rdf/language "en",
                      :rdf/value    "the offset within a DOM node"},
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label       {:rdf/language "en",
                      :rdf/value    "DOMOffset"},
   :vs/term_status   "unstable",
...
(def Film
  ...
  {:db/ident         :ov/Film,
   ...
   :rdf/type         :owl/Class,
   :rdfs/comment     {:rdf/language "en",
                      :rdf/value    "The class of all motion pictures"},
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label       {:rdf/language "en",
                      :rdf/value    "Film"},
   :vs/term_status   "unstable",
...
(def HUDCourseLoan
  ...
  {:db/ident         :ov/HUDCourseLoan,
   :label/plural     {:rdf/language "en",
                      :rdf/value    "The loan history for a book by course"},
   :rdf/type         :owl/Class,
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label       {:rdf/language "en",
                      :rdf/value    "Course Loan History"},
   :vs/term_status   "unstable",
...
(def HUDSchoolLoan
  ...
  {:db/ident         :ov/HUDSchoolLoan,
   :rdf/type         :owl/Class,
   :rdfs/comment     {:rdf/language "en",
                      :rdf/value "The loan history of a book within a school"},
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label       {:rdf/language "en",
                      :rdf/value    "School Loan History"},
   :vs/term_status   "unstable",
...
(def HUDSuggestion
  ...
  {:db/ident         :ov/HUDSuggestion,
   :rdf/type         :owl/Class,
   :rdfs/comment     {:rdf/language "en",
                      :rdf/value    "Suggested book based on circulation data"},
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label       {:rdf/language "en",
                      :rdf/value    "Suggestion"},
   :vs/term_status   "unstable",
...
(def HUDYearLoan
  ...
  {:db/ident         :ov/HUDYearLoan,
   :rdf/type         :owl/Class,
   :rdfs/comment     {:rdf/language "en",
                      :rdf/value    "The loan history for a book by year."},
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label       {:rdf/language "en",
                      :rdf/value    "Year Loan History"},
   :vs/term_status   "unstable",
...
(def House
  ...
  {:db/ident               :ov/House,
   :label/plural           {:rdf/language "en",
                            :rdf/value    "Houses"},
   :ov/markdownDescription {:rdf/language "en",
                            :rdf/value    "This is just a test"},
   :owl/disjointWith       :ov/horse,
   :owl/equivalentClass    :ov/domicile,
   :rdf/type               :owl/Class,
   :rdfs/comment           {:rdf/language "en",
                            :rdf/value    "Structure in which someone lives"},
   :rdfs/isDefinedBy       "http://open.vocab.org/terms",
   :rdfs/label             {:rdf/language "en",
                            :rdf/value    "House"},
...
(def ITUREgion
  ...
  {:db/ident :ov/ITUREgion,
   ...
   :label/plural {:rdf/language "en",
                  :rdf/value "ITU Regions for governance of radio operation"},
   :rdf/type :owl/Class,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
   ...
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "ITU Region for governance of radio operation"},
...
(def IllegalRDFXMLStatement
  ...
  {:db/ident :ov/IllegalRDFXMLStatement,
   :label/plural {:rdf/language "en",
                  :rdf/value    "Illegal RDF/XML Statements"},
   :ov/markdownDescription
   {:rdf/language "en",
    :rdf/value
   ...
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "Illegal RDF/XML Statement"},
...
(def IrcBot
  ...
  {:db/ident         :ov/IrcBot,
   ...
   :rdf/type         :owl/Class,
   :rdfs/comment     {:rdf/language "en",
                      :rdf/value    "An irc chat bot"},
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label       {:rdf/language "en",
                      :rdf/value    "IrcBot"},
   :rdfs/subClassOf  "http://xmlns.com/foaf/spec/#term_Agent",
   :vs/term_status   "unstable",
...
(def KillerGorilla
  ...
  {:db/ident         :ov/KillerGorilla,
   ...
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label       {:rdf/language "en",
                      :rdf/value    "Killer Gorilla"},
   :rdfs/subClassOf  "http://umbel.org/umbel/sc/Gorilla",
   :vs/term_status   "unstable",
...
(def MOTTestingStation
  ...
  {:db/ident :ov/MOTTestingStation,
   ...
   :label/plural {:rdf/language "en",
                  :rdf/value    "MOT Testing Stations"},
   :rdf/type :owl/Class,
   :rdfs/comment {:rdf/language "en",
                  :rdf/value    "The class of all MOT Testing Stations."},
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "MOT Testing Station"},
...
(def NewsItem
  ...
  {:db/ident :ov/NewsItem,
   ...
   :label/plural {:rdf/language "en",
                  :rdf/value    "News items"},
   :rdf/type :owl/Class,
   :rdfs/comment {:rdf/language "en",
                  :rdf/value    "A piece of News"},
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "News item"},
...
(def PrimaryVisualElement
  ...
  {:db/ident         :ov/PrimaryVisualElement,
   :label/plural     {:rdf/language "en",
                      :rdf/value    "Primary Visual Elements"},
   :rdf/type         :owl/Class,
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label       {:rdf/language "en",
                      :rdf/value    "Primary Visual Element"},
...
(def RTFMImperative
  ...
  {:db/ident :ov/RTFMImperative,
   :label/plural {:rdf/language "en",
                  :rdf/value    "instructions to RTFM"},
   :rdf/type :owl/Class,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def RadioOperationFrequency
  ...
  {:db/ident :ov/RadioOperationFrequency,
   ...
   :label/plural {:rdf/language "en",
                  :rdf/value    "Frequencies of operation of a radio."},
   :rdf/type :owl/Class,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
   ...
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "Frequency of operation of a radio."},
...
(def ScientificDatabase
  ...
  {:db/ident         :ov/ScientificDatabase,
   :label/plural     {:rdf/language "en",
                      :rdf/value    "Scientific Databases"},
   :rdf/type         :owl/Class,
   :rdfs/comment     {:rdf/language "en",
                      :rdf/value    "A Scientific Database"},
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label       {:rdf/language "en",
                      :rdf/value    "Scientific Database"},
...
(def SportEvent
  ...
  {:db/ident         :ov/SportEvent,
   :rdf/type         :owl/Class,
   :rdfs/comment     {:rdf/language "en",
                      :rdf/value    "e.g. : 100m in Beijing 2008"},
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label       {:rdf/language "en",
                      :rdf/value    "Sport Event "},
   :rdfs/subClassOf  :event/Event,
   :vs/term_status   "unstable",
...
(def StillAKillerGorilla
  ...
  {:db/ident :ov/StillAKillerGorilla,
   :label/plural {:rdf/language "en",
                  :rdf/value    "Living Killer Gorillas"},
   :ov/markdownDescription
   {:rdf/language "en",
    :rdf/value
   ...
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value "Indicates that the subject is a non-deceased killer gorilla."},
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "Living Killer Gorilla"},
...
(def SummerOlympicGames
  ...
  {:db/ident         :ov/SummerOlympicGames,
   ...
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label       {:rdf/language "en",
                      :rdf/value    "Summer Olympic Games"},
...
(def UnivCourse
  ...
  {:db/ident         :ov/UnivCourse,
   :rdf/type         :owl/Class,
   :rdfs/comment     {:rdf/language "en",
                      :rdf/value    "A course taught at a university"},
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label       {:rdf/language "en",
                      :rdf/value    "University Course"},
...
(def VisualElement
  ...
  {:db/ident :ov/VisualElement,
   ...
   :rdf/type :owl/Class,
   :rdfs/comment {:rdf/language "en",
                  :rdf/value    "A thing that manifests visually."},
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "Visual Element"},
   :vs/term_status "unstable",
...
(def Vocabulary
  ...
  {:db/ident :ov/Vocabulary,
   ...
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value "A set of terms or names, each one having an assigned meaning."},
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
...
(def WheelChairEnabled
  ...
  {:db/ident :ov/WheelChairEnabled,
   ...
   :label/plural {:rdf/language "en",
                  :rdf/value    "wheel chair enabled"},
   :rdf/type :owl/Class,
   :rdfs/comment {:rdf/language "en",
                  :rdf/value "A place that is accessible with a wheel chair."},
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "wheel chair enabled"},
...
(def WinterOlympicGames
  ...
  {:db/ident         :ov/WinterOlympicGames,
   ...
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label       {:rdf/language "en",
                      :rdf/value    "Winter Olympic Games"},
   :rdfs/subClassOf  :ov/OlympicGames,
   :vs/term_status   "unstable",
...
(def ZoiaCommand
  ...
  {:db/ident         :ov/ZoiaCommand,
   ...
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label       {:rdf/language "en",
                      :rdf/value    "ZoiaCommand"},
   :rdfs/subClassOf  "http://rdfs.org/sioc/spec/#term_Post",
   :vs/term_status   "unstable",
...
(def affiliation
  ...
  {:db/ident :ov/affiliation,
   :label/plural {:rdf/language "en",
                  :rdf/value    "Personal or Professional Affiliations"},
   :rdf/type :rdf/Property,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
   ...
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "Personal or Professional Affiliation"},
...
(def aggregates
  ...
  {:db/ident :ov/aggregates,
   :label/plural {:rdf/language "en",
                  :rdf/value    "syndicates"},
   :rdf/type :rdf/Property,
   :rdfs/comment {:rdf/language "en",
                  :rdf/value    "An agent syndicates a document some way."},
...
(def anniversary
  ...
  {:db/ident :ov/anniversary,
   ...
   :rdf/type :rdf/Property,
   :rdfs/comment {:rdf/language "en",
                  :rdf/value    "The anniversary of some event"},
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
...
(def areaHectares
  ...
  {:db/ident :ov/areaHectares,
   :label/plural {:rdf/language "en",
                  :rdf/value    "Area in Hectares"},
   :owl/equivalentProperty
   "http://data.ordnancesurvey.co.uk/ontology/geometry/hectares",
   :rdf/type :rdf/Property,
   :rdfs/comment {:rdf/language "en",
                  :rdf/value    "The area of some physical thing in hectares."},
...
(def attestsTo
  ...
  {:db/ident :ov/attestsTo,
   :label/plural {:rdf/language "en",
                  :rdf/value "Providing evidence for existence or historicity"},
   :ov/markdownDescription
   {:rdf/language "en",
    :rdf/value
...
(def avatarBendingElement
  ...
  {:db/ident :ov/avatarBendingElement,
   ...
   :label/plural {:rdf/language "en",
                  :rdf/value    "The Elements an Individual Can Bend"},
   :rdf/type :rdf/Property,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
   ...
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "The Element an Individual Can Bend"},
...
(def avatarEyeColor
  ...
  {:db/ident :ov/avatarEyeColor,
   ...
   :label/plural {:rdf/language "en",
                  :rdf/value    "Color of Eyes of an Individual"},
   :rdf/type :rdf/Property,
   :rdfs/comment {:rdf/language "en",
                  :rdf/value    "Describes the eye color of an individual"},
   :rdfs/domain :ov/AvatarCharacterTraits,
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "Color of Eyes of an Individual"},
...
(def avatarFirstAppearance
  ...
  {:db/ident :ov/avatarFirstAppearance,
   ...
   :label/plural {:rdf/language "en",
                  :rdf/value    "First Appearances of Character"},
   :rdf/type :rdf/Property,
   :rdfs/comment {:rdf/language "en",
                  :rdf/value
                  "Describes when the character was introduced in the series."},
   ...
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "First Appearance of Character"},
...
(def avatarHairColor
  ...
  {:db/ident :ov/avatarHairColor,
   ...
   :label/plural {:rdf/language "en",
                  :rdf/value    "Hair Color of an Individual"},
   :rdf/type :rdf/Property,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value "Defines the hair color (or no hair at all!) of an individual"},
   :rdfs/domain :ov/AvatarCharacterTraits,
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "Color of Hair of an Individual"},
...
(def avatarNationality
  ...
  {:db/ident :ov/avatarNationality,
   :label/plural {:rdf/language "en",
                  :rdf/value
                  "Nationalities of a Character in Graphic Novel Avatar"},
   :rdf/type :rdf/Property,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def avatarPosition
  ...
  {:db/ident :ov/avatarPosition,
   ...
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value "Position of the Character in Graphic Novel Avatar"},
...
(def blid
  ...
  {:db/ident :ov/blid,
   ...
   :label/plural {:rdf/language "en",
                  :rdf/value    "British Library identifiers"},
   :rdf/type :rdf/Property,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
   ...
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "British Library identifier"},
...
(def businessCard
  ...
  {:db/ident :ov/businessCard,
   :label/plural {:rdf/language "en",
                  :rdf/value    "Business Cards"},
   :owl/equivalentProperty "http://purl.org/uF/hCard/terms/hasCard",
   :rdf/type :rdf/Property,
   :rdfs/comment {:rdf/language "en",
                  :rdf/value "A business card associated with this resource."},
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "Business Card"},
...
(def calendar
  ...
  {:db/ident :ov/calendar,
   ...
   :rdf/type :rdf/Property,
   :rdfs/comment {:rdf/language "en",
                  :rdf/value    "A calendar associated with this resource."},
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "Calendar"},
...
(def classSkeletonIgnore
  ...
  {:db/ident :ov/classSkeletonIgnore,
   ...
   :label/plural {:rdf/language "en",
                  :rdf/value    "class skeleton ignore"},
   :rdf/type :rdf/Property,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def commonManifestation
  ...
  {:db/ident :ov/commonManifestation,
   :label/plural {:rdf/language "en",
                  :rdf/value    "Common Manifestations"},
   :rdf/type [:rdf/Property :owl/SymmetricProperty],
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
   ...
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "Common Manifestation"},
   :rdfs/range :rdfs/Resource,
   :rdfs/subPropertyOf :ov/commonEndeavour,
   :skos/note
...
(def compassDirection
  ...
  {:db/ident :ov/compassDirection,
   ...
   :rdf/type :rdf/Property,
   :rdfs/comment {:rdf/language "en",
                  :rdf/value    "The Compass Direction that a Thing faces."},
   :rdfs/domain :geo/SpatialThing,
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "Compass Direction"},
   :rdfs/range :rdfs/Literal,
   :vs/term_status "unstable",
...
(def compressedFileSize
  ...
  {:db/ident :ov/compressedFileSize,
   ...
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "compressed dataset file has fileSize"},
   :rdfs/range :xsd/string,
...
(def csvCol
  ...
  {:db/ident :ov/csvCol,
   :label/plural {:rdf/language "en",
                  :rdf/value    "csv columns"},
   :ov/markdownDescription {:rdf/language "en",
                            :rdf/value
                            "see also http://open.vocab.org/terms/csvRow"},
   :rdf/type :rdf/Property,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def dateOfDeath
  ...
  {:db/ident         :ov/dateOfDeath,
   :label/plural     {:rdf/language "en",
                      :rdf/value    "Dates of Death"},
   :rdf/type         :rdf/Property,
   :rdfs/comment     {:rdf/language "en",
                      :rdf/value    "The date someone died."},
   :rdfs/domain      :foaf/Person,
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label       {:rdf/language "en",
...
(def departureDate
  ...
  {:db/ident         :ov/departureDate,
   :label/plural     {:rdf/language "en",
                      :rdf/value    "departure dates"},
   :rdf/type         [:owl/FunctionalProperty :rdf/Property],
   :rdfs/comment     {:rdf/language "en",
                      :rdf/value    "Date and time your travel will commence"},
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label       {:rdf/language "en",
                      :rdf/value    "departure date"},
   :vs/term_status   "unstable",
...
(def depictsSameResourceAs
  ...
  {:db/ident :ov/depictsSameResourceAs,
   :label/plural {:rdf/language "en",
                  :rdf/value    "depict same resource as"},
   :ov/markdownDescription
   {:rdf/language "en",
    :rdf/value
   ...
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "depicts same resource as"},
...
(def diffSource
  ...
  {:db/ident         :ov/diffSource,
   :rdf/type         [:owl/FunctionalProperty :rdf/Property],
   :rdfs/comment     {:rdf/language "en",
                      :rdf/value    "The resource that this diff goes from."},
   :rdfs/domain      :ov/Diff,
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label       {:rdf/language "en",
                      :rdf/value    "source"},
...
(def diffTarget
  ...
  {:db/ident         :ov/diffTarget,
   :rdf/type         [:owl/FunctionalProperty :rdf/Property],
   :rdfs/comment     {:rdf/language "en",
                      :rdf/value    "The resource that this diff goes to."},
   :rdfs/domain      :ov/Diff,
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label       {:rdf/language "en",
                      :rdf/value    "target"},
...
(def dimensionProperty
  ...
  {:db/ident :ov/dimensionProperty,
   ...
   :label/plural {:rdf/language "en",
                  :rdf/value    "Dimension Properties"},
   :rdf/type :rdf/Property,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def earwormTransmitter
  ...
  {:db/ident         :ov/earwormTransmitter,
   :label/plural     {:rdf/language "en",
                      :rdf/value    "Earworm Transmitters"},
   :rdf/type         :rdf/Property,
   :rdfs/comment     {:rdf/language "en",
                      :rdf/value    "The transmitter of a particular Earworm"},
   :rdfs/domain      :ov/Earworm,
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label       {:rdf/language "en",
                      :rdf/value    "Earworm Transmitter"},
   :rdfs/range       :foaf/Person,
   :vs/term_status   "unstable",
...
(def endTime
  ...
  {:db/ident         :ov/endTime,
   :rdf/type         :rdf/Property,
   :rdfs/comment     {:rdf/language "en",
                      :rdf/value    "The time of day that something ends."},
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label       {:rdf/language "en",
                      :rdf/value    "End Time"},
   :vs/term_status   "unstable",
...
(def enhancedDescription
  ...
  {:db/ident :ov/enhancedDescription,
   :label/plural {:rdf/language "en",
                  :rdf/value    "enhanced descriptions"},
   :ov/markdownDescription
   {:rdf/language "en",
    :rdf/value
   ...
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "enhanced description"},
...
(def eyeColor
  ...
  {:db/ident :ov/eyeColor,
   ...
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "Color of Eye of an Individual"},
...
(def familiarName
  ...
  {:db/ident :ov/familiarName,
   :label/plural {:rdf/language "en",
                  :rdf/value    "Familiar Names"},
   :rdf/type :rdf/Property,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value "The name used in familiar situations by friends, e.g. Ian\n"},
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "Familiar Name"},
...
(def fileSize
  ...
  {:db/ident :ov/fileSize,
   ...
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "dataset file has fileSize"},
   :rdfs/range :xsd/string,
...
(def findspot
  ...
  {:db/ident         :ov/findspot,
   ...
   :rdf/type         :rdf/Property,
   :rdfs/comment     {:rdf/language "en",
                      :rdf/value    "The place at which a thing is found."},
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label       {:rdf/language "en",
                      :rdf/value    "Findspot"},
   :vs/term_status   "unstable",
...
(def firstSentence
  ...
  {:db/ident         :ov/firstSentence,
   :label/plural     {:rdf/language "en",
                      :rdf/value    "First Sentences"},
   :rdf/type         :rdf/Property,
   :rdfs/comment     {:rdf/language "en",
                      :rdf/value    "The first sentence of a resource."},
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label       {:rdf/language "en",
                      :rdf/value    "First Sentence"},
   :rdfs/range       :rdfs/Literal,
   :vs/term_status   "unstable",
...
(def geoBoundaryDefiner
  ...
  {:db/ident :ov/geoBoundaryDefiner,
   ...
   :label/plural {:rdf/language "en",
                  :rdf/value    "Geographic Boundary Definers"},
   :rdf/type :rdf/Property,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value "The agent that defines the boundaries of a geographic area."},
   :rdfs/domain "http://www.geonames.org/ontology#Feature",
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "Geographic Boundary Definer"},
...
(def has
  ...
  {:db/ident         :ov/has,
   ...
   :rdf/type         :rdf/Property,
   :rdfs/comment     {:rdf/language "en",
                      :rdf/value    "Boundary point has a position"},
...
(def hasBoundary
  ...
  {:db/ident         :ov/hasBoundary,
   :label/plural     {:rdf/language "en",
                      :rdf/value    "have boundaries"},
   :rdf/type         :rdf/Property,
   :rdfs/comment     {:rdf/language "en",
                      :rdf/value    "DOMRange has 2 boundary points"},
   :rdfs/domain      :ov/DOMRange,
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label       {:rdf/language "en",
                      :rdf/value    "has boundary"},
...
(def hasMD5
  ...
  {:db/ident         :ov/hasMD5,
   :label/plural     {:rdf/language "en",
                      :rdf/value    "has MD5 checksums"},
   :rdf/type         :rdf/Property,
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label       {:rdf/language "en",
                      :rdf/value    "has MD5 checksum"},
   :vs/term_status   "unstable",
...
(def hasOffset
  ...
  {:db/ident               :ov/hasOffset,
   :label/plural           {:rdf/language "en",
                            :rdf/value    "has offsets"},
   :ov/markdownDescription {:rdf/language "en",
                            :rdf/value
                            "TODO: How should this be used? Offset from what?"},
   :rdf/type               :rdf/Property,
   :rdfs/isDefinedBy       "http://open.vocab.org/terms",
   :rdfs/label             {:rdf/language "en",
                            :rdf/value    "has offset"},
   :vs/term_status         "unstable",
...
(def hasPlot
  ...
  {:db/ident :ov/hasPlot,
   ...
   :rdf/type :rdf/Property,
   :rdfs/comment {:rdf/language "en",
                  :rdf/value    "Something has a plot."},
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "hasPlot"},
   :rdfs/range :ov/Plot,
...
(def hasPosition
  ...
  {:db/ident         :ov/hasPosition,
   :label/plural     {:rdf/language "en",
                      :rdf/value    "have positions"},
   :rdf/type         :rdf/Property,
   :rdfs/domain      :ov/DOMBoundaryPoint,
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label       {:rdf/language "en",
                      :rdf/value    "has position"},
   :rdfs/range       :ov/DOMBoundaryPointPosition,
   :vs/term_status   "unstable",
...
(def houseColor
  ...
  {:db/ident               :ov/houseColor,
   :label/plural           {:rdf/language "en",
                            :rdf/value    "houseColor"},
   :ov/markdownDescription {:rdf/language "en",
                            :rdf/value
                            "I bet I'm going to wish i could delete this"},
   :owl/equivalentProperty :ov/housePaintColor,
   :owl/inverseOf          :ov/colorsOfHouses,
   :rdf/type               [:rdf/Property :owl/TransitiveProperty],
   :rdfs/comment           {:rdf/language "en",
                            :rdf/value    "color of a house"},
...
(def hudCourse
  ...
  {:db/ident         :ov/hudCourse,
   :rdf/type         :rdf/Property,
   :rdfs/comment     {:rdf/language "en",
                      :rdf/value    "A course associated with a book loan"},
...
(def hudYear
  ...
  {:db/ident         :ov/hudYear,
   :rdf/type         :rdf/Property,
   :rdfs/comment     {:rdf/language "en",
                      :rdf/value    "The year associated with a loan history"},
...
(def icon
  ...
  {:db/ident :ov/icon,
   ...
   :rdf/type :rdf/Property,
   :rdfs/comment {:rdf/language "en",
                  :rdf/value    "a pictorial representation for something."},
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "Icon"},
...
(def json
  ...
  {:db/ident :ov/json,
   :label/plural {:rdf/language "en",
                  :rdf/value    "JSON representations"},
...
(def lastCachedPage
  ...
  {:db/ident :ov/lastCachedPage,
   ...
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value "The most recently cached static page describing the resource."},
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "Last Cached Page"},
   :rdfs/range :foaf/Document,
...
(def length
  ...
  {:db/ident               :ov/length,
   ...
   :rdf/type               :rdf/Property,
   :rdfs/comment           {:rdf/language "en",
                            :rdf/value    "The linear extent of a thing."},
   :rdfs/isDefinedBy       "http://open.vocab.org/terms",
   :rdfs/label             {:rdf/language "en",
                            :rdf/value    "Length"},
   :vs/term_status         "unstable",
...
(def maidenName
  ...
  {:db/ident :ov/maidenName,
   ...
   :label/plural {:rdf/language "en",
                  :rdf/value    "Maiden Names"},
   :rdf/type :rdf/Property,
   :rdfs/comment {:rdf/language "en",
                  :rdf/value    "A person's maiden name."},
   :rdfs/domain :foaf/Person,
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "Maiden Name"},
   :rdfs/range :rdfs/Literal,
...
(def namedPlace
  ...
  {:db/ident           :ov/namedPlace,
   :label/plural       {:rdf/language "en",
                        :rdf/value    "Named places"},
   :rdf/type           :rdf/Property,
   :rdfs/comment       {:rdf/language "en",
                        :rdf/value    "Places named in a text."},
   :rdfs/isDefinedBy   "http://open.vocab.org/terms",
   :rdfs/label         {:rdf/language "en",
                        :rdf/value    "Named place"},
...
(def national-grid-reference
  ...
  {:db/ident :ov/national-grid-reference,
   :label/plural {:rdf/language "en",
                  :rdf/value    "National Grid References"},
   :ov/markdownDescription
   {:rdf/language "en",
    :rdf/value
   ...
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "National Grid Reference"},
   :vs/term_status "unstable",
...
(def nationalContextMap
  ...
  {:db/ident :ov/nationalContextMap,
   :label/plural {:rdf/language "en",
                  :rdf/value    "National Context Maps"},
   :rdf/type :rdf/Property,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
   ...
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "National Context Map"},
   :vs/term_status "unstable",
...
(def networkVisibility
  ...
  {:db/ident :ov/networkVisibility,
   :label/plural {:rdf/language "en",
                  :rdf/value    "Network Visibilities"},
   :rdf/type :rdf/Property,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def noOfReviewsWritten
  ...
  {:db/ident :ov/noOfReviewsWritten,
   ...
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "Number of Reviews Written"},
   :rdfs/range :rdfs/Literal,
   :vs/term_status "unstable",
...
(def numberOfPages
  ...
  {:db/ident         :ov/numberOfPages,
   :label/plural     {:rdf/language "en",
                      :rdf/value    "Numbers of Pages"},
   :rdf/type         :rdf/Property,
   :rdfs/comment     {:rdf/language "en",
                      :rdf/value    "The number of pages a resource has"},
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label       {:rdf/language "en",
...
(def offeredBy
  ...
  {:db/ident :ov/offeredBy,
   ...
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "Offering organization"},
   :rdfs/range :foaf/Organization,
...
(def origin
  ...
  {:db/ident :ov/origin,
   ...
   :rdf/type :rdf/Property,
   :rdfs/comment {:rdf/language "en",
                  :rdf/value    "The source of a thing."},
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "Origin"},
   :vs/term_status "unstable",
...
(def originatesFrom
  ...
  {:db/ident :ov/originatesFrom,
   :label/plural {:rdf/language "en",
                  :rdf/value    "Originally from time and place"},
   :ov/markdownDescription
   {:rdf/language "en",
    :rdf/value
...
(def part
  ...
  {:db/ident               :ov/part,
   :label/plural           {:rdf/language "en",
                            :rdf/value    "Parts"},
   :ov/markdownDescription {:rdf/language "en",
                            :rdf/value    "Example: wheel is a part of a car."},
   :rdf/type               :rdf/Property,
   :rdfs/comment           {:rdf/language "en",
                            :rdf/value    "An element of a whole."},
   :rdfs/isDefinedBy       "http://open.vocab.org/terms",
   :rdfs/label             {:rdf/language "en",
                            :rdf/value    "Part"},
   :vs/term_status         "unstable",
...
(def passwd
  ...
  {:db/ident :ov/passwd,
   ...
   :rdf/type :rdf/Property,
   :rdfs/comment {:rdf/language "en",
                  :rdf/value    "a password usually stored in md5"},
...
(def plot
  ...
  {:db/ident               :ov/plot,
   :label/plural           {:rdf/language "en",
                            :rdf/value    "Plots"},
   :ov/markdownDescription {:rdf/language "en",
                            :rdf/value    "Example: a film's plot."},
   :rdf/type               :rdf/Property,
   :rdfs/comment           {:rdf/language "en",
                            :rdf/value    "A plot of anything."},
   :rdfs/isDefinedBy       "http://open.vocab.org/terms",
...
(def preferredAnimal
  ...
  {:db/ident :ov/preferredAnimal,
   ...
   :label/plural {:rdf/language "en",
                  :rdf/value    "Preferred animals"},
   :rdf/type :rdf/Property,
   :rdfs/comment {:rdf/language "en",
                  :rdf/value    "The preferred animal of a person."},
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "Preferred animal"},
...
(def provenance
  ...
  {:db/ident :ov/provenance,
   ...
   :rdf/type [:owl/SymmetricProperty :rdf/Property],
   :rdfs/comment {:rdf/language "en",
                  :rdf/value    "It is about provenance of web data."},
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "provenance"},
...
(def rank
  ...
  {:db/ident :ov/rank,
   ...
   :ov/markdownDescription {:rdf/language "en",
                            :rdf/value
                            "The first resource has an ov:rank of 1."},
   :rdf/type :rdf/Property,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
...
(def regionalContextMap
  ...
  {:db/ident :ov/regionalContextMap,
   :label/plural {:rdf/language "en",
                  :rdf/value    "Regional Context Maps"},
   :rdf/type :rdf/Property,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
   ...
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "Regional Context Map"},
   :vs/term_status "unstable",
...
(def reincarnationOf
  ...
  {:db/ident :ov/reincarnationOf,
   ...
   :label/plural {:rdf/language "en",
                  :rdf/value    "Reincarnations of an Individual"},
   :rdf/type :rdf/Property,
   :rdfs/comment {:rdf/language "en",
                  :rdf/value    "Defines reincarnation of someone"},
   :rdfs/domain "http://purl.org/vocab/relationship/",
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "Reincarnation of an Individual"},
...
(def responsiblityOf
  ...
  {:db/ident :ov/responsiblityOf,
   ...
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "Responsible organization"},
   :rdfs/range :foaf/Organization,
   :skos/note
...
(def rimDiameter
  ...
  {:db/ident :ov/rimDiameter,
   ...
   :rdf/type :rdf/Property,
   :rdfs/comment {:rdf/language "en",
                  :rdf/value    "The diameter of a thing measured at its rim."},
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "Diameter at rim"},
   :vs/term_status "unstable",
...
(def semester
  ...
  {:db/ident :ov/semester,
   ...
   :rdf/type :rdf/Property,
   :rdfs/comment {:rdf/language "en",
                  :rdf/value    "Semester in which the course is offered"},
   :rdfs/domain :ov/Course,
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "Semester"},
...
(def shape
  ...
  {:db/ident         :ov/shape,
   ...
   :rdf/type         :rdf/Property,
   :rdfs/comment     {:rdf/language "en",
                      :rdf/value    "The shape of something"},
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label       {:rdf/language "en",
                      :rdf/value    "Shape"},
   :vs/term_status   "unstable",
...
(def shortName
  ...
  {:db/ident         :ov/shortName,
   :label/plural     {:rdf/language "en",
                      :rdf/value    "Short Names"},
   :rdf/type         :rdf/Property,
   :rdfs/comment     {:rdf/language "en",
                      :rdf/value "Just a simple readable name, a mnemonic. "},
   :rdfs/domain      :ov/DigitalAsset,
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label       {:rdf/language "en",
                      :rdf/value    "Short Name"},
   :rdfs/range       :rdfs/Literal,
   :vs/term_status   "unstable",
...
(def sindiceResultCount
  ...
  {:db/ident :ov/sindiceResultCount,
   :label/plural {:rdf/language "en",
                  :rdf/value    "Sindice Result Counts"},
   :rdf/type [:owl/FunctionalProperty :rdf/Property],
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value
   ...
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "Sindice Result Count"},
   :vs/term_status "unstable",
...
(def sort-name
  ...
  {:db/ident :ov/sort-name,
   :label/plural {:rdf/language "en",
                  :rdf/value    "Sort names"},
   :ov/markdownDescription {:rdf/language "en",
                            :rdf/value
                            "Isn't this the same thing as sortLabel?"},
   :rdf/type :rdf/Property,
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value "Associate a name that can be used for sorting to a foaf:Agent"},
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "Sort name"},
   :vs/term_status "unstable",
...
(def startTime
  ...
  {:db/ident         :ov/startTime,
   :rdf/type         :rdf/Property,
   :rdfs/comment     {:rdf/language "en",
                      :rdf/value "The time of day that something starts at."},
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label       {:rdf/language "en",
                      :rdf/value    "Start Time"},
   :vs/term_status   "unstable",
...
(def stickiness
  ...
  {:db/ident         :ov/stickiness,
   :label/plural     {:rdf/language "en",
                      :rdf/value    "Stickiness"},
   :rdf/type         :rdf/Property,
   :rdfs/comment     {:rdf/language "en",
                      :rdf/value "The the measure of how sticky something is"},
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label       {:rdf/language "en",
                      :rdf/value    "Stickiness"},
   :vs/term_status   "unstable",
...
(def taggingCount
  ...
  {:db/ident :ov/taggingCount,
   :label/plural {:rdf/language "en",
                  :rdf/value    "Tagging Counts"},
   :rdf/type [:rdf/Property :owl/FunctionalProperty],
   :rdfs/comment
   {:rdf/language "en",
    :rdf/value "the number of times a tag has been used in taggings of things"},
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "Tagging Count"},
   :rdfs/range :rdfs/Literal,
   :vs/term_status "unstable",
...
(def twitter-id
  ...
  {:db/ident         :ov/twitter-id,
   :label/plural     {:rdf/language "en",
                      :rdf/value    "Twitter IDs"},
   :rdf/type         [:owl/InverseFunctionalProperty :rdf/Property],
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label       {:rdf/language "en",
                      :rdf/value    "Twitter ID"},
   :vs/term_status   "unstable",
...
(def uses
  ...
  {:db/ident         :ov/uses,
   :rdf/type         :rdf/Property,
   :rdfs/comment     {:rdf/language "en",
                      :rdf/value    "links to a thing used by an agent"},
   :rdfs/domain      :foaf/Agent,
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label       {:rdf/language "en",
                      :rdf/value    "uses"},
...
(def weight
  ...
  {:db/ident         :ov/weight,
   ...
   :rdf/type         :rdf/Property,
   :rdfs/comment     {:rdf/language "en",
                      :rdf/value    "The weight of a resource"},
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label       {:rdf/language "en",
                      :rdf/value    "Weight"},
   :rdfs/range       :rdfs/Literal,
...
(def wikiPage
  ...
  {:db/ident :ov/wikiPage,
   :label/plural {:rdf/language "en",
                  :rdf/value    "Wiki Pages"},
   :rdf/type :rdf/Property,
   :rdfs/comment {:rdf/language "en",
                  :rdf/value    "A wiki page associated with this resource"},
   :rdfs/isDefinedBy "http://open.vocab.org/terms",
   :rdfs/label {:rdf/language "en",
                :rdf/value    "Wiki Page"},
   :rdfs/range :foaf/Document,
