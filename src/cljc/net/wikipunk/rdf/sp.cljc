...
(def Aggregation
  ...
  {:db/ident :sp/Aggregation,
   ...
   :rdfs/subClassOf [:sp/SystemClass :sp/Aggregation :rdfs/Resource]})
...
(def AltPath
  ...
  {:db/ident :sp/AltPath,
   ...
   :rdfs/label "Alt path",
   :rdfs/subClassOf [:sp/Path :sp/AltPath :rdfs/Resource :sp/SystemClass]})
...
(def Command
  ...
  {:db/ident :sp/Command,
   ...
   "A shared superclass for sp:Query and sp:Update that can be used to specify that the range of property can be either one.",
   :rdfs/label "Command",
   :rdfs/subClassOf [:sp/SystemClass :sp/Command :rdfs/Resource]})
...
(def Element
  ...
  {:db/ident        :sp/Element,
   ...
   :rdfs/label      "Element",
   :rdfs/subClassOf [:sp/SystemClass :sp/Element :rdfs/Resource]})
...
(def Exists
  ...
  {:db/ident :sp/Exists,
   ...
   :rdfs/label "Exists",
   :rdfs/subClassOf
   [:sp/ElementGroup :sp/Exists :sp/Element :rdfs/Resource :sp/SystemClass]})
...
(def Let
  ...
  {:db/ident :sp/Let,
   ...
   :rdfs/label "Let",
   :rdfs/subClassOf
   [:sp/Bind :sp/Let :sp/Element :rdfs/Resource :sp/SystemClass]})
...
(def Minus
  ...
  {:db/ident :sp/Minus,
   ...
   :rdfs/label "Minus",
   :rdfs/subClassOf
   [:sp/ElementGroup :sp/Minus :sp/Element :rdfs/Resource :sp/SystemClass]})
...
(def ModPath
  ...
  {:db/ident        :sp/ModPath,
   ...
   :rdfs/label      "Mod path",
   :rdfs/subClassOf [:sp/Path :sp/ModPath :rdfs/Resource :sp/SystemClass]})
...
(def NotExists
  ...
  {:db/ident :sp/NotExists,
   ...
   :rdfs/subClassOf
   [:sp/ElementGroup :sp/NotExists :sp/Element :rdfs/Resource :sp/SystemClass]})
...
(def Optional
  ...
  {:db/ident :sp/Optional,
   ...
   :rdfs/label "Optional",
   :rdfs/subClassOf
   [:sp/ElementGroup :sp/Optional :sp/Element :rdfs/Resource :sp/SystemClass]})
...
(def OrderByCondition
  ...
  {:db/ident :sp/OrderByCondition,
   ...
   :rdfs/subClassOf [:sp/SystemClass :sp/OrderByCondition :rdfs/Resource]})
...
(def Path
  ...
  {:db/ident :sp/Path,
   ...
   "The base class of SPARQL property path expressions. Paths are used by sp:TriplePath triple paths.",
   :rdfs/label "Path",
   :rdfs/subClassOf [:sp/SystemClass :sp/Path :rdfs/Resource]})
...
(def Query
  ...
  {:db/ident :sp/Query,
   ...
   "Abstract base class of the various types of supported queries. Common to all types of queries is that they can have a body (\"WHERE clause\").",
   :rdfs/label "Query",
   :rdfs/subClassOf [:sp/Command :sp/Query :rdfs/Resource :sp/SystemClass]})
...
(def ReversePath
  ...
  {:db/ident        :sp/ReversePath,
   ...
   :rdfs/subClassOf [:sp/Path :sp/ReversePath :rdfs/Resource :sp/SystemClass]})
...
(def SeqPath
  ...
  {:db/ident        :sp/SeqPath,
   ...
   :rdfs/label      "Seq path",
   :rdfs/subClassOf [:sp/Path :sp/SeqPath :rdfs/Resource :sp/SystemClass]})
...
(def Service
  ...
  {:db/ident :sp/Service,
   ...
   :rdfs/label "Service",
   :rdfs/subClassOf
   [:sp/ElementGroup :sp/Service :sp/Element :rdfs/Resource :sp/SystemClass]})
...
(def SystemClass
  ...
  {:db/ident :sp/SystemClass,
   ...
   :rdfs/subClassOf [:rdfs/Resource :sp/SystemClass]})
...
(def Union
  ...
  {:db/ident :sp/Union,
   ...
   :rdfs/label "Union",
   :rdfs/subClassOf
   [:sp/ElementGroup :sp/Union :sp/Element :rdfs/Resource :sp/SystemClass]})
...
(def Update
  ...
  {:db/ident :sp/Update,
   ...
   "Abstract base class to group the various SPARQL UPDATE commands.",
   :rdfs/label "Update",
   :rdfs/subClassOf [:sp/Command :sp/Update :rdfs/Resource :sp/SystemClass]})
...
(def all
  ...
  {:db/ident           :sp/all,
   ...
   :rdfs/subPropertyOf [:sp/systemProperty :sp/all]})
...
(def as
  ...
  {:db/ident :sp/as,
   ...
   :rdfs/subPropertyOf [:sp/systemProperty :sp/as]})
...
(def bindings
  ...
  {:db/ident           :sp/bindings,
   ...
   :rdfs/label         "bindings",
   :rdfs/range         :rdf/List,
   :rdfs/subPropertyOf [:sp/systemProperty :sp/bindings]})
...
(def default
  ...
  {:db/ident           :sp/default,
   ...
   :rdfs/label         "default",
   :rdfs/range         :xsd/boolean,
   :rdfs/subPropertyOf [:sp/systemProperty :sp/default]})
...
(def deletePattern
  ...
  {:db/ident :sp/deletePattern,
   ...
   :rdfs/range :rdf/List,
   :rdfs/subPropertyOf [:sp/systemProperty :sp/deletePattern]})
...
(def distinct
  ...
  {:db/ident :sp/distinct,
   ...
   :rdfs/label "distinct",
   :rdfs/range :xsd/boolean,
   :rdfs/subPropertyOf [:sp/systemProperty :sp/distinct]})
...
(def document
  ...
  {:db/ident :sp/document,
   ...
   :rdfs/subPropertyOf [:sp/systemProperty :sp/document]})
...
(def elements
  ...
  {:db/ident :sp/elements,
   ...
   :rdfs/subPropertyOf [:sp/systemProperty :sp/elements]})
...
(def expression
  ...
  {:db/ident :sp/expression,
   ...
   :rdfs/subPropertyOf [:sp/systemProperty :sp/expression]})
...
(def from
  ...
  {:db/ident :sp/from,
   ...
   :rdfs/label "from",
   :rdfs/range :rdfs/Resource,
   :rdfs/subPropertyOf [:sp/systemProperty :sp/from]})
...
(def fromNamed
  ...
  {:db/ident :sp/fromNamed,
   ...
   :rdfs/range :rdfs/Resource,
   :rdfs/subPropertyOf [:sp/systemProperty :sp/fromNamed]})
...
(def graphIRI
  ...
  {:db/ident :sp/graphIRI,
   ...
   :rdfs/range :rdfs/Resource,
   :rdfs/subPropertyOf [:sp/systemProperty :sp/graphIRI]})
...
(def graphNameNode
  ...
  {:db/ident           :sp/graphNameNode,
   ...
   :rdfs/range         :rdfs/Resource,
   :rdfs/subPropertyOf [:sp/systemProperty :sp/graphNameNode]})
...
(def groupBy
  ...
  {:db/ident :sp/groupBy,
   ...
   :rdfs/label "group by",
   :rdfs/range :rdf/List,
   :rdfs/subPropertyOf [:sp/systemProperty :sp/groupBy]})
...
(def having
  ...
  {:db/ident :sp/having,
   ...
   :rdfs/label "having",
   :rdfs/range :rdf/List,
   :rdfs/subPropertyOf [:sp/systemProperty :sp/having]})
...
(def insertPattern
  ...
  {:db/ident :sp/insertPattern,
   ...
   :rdfs/range :rdf/List,
   :rdfs/subPropertyOf [:sp/systemProperty :sp/insertPattern]})
...
(def into
  ...
  {:db/ident           :sp/into,
   ...
   :rdfs/label         "into",
   :rdfs/range         :rdfs/Resource,
   :rdfs/subPropertyOf [:sp/systemProperty :sp/into]})
...
(def limit
  ...
  {:db/ident           :sp/limit,
   ...
   :rdfs/label         "limit",
   :rdfs/range         :xsd/long,
   :rdfs/subPropertyOf [:sp/systemProperty :sp/limit]})
...
(def modMax
  ...
  {:db/ident           :sp/modMax,
   ...
   :rdfs/subPropertyOf [:sp/systemProperty :sp/modMax]})
...
(def modMin
  ...
  {:db/ident           :sp/modMin,
   ...
   :rdfs/label         "mod min",
   :rdfs/range         :xsd/integer,
   :rdfs/subPropertyOf [:sp/systemProperty :sp/modMin]})
...
(def named
  ...
  {:db/ident           :sp/named,
   ...
   :rdfs/label         "named",
   :rdfs/range         :xsd/boolean,
   :rdfs/subPropertyOf [:sp/systemProperty :sp/named]})
...
(def node
  ...
  {:db/ident           :sp/node,
   ...
   :rdfs/label         "node",
   :rdfs/subPropertyOf [:sp/systemProperty :sp/node]})
...
(def object
  ...
  {:db/ident :sp/object,
   ...
   :rdfs/label "object",
   :rdfs/subPropertyOf [:sp/systemProperty :sp/object]})
...
(def offset
  ...
  {:db/ident           :sp/offset,
   ...
   :rdfs/label         "offset",
   :rdfs/range         :xsd/long,
   :rdfs/subPropertyOf [:sp/systemProperty :sp/offset]})
...
(def orderBy
  ...
  {:db/ident :sp/orderBy,
   ...
   :rdfs/label "order by",
   :rdfs/range :rdf/List,
   :rdfs/subPropertyOf [:sp/systemProperty :sp/orderBy]})
...
(def path
  ...
  {:db/ident           :sp/path,
   ...
   :rdfs/label         "path",
   :rdfs/range         :sp/Path,
   :rdfs/subPropertyOf [:sp/systemProperty :sp/path]})
...
(def path1
  ...
  {:db/ident :sp/path1,
   ...
   :rdfs/label "path1",
   :rdfs/range :sp/Path,
   :rdfs/subPropertyOf [:sp/systemProperty :sp/path1]})
...
(def path2
  ...
  {:db/ident :sp/path2,
   ...
   :rdfs/label "path2",
   :rdfs/range :sp/Path,
   :rdfs/subPropertyOf [:sp/systemProperty :sp/path2]})
...
(def predicate
  ...
  {:db/ident :sp/predicate,
   ...
   :rdfs/range :rdfs/Resource,
   :rdfs/subPropertyOf [:sp/systemProperty :sp/predicate]})
...
(def query
  ...
  {:db/ident           :sp/query,
   ...
   :rdfs/label         "query",
   :rdfs/range         :sp/Query,
   :rdfs/subPropertyOf [:sp/systemProperty :sp/query]})
...
(def reduced
  ...
  {:db/ident :sp/reduced,
   ...
   :rdfs/label "reduced",
   :rdfs/range :xsd/boolean,
   :rdfs/subPropertyOf [:sp/systemProperty :sp/reduced]})
...
(def resultNodes
  ...
  {:db/ident :sp/resultNodes,
   ...
   :rdfs/range :rdf/List,
   :rdfs/subPropertyOf [:sp/systemProperty :sp/resultNodes]})
...
(def resultVariables
  ...
  {:db/ident :sp/resultVariables,
   ...
   :rdfs/range :rdf/List,
   :rdfs/subPropertyOf [:sp/systemProperty :sp/resultVariables]})
...
(def separator
  ...
  {:db/ident :sp/separator,
   ...
   :rdfs/subPropertyOf [:sp/systemProperty :sp/separator]})
...
(def serviceURI
  ...
  {:db/ident :sp/serviceURI,
   ...
   :rdfs/range :rdfs/Resource,
   :rdfs/subPropertyOf [:sp/systemProperty :sp/serviceURI]})
...
(def silent
  ...
  {:db/ident           :sp/silent,
   ...
   :rdfs/label         "silent",
   :rdfs/range         :xsd/boolean,
   :rdfs/subPropertyOf [:sp/systemProperty :sp/silent]})
...
(def source
  ...
  {:db/ident           :sp/source,
   :rdf/type           :rdf/Property,
   :rdfs/label         "source",
   :rdfs/subPropertyOf [:sp/systemProperty :sp/source]})
...
(def subPath
  ...
  {:db/ident :sp/subPath,
   ...
   "The child path of a property path expression. This is used by ReversePath and ModPath.",
   :rdfs/label "sub path",
   :rdfs/subPropertyOf [:sp/systemProperty :sp/subPath]})
...
(def subject
  ...
  {:db/ident :sp/subject,
   ...
   :rdfs/label "subject",
   :rdfs/range :rdfs/Resource,
   :rdfs/subPropertyOf [:sp/systemProperty :sp/subject]})
...
(def target
  ...
  {:db/ident           :sp/target,
   :rdf/type           :rdf/Property,
   :rdfs/label         "target",
   :rdfs/subPropertyOf [:sp/systemProperty :sp/target]})
