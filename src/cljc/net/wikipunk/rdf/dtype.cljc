...
(def CompositeCodeList
  ...
  {:db/ident :dtype/CompositeCodeList,
   ...
   :rdfs/isDefinedBy [{:rdfa/uri "http://www.linkedmodel.org/1.1/schema/dtype"}
                      {:rdfa/uri "http://www.linkedmodel.org/schema/dtype"}],
   :rdfs/label #xsd/string "Composite Code List",
...
(def Enumeration
  ...
  {:db/ident :dtype/Enumeration,
   ...
   :rdfs/isDefinedBy [{:rdfa/uri "http://www.linkedmodel.org/1.1/schema/dtype"}
                      {:rdfa/uri "http://www.linkedmodel.org/schema/dtype"}],
   :rdfs/label #xsd/string "DTYPE Enumeration",
...
(def SimpleCodeList
  ...
  {:db/ident :dtype/SimpleCodeList,
   ...
   :rdfs/isDefinedBy [{:rdfa/uri "http://www.linkedmodel.org/1.1/schema/dtype"}
                      {:rdfa/uri "http://www.linkedmodel.org/schema/dtype"}],
   :rdfs/label #xsd/string "Simple Code List",
   :rdfs/subClassOf [:dtype/CodeList
                     {:owl/allValuesFrom :dtype/EnumeratedValue,
                      :owl/onProperty    :dtype/hasMember,
                      :rdf/type          :owl/Restriction}
...
(def ValueReference
  ...
  {:db/ident :dtype/ValueReference,
   ...
   :rdfs/isDefinedBy [{:rdfa/uri "http://www.linkedmodel.org/1.1/schema/dtype"}
                      {:rdfa/uri "http://www.linkedmodel.org/schema/dtype"}],
   :rdfs/label #xsd/string "Value Reference",
   :rdfs/subClassOf [:owl/Thing
                     {:owl/allValuesFrom :dtype/EnumeratedValue,
...
(def compositeOf
  ...
  {:db/ident         :dtype/compositeOf,
   ...
   :rdfs/isDefinedBy [{:rdfa/uri "http://www.linkedmodel.org/1.1/schema/dtype"}
                      {:rdfa/uri "http://www.linkedmodel.org/schema/dtype"}],
   :rdfs/label       #xsd/string "composite of",
   :vaem/comment     #xsd/string
...
(def defaultValue
  ...
  {:db/ident :dtype/defaultValue,
   ...
   :rdfs/isDefinedBy [{:rdfa/uri "http://www.linkedmodel.org/1.1/schema/dtype"}
                      {:rdfa/uri "http://www.linkedmodel.org/schema/dtype"}],
   :rdfs/label #xsd/string "default value",
   :vaem/comment
   #xsd/string
...
(def hasMember
  ...
  {:db/ident :dtype/hasMember,
   ...
   :rdfs/isDefinedBy [{:rdfa/uri "http://www.linkedmodel.org/1.1/schema/dtype"}
                      {:rdfa/uri "http://www.linkedmodel.org/schema/dtype"}],
   :rdfs/label #xsd/string "has member",
   :vaem/comment
   #xsd/string
...
(def isInvalid
  ...
  {:db/ident :dtype/isInvalid,
   ...
   :rdfs/isDefinedBy [{:rdfa/uri "http://www.linkedmodel.org/1.1/schema/dtype"}
                      {:rdfa/uri "http://www.linkedmodel.org/schema/dtype"}],
   :rdfs/label #xsd/string "is invalid",
...
(def orderIndex
  ...
  {:db/ident :dtype/orderIndex,
   ...
   :rdfs/isDefinedBy [{:rdfa/uri "http://www.linkedmodel.org/1.1/schema/dtype"}
                      {:rdfa/uri "http://www.linkedmodel.org/schema/dtype"}],
   :rdfs/label #xsd/string "order index",
   :rdfs/range :xsd/nonNegativeInteger,
   :vaem/comment
   #xsd/string
...
(def position
  ...
  {:db/ident         :dtype/position,
   ...
   :rdfs/isDefinedBy [{:rdfa/uri "http://www.linkedmodel.org/1.1/schema/dtype"}
                      {:rdfa/uri "http://www.linkedmodel.org/schema/dtype"}],
   :rdfs/label       #xsd/string "position",
   :rdfs/range       :xsd/nonNegativeInteger})
...
(def refersTo
  ...
  {:db/ident :dtype/refersTo,
   ...
   :rdfs/isDefinedBy [{:rdfa/uri "http://www.linkedmodel.org/1.1/schema/dtype"}
                      {:rdfa/uri "http://www.linkedmodel.org/schema/dtype"}],
   :rdfs/label #xsd/string "refers to",
   :vaem/comment
   #xsd/string
