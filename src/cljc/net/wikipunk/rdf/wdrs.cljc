...
(def Document
  {:db/ident         :wdrs/Document,
   ...
   :rdfs/isDefinedBy {:xsd/anyURI "http://www.w3.org/TR/powder-dr/#structure"},
...
(def authenticate
  {:db/ident :wdrs/authenticate,
   ...
   :rdfs/isDefinedBy {:xsd/anyURI "http://www.w3.org/TR/powder-dr/#discover"},
   :rdfs/label {:rdf/language "en",
...
(def describedby
  {:db/ident :wdrs/describedby,
   ...
   :rdfs/isDefinedBy {:xsd/anyURI "http://www.w3.org/TR/powder-dr/#semlink"},
   :rdfs/label {:rdf/language "en",
...
(def issuedby
  {:db/ident         :wdrs/issuedby,
   ...
   :rdfs/isDefinedBy {:xsd/anyURI "http://www.w3.org/TR/powder-dr/#line3"},
   :rdfs/label       {:rdf/language "en",
                      :rdf/value    "issued by"}})
...
(def logo
  {:db/ident :wdrs/logo,
   ...
   :rdfs/isDefinedBy {:xsd/anyURI "http://www.w3.org/TR/powder-dr/#line13"},
   :rdfs/label {:rdf/language "en",
                :rdf/value    "logo"}})
...
(def tag
  {:db/ident :wdrs/tag,
   ...
   :rdfs/isDefinedBy {:xsd/anyURI "http://www.w3.org/TR/powder-dr/#tags"},
   :rdfs/label {:rdf/language "en",
                :rdf/value    "tag"},
