...
(def Document
  ...
  {:db/ident         :wdrs/Document,
   :rdf/type         :rdfs/Class,
   :rdfs/comment     #rdf/langString "A POWDER document.@en",
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/TR/powder-dr/#structure"},
   :rdfs/label       #rdf/langString "POWDER document@en",
...
(def Processor
  ...
  {:db/ident         :wdrs/Processor,
   ...
   :rdfs/label       #rdf/langString "POWDER processor@en",
...
(def authenticate
  ...
  {:db/ident :wdrs/authenticate,
   ...
   :rdfs/label #rdf/langString "authenticate@en"})
...
(def certified
  ...
  {:db/ident :wdrs/certified,
   ...
   :rdfs/label #rdf/langString "certified@en",
...
(def certifiedby
  ...
  {:db/ident :wdrs/certifiedby,
   ...
   :rdfs/isDefinedBy {:rdfa/uri
                      "http://www.w3.org/TR/powder-dr/#certification"},
   :rdfs/label #rdf/langString "certified by@en"})
...
(def data_error
  ...
  {:db/ident :wdrs/data_error,
   ...
   :rdfs/label #rdf/langString "data error@en"})
...
(def describedby
  ...
  {:db/ident :wdrs/describedby,
   ...
   :rdfs/label #rdf/langString "described by@en"})
...
(def error_code
  ...
  {:db/ident :wdrs/error_code,
   ...
   :rdfs/isDefinedBy {:rdfa/uri
                      "http://www.w3.org/TR/powder-dr/#ppErrorhandling"},
   :rdfs/label #rdf/langString "error code@en",
...
(def hasIRI
  ...
  {:db/ident :wdrs/hasIRI,
   ...
   :rdfs/label #rdf/langString "has IRI@en",
...
(def issuedby
  ...
  {:db/ident :wdrs/issuedby,
   ...
   :rdfs/label #rdf/langString "issued by@en"})
...
(def matchesregex
  ...
  {:db/ident :wdrs/matchesregex,
   ...
   :rdfs/label #rdf/langString "matches regular expression@en",
...
(def notknownto
  ...
  {:db/ident :wdrs/notknownto,
   ...
   :rdfs/isDefinedBy {:rdfa/uri
                      "http://www.w3.org/TR/powder-dr/#powderprocessor"},
   :rdfs/label #rdf/langString "not known to@en",
...
(def proc_error
  ...
  {:db/ident :wdrs/proc_error,
   ...
   :rdfs/isDefinedBy {:rdfa/uri
                      "http://www.w3.org/TR/powder-dr/#ppErrorhandling"},
   :rdfs/label #rdf/langString "processing error@en"})
...
(def sha1sum
  ...
  {:db/ident :wdrs/sha1sum,
   ...
   :rdfs/isDefinedBy {:rdfa/uri
                      "http://www.w3.org/TR/powder-dr/#certification"},
   :rdfs/label #rdf/langString "SHA-1 sum@en",
...
(def supportedby
  ...
  {:db/ident :wdrs/supportedby,
   ...
   :rdfs/label #rdf/langString "supported by@en"})
...
(def text
  ...
  {:db/ident :wdrs/text,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/TR/powder-dr/#line13"},
   :rdfs/label #rdf/langString "text that may be displayed@en"})
...
(def validfrom
  ...
  {:db/ident :wdrs/validfrom,
   ...
   :rdfs/isDefinedBy {:rdfa/uri
                      "http://www.w3.org/TR/powder-dr/#certification"},
   :rdfs/label #rdf/langString "valid from@en"})
...
(def validuntil
  ...
  {:db/ident :wdrs/validuntil,
   ...
   :rdfs/isDefinedBy {:rdfa/uri
                      "http://www.w3.org/TR/powder-dr/#certification"},
   :rdfs/label #rdf/langString "valid until@en"})
