(ns net.wikipunk.rdf.voaf
  ...
  {:cc/license "http://creativecommons.org/licenses/by/3.0/",
   ...
   :dc11/title ["Vocabulary of a Friend" "Vocabulaire d'un ami"],
   :dcat/downloadURL
...
(def DatasetOccurrences
  "Classe utilisée pour stocker l'information d'occurences d'un vocabulaire dans un jeu de données Class used to store the number of occurences of a vocabulary in a particular dataset"
  {:db/ident :voaf/DatasetOccurrences,
   ...
   :rdfs/label ["Occurrences dans un jeu de données" "Dataset occurrences"],
   :vs/term_status "testing"})

(def Vocabulary
  "A vocabulary used in the linked data cloud. An instance of voaf:Vocabulary relies on or is used by at least another instance of voaf:Vocabulary Un vocabulaire utilisé ou utilisable dans le Web des données. Une instance de voaf:Vocabulary s'appuie at/ou est utilisée par au moins une autre instance of voaf:Vocabulary"
...
(def VocabularySpace
  ...
  {:db/ident :voaf/VocabularySpace,
   ...
   :rdfs/isDefinedBy "http://purl.org/vocommons/voaf",
   :rdfs/label ["Espace de vocabulaires" "Vocabulary Space"],
   :vs/term_status "testing"})
...
(def classNumber
  ...
  {:db/ident :voaf/classNumber,
   ...
   :rdfs/isDefinedBy "http://purl.org/vocommons/voaf",
   :rdfs/label ["nombre de classes" "number of classes"],
   :rdfs/range :xsd/integer,
   :vs/term_status "stable"})

(def dataset
  "Déprécié depuis la v2.4 Deprecated since v2.4"
  {:db/ident          :voaf/dataset,
   :dc11/isReplacedBy :voaf/DatasetOccurrences,
   :owl/inverseOf     :void/vocabulary,
   :rdf/type          :owl/ObjectProperty,
   :rdfs/comment      ["Déprécié depuis la v2.4" "Deprecated since v2.4"],
   :rdfs/domain       :voaf/Vocabulary,
   :rdfs/isDefinedBy  "http://purl.org/vocommons/voaf",
   :rdfs/label        ["dataset" "jeu de données"],
   :rdfs/range        :void/Dataset,
   :vs/term_status    "deprecated"})

(def exampleDataset
  "Déprécié depuis la v1.1 Deprecated since v1.1"
  {:db/ident          :voaf/exampleDataset,
   :dc11/isReplacedBy :voaf/dataset,
   :rdf/type          :owl/ObjectProperty,
   :rdfs/comment      ["Déprécié depuis la v1.1" "Deprecated since v1.1"],
   :rdfs/isDefinedBy  "http://purl.org/vocommons/voaf",
   :rdfs/label        ["exemple de jeu de données" "example dataset"],
   :vs/term_status    "deprecated"})
...
(def generalizes
  ...
  {:db/ident :voaf/generalizes,
   ...
   :rdfs/domain :voaf/Vocabulary,
   :rdfs/isDefinedBy "http://purl.org/vocommons/voaf",
   :rdfs/label ["généralise" "generalizes"],
   :rdfs/range :voaf/Vocabulary,
   :rdfs/subPropertyOf
...
(def hasDisjunctionsWith
  ...
  {:db/ident :voaf/hasDisjunctionsWith,
   ...
   :rdfs/domain :voaf/Vocabulary,
   :rdfs/isDefinedBy "http://purl.org/vocommons/voaf",
   :rdfs/label ["a des disjonctions avec" "has disjunctions with"],
   :rdfs/range :voaf/Vocabulary,
   :rdfs/subPropertyOf
...
(def hasEquivalencesWith
  ...
  {:db/ident :voaf/hasEquivalencesWith,
   ...
   :rdfs/domain :voaf/Vocabulary,
   :rdfs/isDefinedBy "http://purl.org/vocommons/voaf",
   :rdfs/label ["a des équivalences avec" "has equivalences with"],
   :rdfs/range :voaf/Vocabulary,
   :rdfs/subPropertyOf
...
(def inDataset
  "jeu de données dans lequel un vocabulaire apparait dataset in which a vocabulary occurred"
  {:db/ident         :voaf/inDataset,
   :rdf/type         :owl/ObjectProperty,
   :rdfs/comment     ["jeu de données dans lequel un vocabulaire apparait"
                      "dataset in which a vocabulary occurred"],
   :rdfs/domain      :voaf/DatasetOccurrences,
   :rdfs/isDefinedBy "http://purl.org/vocommons/voaf",
   :rdfs/label       ["dans le jeu de données" "in dataset"],
   :rdfs/range       :void/Dataset,
   :vs/term_status   "testing"})
...
(def metadataVoc
  ...
  {:db/ident :voaf/metadataVoc,
   ...
   :rdfs/domain :voaf/Vocabulary,
   :rdfs/isDefinedBy "http://purl.org/vocommons/voaf",
   :rdfs/label ["vocabulaire de métadonnées" "metadata vocabulary"],
   :rdfs/range :voaf/Vocabulary,
   :rdfs/subPropertyOf
...
(def occurrences
  "nombre d'occurrences d'un vocabulaire dans un dataset Number of occurrences of a vocabulary in a dataset"
  {:db/ident         :voaf/occurrences,
   :rdf/type         :owl/ObjectProperty,
   :rdfs/comment     ["nombre d'occurrences d'un vocabulaire dans un dataset"
                      "Number of occurrences of a vocabulary in a dataset"],
   :rdfs/domain      :voaf/DatasetOccurrences,
   :rdfs/isDefinedBy "http://purl.org/vocommons/voaf",
   :rdfs/label       ["occurrences" "occurrences"],
   :rdfs/range       :xsd/integer,
   :vs/term_status   "testing"})

(def occurrencesInDatasets
  "Nombre de jeux de données utilisant une ressource. Number of datasets using a resource."
  {:db/ident         :voaf/occurrencesInDatasets,
   :rdf/type         :owl/DatatypeProperty,
   :rdfs/comment     ["Nombre de jeux de données utilisant une ressource."
                      "Number of datasets using a resource."],
   :rdfs/isDefinedBy "http://purl.org/vocommons/voaf",
   :rdfs/label       ["occurences dans des datasets" "occurrences in datasets"],
   :rdfs/range       :xsd/integer,
   :vs/term_status   "testing"})

(def occurrencesInVocabularies
  "Nombre de vocabulaires utilisant une ressource. Number of vocabularies using a resource"
  {:db/ident         :voaf/occurrencesInVocabularies,
   :rdf/type         :owl/DatatypeProperty,
   :rdfs/comment     ["Nombre de vocabulaires utilisant une ressource."
                      "Number of vocabularies using a resource"],
   :rdfs/isDefinedBy "http://purl.org/vocommons/voaf",
   :rdfs/label       ["occurences dans des vocabulaires"
                      "occurrences in vocabularies"],
   :rdfs/range       :xsd/integer,
   :vs/term_status   "testing"})
...
(def propertyNumber
  ...
  {:db/ident :voaf/propertyNumber,
   ...
   :rdfs/domain :voaf/Vocabulary,
   :rdfs/isDefinedBy "http://purl.org/vocommons/voaf",
   :rdfs/label ["number of properties" "nombre de propriétés"],
   :rdfs/range :xsd/integer,
   :vs/term_status "stable"})

(def reliesOn
  "Indique que le vocabulaire sujet utilise ou étend au moins une classe ou propriété du vocabulaire objet Indicates that the subject vocabulary uses or extends some class or property of the object vocabulary"
  {:db/ident :voaf/reliesOn,
   ...
   :rdfs/domain :voaf/Vocabulary,
   :rdfs/isDefinedBy "http://purl.org/vocommons/voaf",
   :rdfs/label ["réutilise" "relies on"],
   :rdfs/range :voaf/Vocabulary,
   :rdfs/subPropertyOf [:void/vocabulary :dc11/references :voaf/reliesOn],
   :vs/term_status "stable"})

(def reusedByDatasets
  "Nombre distinct de jeux de données reutilisant une resource. Distinct number of datasets reusing a resource."
  {:db/ident :voaf/reusedByDatasets,
   :rdf/type :owl/DatatypeProperty,
   :rdfs/comment ["Nombre distinct de jeux de données reutilisant une resource."
                  "Distinct number of datasets reusing a resource."],
   :rdfs/isDefinedBy "http://purl.org/vocommons/voaf",
   :rdfs/label ["réutilisé par des jeux de données" "reused by datasets"],
   :rdfs/range :xsd/integer,
   :vs/term_status "testing"})

(def reusedByVocabularies
  "Nombre distinct de vocabulaires reutilisant une resource. Distinct number of vocabularies reusing a resource."
  {:db/ident :voaf/reusedByVocabularies,
   :rdf/type :owl/DatatypeProperty,
   :rdfs/comment ["Nombre distinct de vocabulaires reutilisant une resource."
                  "Distinct number of vocabularies reusing a resource."],
   :rdfs/isDefinedBy "http://purl.org/vocommons/voaf",
   :rdfs/label ["réutilisé par des vocabulaires" "reused by vocabularies"],
   :rdfs/range :xsd/integer,
   :vs/term_status "testing"})

(def similar
  "Used to assert that two vocabularies are similar in scope and objectives, independently of the fact that they otherwise refer to each other. Indique que deux vocabulaires sont similaires dans leur domaine et/ou leurs objectifs, sans être nécessairement reliés par des références."
...
(def specializes
  ...
  {:db/ident :voaf/specializes,
   ...
   :rdfs/domain :voaf/Vocabulary,
   :rdfs/isDefinedBy "http://purl.org/vocommons/voaf",
   :rdfs/label ["specializes" "spécialise"],
   :rdfs/range :voaf/Vocabulary,
   :rdfs/subPropertyOf
...
(def toDoList
  ...
  {:db/ident :voaf/toDoList,
   ...
   :rdfs/isDefinedBy "http://purl.org/vocommons/voaf",
   :rdfs/label ["liste des choses à faire" "to-do list"],
   :rdfs/range "http://www.w3.org/2002/12/cal/ical#Vtodo",
   :vs/term_status "stable"})

(def usageInDataset
  "statistiques d'utilisation dans un jeu de données usage statistics in a dataset"
  {:db/ident         :voaf/usageInDataset,
   :rdf/type         :owl/ObjectProperty,
   :rdfs/comment     ["statistiques d'utilisation dans un jeu de données"
                      "usage statistics in a dataset"],
   :rdfs/domain      :voaf/Vocabulary,
   :rdfs/isDefinedBy "http://purl.org/vocommons/voaf",
   :rdfs/label       ["utilisation dans un jeu de données" "usage in dataset"],
   :rdfs/range       :voaf/DatasetOccurrences,
   :vs/term_status   "testing"})

(def usedBy
  "Indicates that the subject vocabulary is used by the object vocabulary Indique que le vocabulaire sujet est utilisé par le vocabulaire objet"
  {:db/ident :voaf/usedBy,
   ...
   :rdfs/domain :voaf/Vocabulary,
   :rdfs/isDefinedBy "http://purl.org/vocommons/voaf",
   :rdfs/label ["used by" "utilisé par"],
   :rdfs/range :voaf/Vocabulary,
   :vs/term_status "stable"})
