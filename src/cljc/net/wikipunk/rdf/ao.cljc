(ns net.wikipunk.rdf.ao
  ...
  {:dc11/creator [{:rdfa/uri "http://foaf.me/zazi#me"}
   ...
   :dc11/title #xsd/langString "The Association Ontology@en",
...
(def LikeableAssociation
  ...
  {:db/ident :ao/LikeableAssociation,
   ...
   :rdfs/label #xsd/langString "Likeable Association@en",
...
(def application
  ...
  {:db/ident :ao/application,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://purl.org/ontology/ao/core#"},
   :rdfs/label #xsd/langString "has application@en",
   :rdfs/subPropertyOf :ao/context,
   :vs/term_status #xsd/langString "testing@en"})
...
(def device
  ...
  {:db/ident :ao/device,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://purl.org/ontology/ao/core#"},
   :rdfs/label #xsd/langString "has device@en",
   :rdfs/subPropertyOf :ao/context,
   :vs/term_status #xsd/langString "testing@en"})
...
(def genre
  ...
  {:db/ident           :ao/genre,
   :rdf/type           :rdf/Property,
   :rdfs/comment       #xsd/langString "An genre of something.@en",
   :rdfs/domain        :owl/Thing,
   :rdfs/isDefinedBy   {:rdfa/uri "http://purl.org/ontology/ao/core#"},
   :rdfs/label         #xsd/langString "has genre@en",
...
(def included_association
  ...
  {:db/ident :ao/included_association,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://purl.org/ontology/ao/core#"},
   :rdfs/label #xsd/langString "has included association@en",
...
(def mood
  ...
  {:db/ident           :ao/mood,
   ...
   :rdfs/domain        :owl/Thing,
   :rdfs/isDefinedBy   {:rdfa/uri "http://purl.org/ontology/ao/core#"},
   :rdfs/label         #xsd/langString "has mood@en",
   :rdfs/subPropertyOf :dcterms/subject,
   :vs/term_status     #xsd/langString "unstable@en"})
...
(def occasion
  ...
  {:db/ident           :ao/occasion,
   ...
   :rdfs/domain        :owl/Thing,
   :rdfs/isDefinedBy   {:rdfa/uri "http://purl.org/ontology/ao/core#"},
   :rdfs/label         #xsd/langString "has occassion@en",
   :rdfs/subPropertyOf :dcterms/subject,
   :vs/term_status     #xsd/langString "unstable@en"})
...
(def used_application
  ...
  {:db/ident :ao/used_application,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://purl.org/ontology/ao/core#"},
   :rdfs/label #xsd/langString "has used application@en",
...
(def used_device
  ...
  {:db/ident :ao/used_device,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://purl.org/ontology/ao/core#"},
   :rdfs/label #xsd/langString "has used device@en",
