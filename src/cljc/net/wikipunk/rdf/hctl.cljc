...
(def hasAdditionalOutputSchema
  "This optional term can be used to define a data schema for an additional response if it differs from the default output data schema. Rather than a <code>DataSchema</code> object, the name of a previous definition given in a <code>schemaDefinitions</code> map must be used."
