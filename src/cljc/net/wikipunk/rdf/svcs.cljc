...
(def has_service
  ...
  {:db/ident           :svcs/has_service,
   ...
   :rdfs/comment       "A Service associated with this SIOC object.",
   :rdfs/isDefinedBy   "http://rdfs.org/sioc/services#",
...
(def max_results
  ...
  {:db/ident :svcs/max_results,
   ...
   :rdfs/comment "Maximum number of results results returned by a web service.",
   :rdfs/domain :svcs/Service,
   :rdfs/isDefinedBy "http://rdfs.org/sioc/services#",
   :rdfs/label "max results",
...
(def results_format
  ...
  {:db/ident           :svcs/results_format,
   :rdf/type           [:owl/ObjectProperty :rdf/Property],
   :rdfs/comment       "Format of results returned by a web service.",
   :rdfs/domain        :svcs/Service,
   :rdfs/isDefinedBy   "http://rdfs.org/sioc/services#",
   :rdfs/label         "results format",
...
(def service_definition
  ...
  {:db/ident :svcs/service_definition,
   :rdf/type [:owl/ObjectProperty :rdf/Property],
   :rdfs/comment "Links to a web service definition of this sioc:Service.",
   :rdfs/domain :svcs/Service,
   :rdfs/isDefinedBy "http://rdfs.org/sioc/services#",
   :rdfs/label "service definition",
...
(def service_endpoint
  ...
  {:db/ident           :svcs/service_endpoint,
   :rdf/type           [:owl/ObjectProperty :rdf/Property],
   :rdfs/comment       "URL of a web service endpoint.",
   :rdfs/domain        :svcs/Service,
   :rdfs/isDefinedBy   "http://rdfs.org/sioc/services#",
...
(def service_of
  ...
  {:db/ident           :svcs/service_of,
   ...
   :rdf/type           [:owl/ObjectProperty :rdf/Property],
   :rdfs/comment       "A SIOC object this Service is associated with.",
   :rdfs/domain        :svcs/Service,
   :rdfs/isDefinedBy   "http://rdfs.org/sioc/services#",
   :rdfs/label         "service of",
