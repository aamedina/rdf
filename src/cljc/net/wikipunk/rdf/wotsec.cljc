...
(def APIKeySecurityScheme
  ...
  {:db/ident :wotsec/APIKeySecurityScheme,
   ...
   :rdfs/subClassOf
   [:wotsec/SecurityScheme :wotsec/APIKeySecurityScheme :rdfs/Resource]})
...
(def AutoSecurityScheme
  ...
  {:db/ident :wotsec/AutoSecurityScheme,
   ...
   :rdfs/subClassOf
   [:wotsec/SecurityScheme :wotsec/AutoSecurityScheme :rdfs/Resource]})
...
(def BasicSecurityScheme
  ...
  {:db/ident :wotsec/BasicSecurityScheme,
   ...
   :rdfs/subClassOf
   [:wotsec/SecurityScheme :wotsec/BasicSecurityScheme :rdfs/Resource]})
...
(def BearerSecurityScheme
  ...
  {:db/ident :wotsec/BearerSecurityScheme,
   ...
   :rdfs/subClassOf
   [:wotsec/SecurityScheme :wotsec/BearerSecurityScheme :rdfs/Resource]})
...
(def ComboSecurityScheme
  ...
  {:db/ident :wotsec/ComboSecurityScheme,
   ...
   :rdfs/subClassOf
   [:rdfs/Resource :wotsec/SecurityScheme :wotsec/ComboSecurityScheme]})
...
(def DigestSecurityScheme
  ...
  {:db/ident :wotsec/DigestSecurityScheme,
   ...
   :rdfs/subClassOf
   [:wotsec/SecurityScheme :wotsec/DigestSecurityScheme :rdfs/Resource]})
...
(def NoSecurityScheme
  ...
  {:db/ident :wotsec/NoSecurityScheme,
   ...
   :rdfs/subClassOf
   [:wotsec/SecurityScheme :wotsec/NoSecurityScheme :rdfs/Resource]})
...
(def OAuth2SecurityScheme
  ...
  {:db/ident :wotsec/OAuth2SecurityScheme,
   ...
   :rdfs/subClassOf
   [:wotsec/SecurityScheme :wotsec/OAuth2SecurityScheme :rdfs/Resource]})
...
(def PSKSecurityScheme
  ...
  {:db/ident :wotsec/PSKSecurityScheme,
   ...
   :rdfs/subClassOf
   [:wotsec/SecurityScheme :wotsec/PSKSecurityScheme :rdfs/Resource]})
...
(def alg
  ...
  {:db/ident     :wotsec/alg,
   ...
   :rdfs/comment #voc/lstr "Encoding, encryption, or digest algorithm.@en",
   :rdfs/label   "alg",
...
(def authorization
  ...
  {:db/ident     :wotsec/authorization,
   :rdf/type     :owl/ObjectProperty,
   :rdfs/comment #voc/lstr "URI of the authorization server.@en",
...
(def flow
  ...
  {:db/ident     :wotsec/flow,
   :rdf/type     :owl/DatatypeProperty,
   :rdfs/comment #voc/lstr "Authorization flow.@en",
   :rdfs/label   "flow",
   :schema/domainIncludes :wotsec/OAuth2SecurityScheme})
...
(def refresh
  ...
  {:db/ident     :wotsec/refresh,
   :rdf/type     :owl/ObjectProperty,
   :rdfs/comment #voc/lstr "URI of the refresh server.@en",
   :rdfs/label   "refresh",
   :schema/domainIncludes :wotsec/OAuth2SecurityScheme})
...
(def token
  ...
  {:db/ident     :wotsec/token,
   :rdf/type     :owl/ObjectProperty,
   :rdfs/comment #voc/lstr "URI of the token server.@en",
   :rdfs/label   "token",
   :schema/domainIncludes :wotsec/OAuth2SecurityScheme})