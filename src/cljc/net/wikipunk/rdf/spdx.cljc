...
(def ChecksumAlgorithm
  ...
  {:db/ident       :spdx/ChecksumAlgorithm,
   :rdf/type       :owl/Class,
   :rdfs/comment   "Algorighm for Checksums.",
   :vs/term_status "stable"})
...
(def CrossRef
  ...
  {:db/ident        :spdx/CrossRef,
   :rdf/type        :owl/Class,
   :rdfs/comment    "Cross reference details for the a URL reference",
   :rdfs/subClassOf [{:owl/maxQualifiedCardinality 1,
...
(def LicenseException
  ...
  {:db/ident        :spdx/LicenseException,
   :rdf/type        :owl/Class,
   :rdfs/comment    "An exception to a license.",
...
(def ReferenceCategory
  ...
  {:db/ident       :spdx/ReferenceCategory,
   :rdf/type       :owl/Class,
   :rdfs/comment   "Category used for ExternalRef",
   :vs/term_status "stable"})
...
(def ReferenceType
  ...
  {:db/ident        :spdx/ReferenceType,
   :rdf/type        :owl/Class,
   :rdfs/comment    "Types used to external reference identifiers.",
   :rdfs/subClassOf [{:owl/onDataRange :xsd/anyURI,
...
(def SpdxItem
  ...
  {:db/ident        :spdx/SpdxItem,
   :rdf/type        :owl/Class,
   :rdfs/comment    "An SpdxItem is a potentially copyrightable work.",
   :rdfs/subClassOf [{:owl/maxQualifiedCardinality 1,
                      :owl/onDataRange :xsd/string,
                      :owl/onProperty  :spdx/licenseComments,
                      :rdf/type        :owl/Restriction}
...
(def annotation
  ...
  {:db/ident       :spdx/annotation,
   :rdf/type       :owl/ObjectProperty,
   :rdfs/comment   "Provide additional information about an SpdxElement.",
...
(def annotationDate
  ...
  {:db/ident :spdx/annotationDate,
   ...
   :rdfs/subPropertyOf [:spdx/date :spdx/annotationDate],
   :vs/term_status "stable"})
...
(def annotationType
  ...
  {:db/ident       :spdx/annotationType,
   :rdf/type       :owl/ObjectProperty,
   :rdfs/comment   "Type of the annotation.",
   :rdfs/domain    :spdx/Annotation,
...
(def builtDate
  ...
  {:db/ident :spdx/builtDate,
   ...
   :rdfs/range :xsd/dateTime,
   :rdfs/subPropertyOf [:spdx/date :spdx/builtDate],
   :vs/term_status "stable"})
...
(def checksumAlgorithm_adler32
  ...
  {:db/ident       :spdx/checksumAlgorithm_adler32,
   ...
   :rdfs/comment   "Indicates the algorithm used was ADLER32.",
   :vs/term_status "stable"})
...
(def checksumAlgorithm_blake2b256
  ...
  {:db/ident       :spdx/checksumAlgorithm_blake2b256,
   :rdf/type       [:spdx/ChecksumAlgorithm :owl/NamedIndividual],
   :rdfs/comment   "Indicates the algorithm used was BLAKE2b-256.",
   :vs/term_status "stable"})
...
(def checksumAlgorithm_blake2b384
  ...
  {:db/ident       :spdx/checksumAlgorithm_blake2b384,
   :rdf/type       [:spdx/ChecksumAlgorithm :owl/NamedIndividual],
   :rdfs/comment   "Indicates the algorithm used was BLAKE2b-384.",
   :vs/term_status "stable"})
...
(def checksumAlgorithm_blake2b512
  ...
  {:db/ident       :spdx/checksumAlgorithm_blake2b512,
   :rdf/type       [:spdx/ChecksumAlgorithm :owl/NamedIndividual],
   :rdfs/comment   "Indicates the algorithm used was BLAKE2b-512.",
   :vs/term_status "stable"})
...
(def checksumAlgorithm_blake3
  ...
  {:db/ident       :spdx/checksumAlgorithm_blake3,
   :rdf/type       [:spdx/ChecksumAlgorithm :owl/NamedIndividual],
   :rdfs/comment   "Indicates the algorithm used was BLAKE3.",
   :vs/term_status "stable"})
...
(def checksumAlgorithm_md5
  ...
  {:db/ident       :spdx/checksumAlgorithm_md5,
   :rdf/type       [:spdx/ChecksumAlgorithm :owl/NamedIndividual],
   :rdfs/comment   "Indicates the algorithm used was MD5",
   :vs/term_status "stable"})
...
(def checksumAlgorithm_md6
  ...
  {:db/ident       :spdx/checksumAlgorithm_md6,
   :rdf/type       [:spdx/ChecksumAlgorithm :owl/NamedIndividual],
   :rdfs/comment   "Indicates the algorithm used was MD6",
   :vs/term_status "stable"})
...
(def checksumAlgorithm_sha224
  ...
  {:db/ident       :spdx/checksumAlgorithm_sha224,
   :rdf/type       [:spdx/ChecksumAlgorithm :owl/NamedIndividual],
   :rdfs/comment   "Indicates the algorithm used was SHA224",
   :vs/term_status "stable"})
...
(def checksumAlgorithm_sha256
  ...
  {:db/ident       :spdx/checksumAlgorithm_sha256,
   :rdf/type       [:spdx/ChecksumAlgorithm :owl/NamedIndividual],
   :rdfs/comment   "Indicates the algorithm used was SHA256",
   :vs/term_status "stable"})
...
(def checksumAlgorithm_sha384
  ...
  {:db/ident       :spdx/checksumAlgorithm_sha384,
   :rdf/type       [:spdx/ChecksumAlgorithm :owl/NamedIndividual],
   :rdfs/comment   "Indicates the algorithm used was SHA384",
   :vs/term_status "stable"})
...
(def checksumAlgorithm_sha3_256
  ...
  {:db/ident       :spdx/checksumAlgorithm_sha3_256,
   :rdf/type       [:spdx/ChecksumAlgorithm :owl/NamedIndividual],
   :rdfs/comment   "Indicates the algorithm used was SHA3-256.",
   :vs/term_status "stable"})
...
(def checksumAlgorithm_sha3_384
  ...
  {:db/ident       :spdx/checksumAlgorithm_sha3_384,
   :rdf/type       [:spdx/ChecksumAlgorithm :owl/NamedIndividual],
   :rdfs/comment   "Indicates the algorithm used was SHA3-384.",
   :vs/term_status "stable"})
...
(def checksumAlgorithm_sha3_512
  ...
  {:db/ident       :spdx/checksumAlgorithm_sha3_512,
   :rdf/type       [:spdx/ChecksumAlgorithm :owl/NamedIndividual],
   :rdfs/comment   "Indicates the algorithm used was SHA3-512.",
   :vs/term_status "stable"})
...
(def checksumAlgorithm_sha512
  ...
  {:db/ident       :spdx/checksumAlgorithm_sha512,
   :rdf/type       [:spdx/ChecksumAlgorithm :owl/NamedIndividual],
   :rdfs/comment   "Indicates the algorithm used was SHA512",
   :vs/term_status "stable"})
...
(def contextualExample
  ...
  {:db/ident       :spdx/contextualExample,
   :rdf/type       :owl/DatatypeProperty,
   :rdfs/comment   "Example for use of the external repository identifier",
...
(def created
  ...
  {:db/ident :spdx/created,
   ...
   :rdfs/range :xsd/dateTime,
   :rdfs/subPropertyOf [:spdx/date :spdx/created],
   :vs/term_status "stable"})
...
(def crossRef
  ...
  {:db/ident     :spdx/crossRef,
   :rdf/type     :owl/ObjectProperty,
   :rdfs/comment "Cross Reference Detail for a license SeeAlso URL",
...
(def date
  ...
  {:db/ident           :spdx/date,
   :rdf/type           :owl/DatatypeProperty,
   :rdfs/comment       "A date-time stamp.",
...
(def deprecatedVersion
  ...
  {:db/ident       :spdx/deprecatedVersion,
   :rdf/type       :owl/DatatypeProperty,
   :rdfs/comment   "License list version where this license was decprecated",
...
(def description
  ...
  {:db/ident       :spdx/description,
   :rdf/type       :owl/DatatypeProperty,
   :rdfs/comment   "Provides a detailed description of the package.",
   :rdfs/domain    :spdx/Package,
   :rdfs/range     :xsd/string,
   :vs/term_status "stable"})
...
(def example
  ...
  {:db/ident       :spdx/example,
   :rdf/type       :owl/DatatypeProperty,
   :rdfs/comment   "Text for examples in describing an SPDX element.",
...
(def exceptionTextHtml
  ...
  {:db/ident       :spdx/exceptionTextHtml,
   :rdf/type       :owl/DatatypeProperty,
   :rdfs/comment   "HTML representation of the License Exception Text",
...
(def externalReferenceSite
  ...
  {:db/ident       :spdx/externalReferenceSite,
   :rdf/type       :owl/DatatypeProperty,
   :rdfs/comment   "Website for the maintainers of the external reference site",
   :rdfs/domain    :spdx/ReferenceType,
   :rdfs/range     :xsd/anyURI,
   :vs/term_status "stable"})
...
(def fileName
  ...
  {:db/ident :spdx/fileName,
   :rdf/type :owl/DatatypeProperty,
   :rdfs/comment "The name of the file relative to the root of the package.",
   :rdfs/domain :spdx/File,
   :rdfs/range :xsd/string,
   :rdfs/subPropertyOf [:spdx/name :spdx/fileName],
   :vs/term_status "stable"})
...
(def fileType
  ...
  {:db/ident       :spdx/fileType,
   :rdf/type       :owl/ObjectProperty,
   :rdfs/comment   "The type of the file.",
   :rdfs/domain    :spdx/File,
   :vs/term_status "stable"})
...
(def fileType_archive
  ...
  {:db/ident       :spdx/fileType_archive,
   :rdf/type       [:spdx/FileType :owl/NamedIndividual],
   :rdfs/comment   "Indicates the file is an archive file.",
   :vs/term_status "stable"})
...
(def fileType_documentation
  ...
  {:db/ident       :spdx/fileType_documentation,
   :rdf/type       [:spdx/FileType :owl/NamedIndividual],
   :rdfs/comment   "The file serves as documentation.",
   :vs/term_status "stable"})
...
(def fileType_other
  ...
  {:db/ident :spdx/fileType_other,
   :rdf/type [:spdx/FileType :owl/NamedIndividual],
   :rdfs/comment "Indicates the file is not a source, archive or binary file.",
   :vs/term_status "stable"})
...
(def fileType_source
  ...
  {:db/ident       :spdx/fileType_source,
   :rdf/type       [:spdx/FileType :owl/NamedIndividual],
   :rdfs/comment   "Indicates the file is a source code file.",
   :vs/term_status "stable"})
...
(def fileType_spdx
  ...
  {:db/ident       :spdx/fileType_spdx,
   :rdf/type       [:spdx/FileType :owl/NamedIndividual],
   :rdfs/comment   "The file is an SPDX document.",
   :vs/term_status "stable"})
...
(def fileType_text
  ...
  {:db/ident :spdx/fileType_text,
   :rdf/type [:spdx/FileType :owl/NamedIndividual],
   :rdfs/comment "The file is human readable text file (MIME type of text/*).",
   :vs/term_status "stable"})
...
(def hasFile
  ...
  {:db/ident       :spdx/hasFile,
   :rdf/type       :owl/ObjectProperty,
   :rdfs/comment   "Indicates that a particular file belongs to a package.",
   :rdfs/domain    :spdx/Package,
   :rdfs/range     :spdx/File,
   :vs/term_status "stable"})
...
(def isOsiApproved
  ...
  {:db/ident       :spdx/isOsiApproved,
   :rdf/type       :owl/DatatypeProperty,
   :rdfs/comment   "Indicates if the OSI has approved the license.",
   :rdfs/domain    :spdx/License,
   :rdfs/range     :xsd/boolean,
   :vs/term_status "stable"})
...
(def isValid
  ...
  {:db/ident     :spdx/isValid,
   :rdf/type     :owl/DatatypeProperty,
   :rdfs/comment "True if the URL is a valid well formed URL",
   :rdfs/domain  :spdx/CrossRef,
   :rdfs/range   :xsd/boolean})
...
(def isWayBackLink
  ...
  {:db/ident     :spdx/isWayBackLink,
   :rdf/type     :owl/DatatypeProperty,
   :rdfs/comment "True if the License SeeAlso URL points to a Wayback archive",
   :rdfs/domain  :spdx/CrossRef,
   :rdfs/range   :xsd/boolean})
...
(def licenseExceptionTemplate
  ...
  {:db/ident       :spdx/licenseExceptionTemplate,
   :rdf/type       :owl/DatatypeProperty,
   :rdfs/comment   "Template for matching license exception text",
   :rdfs/domain    :spdx/LicenseException,
   :rdfs/range     :xsd/string,
   :vs/term_status "stable"})
...
(def licenseExceptionText
  ...
  {:db/ident       :spdx/licenseExceptionText,
   :rdf/type       :owl/DatatypeProperty,
   :rdfs/comment   "Full text of the license exception.",
   :rdfs/domain    :spdx/LicenseException,
   :rdfs/range     :xsd/string,
   :vs/term_status "stable"})
  ...
  {:db/ident :spdx/licenseInfoInFile,
   ...
   :rdfs/range {:owl/unionOf [:spdx/AnyLicenseInfo
                              ...
                              {:owl/hasValue   :spdx/none,
                               ...
                               :rdf/type       :owl/Restriction}],
                :rdf/type    :owl/Class},
   :rdfs/subPropertyOf [:spdx/licenseInfoFromFiles :spdx/licenseInfoInFile],
   :vs/term_status "stable"})
  ...
  {:db/ident :spdx/licenseInfoInSnippet,
   ...
   :rdfs/range {:owl/unionOf [:spdx/AnyLicenseInfo
                              ...
                              {:owl/hasValue   :spdx/none,
                               ...
                               :rdf/type       :owl/Restriction}],
                :rdf/type    :owl/Class},
   :rdfs/subPropertyOf [:spdx/licenseInfoFromFiles :spdx/licenseInfoInSnippet],
   :vs/term_status "stable"})
...
(def licenseText
  ...
  {:db/ident       :spdx/licenseText,
   :rdf/type       :owl/DatatypeProperty,
   :rdfs/comment   "Full text of the license.",
   :rdfs/domain    :spdx/License,
   :rdfs/range     :xsd/string,
   :vs/term_status "stable"})
...
(def licenseTextHtml
  ...
  {:db/ident       :spdx/licenseTextHtml,
   :rdf/type       :owl/DatatypeProperty,
   :rdfs/comment   "License text in HTML format",
   :rdfs/domain    :spdx/ListedLicense,
   :rdfs/range     :xsd/string,
   :vs/term_status "stable"})
...
(def name
  ...
  {:db/ident           :spdx/name,
   :rdf/type           :owl/DatatypeProperty,
   :rdfs/comment       "Identify name of this SpdxElement.",
   :rdfs/domain        :spdx/SpdxElement,
   :rdfs/range         :xsd/string,
...
(def order
  ...
  {:db/ident     :spdx/order,
   :rdf/type     :owl/DatatypeProperty,
   :rdfs/comment "The ordinal order of this element within a list",
   :rdfs/domain  :spdx/CrossRef,
...
(def packageName
  ...
  {:db/ident :spdx/packageName,
   ...
   :rdfs/domain :spdx/Package,
   :rdfs/range :xsd/string,
   :rdfs/subPropertyOf [:spdx/name :spdx/packageName],
   :vs/term_status "stable"})
...
(def packageVerificationCodeValue
  ...
  {:db/ident :spdx/packageVerificationCodeValue,
   :rdf/type :owl/DatatypeProperty,
   :rdfs/comment "The actual package verification code as a hex encoded value.",
   :rdfs/domain :spdx/PackageVerificationCode,
   :rdfs/range :xsd/hexBinary,
   :vs/term_status "stable"})
...
(def purpose_application
  ...
  {:db/ident       :spdx/purpose_application,
   ...
   :rdfs/comment   "The package is a software application.",
   :vs/term_status "stable"})
...
(def purpose_framework
  ...
  {:db/ident       :spdx/purpose_framework,
   :rdf/type       [:spdx/Purpose :owl/NamedIndividual],
   :rdfs/comment   "The package is a software framework.",
   :vs/term_status "stable"})
...
(def purpose_install
  ...
  {:db/ident       :spdx/purpose_install,
   :rdf/type       [:spdx/Purpose :owl/NamedIndividual],
   :rdfs/comment   "The package is used to install software on disk.",
   :vs/term_status "stable"})
...
(def purpose_library
  ...
  {:db/ident       :spdx/purpose_library,
   :rdf/type       [:spdx/Purpose :owl/NamedIndividual],
   :rdfs/comment   "The package is a software library.",
   :vs/term_status "stable"})
...
(def purpose_operatingSystem
  ...
  {:db/ident       :spdx/purpose_operatingSystem,
   :rdf/type       [:spdx/Purpose :owl/NamedIndividual],
   :rdfs/comment   "The package refers to an operating system.",
   :vs/term_status "stable"})
...
(def purpose_other
  ...
  {:db/ident       :spdx/purpose_other,
   :rdf/type       [:spdx/Purpose :owl/NamedIndividual],
   :rdfs/comment   "The package doesn't fit into other purpose defined terms.",
   :vs/term_status "stable"})
...
(def purpose_source
  ...
  {:db/ident       :spdx/purpose_source,
   :rdf/type       [:spdx/Purpose :owl/NamedIndividual],
   :rdfs/comment   "The package is a collection of source files.",
   :vs/term_status "stable"})
...
(def referenceCategory
  ...
  {:db/ident       :spdx/referenceCategory,
   :rdf/type       :owl/ObjectProperty,
   :rdfs/comment   "Category for the external reference",
...
(def referencesFile
  "This property has been replaced by a relationship between the SPDX document and file with a \"contains\" relationship type. Indicates that a particular file belongs as part of the set of analyzed files in the SpdxDocument."
...
(def relatedSpdxElement
  ...
  {:db/ident       :spdx/relatedSpdxElement,
   :rdf/type       :owl/ObjectProperty,
   :rdfs/comment   "A related SpdxElement.",
...
(def relationshipType_buildToolOf
  ...
  {:db/ident       :spdx/relationshipType_buildToolOf,
   :rdf/type       [:spdx/RelationshipType :owl/NamedIndividual],
   :rdfs/comment   "To be used when SPDXRef-A is used to to build SPDXRef-B.",
   :vs/term_status "stable"})
...
(def relationshipType_dependencyOf
  ...
  {:db/ident       :spdx/relationshipType_dependencyOf,
   :rdf/type       [:spdx/RelationshipType :owl/NamedIndividual],
   :rdfs/comment   "Is to be used when SPDXRef-A is dependency of SPDXRef-B.",
   :vs/term_status "stable"})
...
(def relationshipType_dependsOn
  ...
  {:db/ident       :spdx/relationshipType_dependsOn,
   :rdf/type       [:spdx/RelationshipType :owl/NamedIndividual],
   :rdfs/comment   "Is to be used when SPDXRef-A depends on SPDXRef-B.",
   :vs/term_status "stable"})
...
(def relationshipType_describedBy
  ...
  {:db/ident :spdx/relationshipType_describedBy,
   :rdf/type [:spdx/RelationshipType :owl/NamedIndividual],
   :rdfs/comment "Is to be used an SPDXRef-A is described by SPDXRef-Document.",
   :vs/term_status "stable"})
...
(def relationshipType_describes
  ...
  {:db/ident       :spdx/relationshipType_describes,
   :rdf/type       [:spdx/RelationshipType :owl/NamedIndividual],
   :rdfs/comment   "Is to be used when SPDXRef-DOCUMENT describes SPDXRef-A.",
   :vs/term_status "stable"})
...
(def relationshipType_dynamicLink
  ...
  {:db/ident :spdx/relationshipType_dynamicLink,
   :rdf/type [:spdx/RelationshipType :owl/NamedIndividual],
   :rdfs/comment "Is to be used when SPDXRef-A dynamically links to SPDXRef-B.",
   :vs/term_status "stable"})
...
(def relationshipType_exampleOf
  ...
  {:db/ident       :spdx/relationshipType_exampleOf,
   :rdf/type       [:spdx/RelationshipType :owl/NamedIndividual],
   :rdfs/comment   "Is to be used when SPDXRef-A is an example of SPDXRef-B.",
   :vs/term_status "stable"})
...
(def relationshipType_metafileOf
  ...
  {:db/ident       :spdx/relationshipType_metafileOf,
   :rdf/type       [:spdx/RelationshipType :owl/NamedIndividual],
   :rdfs/comment   "To be used when SPDXRef-A is a metafile of SPDXRef-B.",
   :vs/term_status "stable"})
...
(def relationshipType_prerequisiteFor
  ...
  {:db/ident :spdx/relationshipType_prerequisiteFor,
   :rdf/type [:spdx/RelationshipType :owl/NamedIndividual],
   :rdfs/comment "Is to be used when SPDXRef-A is a prerequisite for SPDXRef-B",
   :vs/term_status "stable"})
...
(def relationshipType_staticLink
  ...
  {:db/ident :spdx/relationshipType_staticLink,
   :rdf/type [:spdx/RelationshipType :owl/NamedIndividual],
   :rdfs/comment "Is to be used when SPDXRef-A statically links to SPDXRef-B.",
   :vs/term_status "stable"})
...
(def relationshipType_testOf
  ...
  {:db/ident :spdx/relationshipType_testOf,
   :rdf/type [:spdx/RelationshipType :owl/NamedIndividual],
   :rdfs/comment "Is to be used when SPDXRef-A is used for testing SPDXRef-B.",
   :vs/term_status "stable"})
...
(def releaseDate
  ...
  {:db/ident :spdx/releaseDate,
   ...
   :rdfs/domain :spdx/Package,
   :rdfs/range :xsd/dateTime,
   :rdfs/subPropertyOf [:spdx/date :spdx/releaseDate],
   :vs/term_status "stable"})

(def reviewDate
  "The date and time at which the SpdxDocument was reviewed. This value must be in UTC and have 'Z' as its timezone indicator. Deprecated in favor of Annotation with an annotationType_review."
...
(def reviewed
  "Reviewed This property has been deprecated since SPDX version 2.0. It has been replaced by an Annotation with an annotation type review."
...
(def snippetName
  ...
  {:db/ident :spdx/snippetName,
   :rdf/type :owl/DatatypeProperty,
   :rdfs/comment "Identify a specific snippet in a human convenient manner.",
   :rdfs/domain :spdx/Snippet,
   :rdfs/range :xsd/string,
   :rdfs/subPropertyOf [:spdx/name :spdx/snippetName],
   :vs/term_status "stable"})
...
(def spdxDocument
  ...
  {:db/ident       :spdx/spdxDocument,
   :rdf/type       :owl/ObjectProperty,
   :rdfs/comment   "A property containing an SPDX document.",
   :rdfs/domain    :spdx/ExternalDocumentRef,
...
(def standardLicenseHeaderHtml
  ...
  {:db/ident       :spdx/standardLicenseHeaderHtml,
   :rdf/type       :owl/DatatypeProperty,
   :rdfs/comment   "HTML representation of the standard license header",
   :rdfs/domain    :spdx/ListedLicense,
   :rdfs/range     :xsd/string,
   :vs/term_status "stable"})
...
(def summary
  ...
  {:db/ident       :spdx/summary,
   :rdf/type       :owl/DatatypeProperty,
   :rdfs/comment   "Provides a short description of the package.",
   :rdfs/domain    :spdx/Package,
   :rdfs/range     :xsd/string,
   :vs/term_status "stable"})
...
(def validUntilDate
  ...
  {:db/ident :spdx/validUntilDate,
   ...
   :rdfs/domain :spdx/Package,
   :rdfs/range :xsd/dateTime,
   :rdfs/subPropertyOf [:spdx/date :spdx/validUntilDate],
   :vs/term_status "stable"})
...
(def ^{:private true} ByteOffsetPointer
  {:db/ident        :pointers/ByteOffsetPointer,
   :rdf/type        :owl/Class,
   :rdfs/subClassOf [{:owl/onDataRange :xsd/positiveInteger,
                      :owl/onProperty  :pointers/offset,
                      :owl/qualifiedCardinality 1,
                      :rdf/type        :owl/Restriction}
                     :pointers/OffsetPointer
                     :pointers/ByteOffsetPointer
                     {:owl/onClass    :spdx/File,
                      :owl/onProperty :pointers/reference,
                      :owl/qualifiedCardinality 1,
                      :rdf/type       :owl/Restriction}
                     :pointers/Pointer
...
(def ^{:private true} CompoundPointer
  {:db/ident        :pointers/CompoundPointer,
   :rdf/type        :owl/Class,
   :rdfs/subClassOf [:pointers/Pointer :pointers/CompoundPointer],
   :vs/term_status  "stable"})

(def ^{:private true} LineCharPointer
  {:db/ident        :pointers/LineCharPointer,
   :rdf/type        :owl/Class,
   :rdfs/subClassOf [{:owl/onDataRange :xsd/positiveInteger,
                      :owl/onProperty  :pointers/lineNumber,
                      :owl/qualifiedCardinality 1,
                      :rdf/type        :owl/Restriction}
                     :pointers/OffsetPointer
...
(def ^{:private true} OffsetPointer
...
(def ^{:private true} SinglePointer
...
(def ^{:private true} StartEndPointer
  {:db/ident        :pointers/StartEndPointer,
   :rdf/type        :owl/Class,
   :rdfs/subClassOf [{:owl/onClass    :pointers/SinglePointer,
                      :owl/onProperty :pointers/startPointer,
                      :owl/qualifiedCardinality 1,
                      :rdf/type       :owl/Restriction}
                     {:owl/onClass    :pointers/SinglePointer,
                      :owl/onProperty :pointers/endPointer,
                      :owl/qualifiedCardinality 1,
                      :rdf/type       :owl/Restriction}
