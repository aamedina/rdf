  ...
  {:db/ident        :spdx/Annotation,
   ...
   :rdfs/subClassOf [{:owl/onDataRange :xsd/string,
                     ...
                     {:owl/onClass    :spdx/AnnotationType,
                      ...
                      :owl/qualifiedCardinality 1,
                      :rdf/type       :owl/Restriction}],
   :vs/term_status  #rdf/langString "stable@en"})
...
(def ChecksumAlgorithm
  ...
  {:db/ident       :spdx/ChecksumAlgorithm,
   :rdf/type       :owl/Class,
   :rdfs/comment   #rdf/langString "Algorighm for Checksums.@en",
   :vs/term_status #rdf/langString "stable@en"})
...
(def FileType
  ...
  {:db/ident       :spdx/FileType,
   :rdf/type       :owl/Class,
   :rdfs/comment   #rdf/langString "Type of file.@en",
   :vs/term_status #rdf/langString "stable@en"})
...
(def LicenseException
  ...
  {:db/ident        :spdx/LicenseException,
   :rdf/type        :owl/Class,
   :rdfs/comment    #rdf/langString "An exception to a license.@en",
   :rdfs/subClassOf [{:owl/onDataRange :xsd/string,
...
(def ReferenceCategory
  ...
  {:db/ident       :spdx/ReferenceCategory,
   :rdf/type       :owl/Class,
   :rdfs/comment   #rdf/langString "Category used for ExternalRef@en",
   :vs/term_status #rdf/langString "stable@en"})
...
(def RelationshipType
  ...
  {:db/ident       :spdx/RelationshipType,
   :rdf/type       :owl/Class,
   :rdfs/comment   #rdf/langString "Type of relationship.@en",
   :vs/term_status #rdf/langString "stable@en"})
  ...
  {:db/ident :spdx/Review,
   ...
   :rdfs/subClassOf [{:owl/maxQualifiedCardinality 1,
                     ...
                     {:owl/onDataRange :xsd/dateTime,
                      ...
                      :owl/qualifiedCardinality 1,
                      :rdf/type        :owl/Restriction}],
   :vs/term_status #rdf/langString "deprecated@en"})
...
(def annotationType
  ...
  {:db/ident       :spdx/annotationType,
   :rdf/type       :owl/ObjectProperty,
   :rdfs/comment   #rdf/langString "Type of the annotation.@en",
   :rdfs/domain    :spdx/Annotation,
...
(def artifactOf
  ...
  {:db/ident :spdx/artifactOf,
   ...
   [#rdf/langString
    ...
    #rdf/langString "Deprecated as of version 2.1@en"],
   :rdfs/domain :spdx/SpdxElement,
...
(def checksumAlgorithm_md5
  ...
  {:db/ident       :spdx/checksumAlgorithm_md5,
   :rdf/type       [:spdx/ChecksumAlgorithm :owl/NamedIndividual],
   :rdfs/comment   #rdf/langString "Indicates the algorithm used was MD5@en",
   :vs/term_status #rdf/langString "stable@en"})
...
(def checksumAlgorithm_md6
  ...
  {:db/ident       :spdx/checksumAlgorithm_md6,
   :rdf/type       [:spdx/ChecksumAlgorithm :owl/NamedIndividual],
   :rdfs/comment   #rdf/langString "Indicates the algorithm used was MD6@en",
   :vs/term_status "stable"})
...
(def checksumAlgorithm_sha224
  ...
  {:db/ident       :spdx/checksumAlgorithm_sha224,
   :rdf/type       [:spdx/ChecksumAlgorithm :owl/NamedIndividual],
   :rdfs/comment   #rdf/langString "Indicates the algorithm used was SHA224@en",
   :vs/term_status #rdf/langString "stable@en"})
...
(def checksumAlgorithm_sha256
  ...
  {:db/ident       :spdx/checksumAlgorithm_sha256,
   :rdf/type       [:spdx/ChecksumAlgorithm :owl/NamedIndividual],
   :rdfs/comment   #rdf/langString "Indicates the algorithm used was SHA256@en",
   :vs/term_status #rdf/langString "stable@en"})
...
(def checksumAlgorithm_sha384
  ...
  {:db/ident       :spdx/checksumAlgorithm_sha384,
   :rdf/type       [:spdx/ChecksumAlgorithm :owl/NamedIndividual],
   :rdfs/comment   #rdf/langString "Indicates the algorithm used was SHA384@en",
   :vs/term_status #rdf/langString "stable@en"})
...
(def checksumAlgorithm_sha512
  ...
  {:db/ident       :spdx/checksumAlgorithm_sha512,
   :rdf/type       [:spdx/ChecksumAlgorithm :owl/NamedIndividual],
   :rdfs/comment   #rdf/langString "Indicates the algorithm used was SHA512@en",
   :vs/term_status #rdf/langString "stable@en"})
...
(def date
  ...
  {:db/ident       :spdx/date,
   :rdf/type       :owl/DatatypeProperty,
   :rdfs/comment   #rdf/langString "A date-time stamp.@en",
...
(def fileType
  ...
  {:db/ident       :spdx/fileType,
   :rdf/type       :owl/ObjectProperty,
   :rdfs/comment   #rdf/langString "The type of the file.@en",
   :rdfs/domain    :spdx/File,
   :vs/term_status "stable"})
...
(def fileType_archive
  ...
  {:db/ident       :spdx/fileType_archive,
   :rdf/type       [:spdx/FileType :owl/NamedIndividual],
   :rdfs/comment   #rdf/langString "Indicates the file is an archive file.@en",
   :vs/term_status #rdf/langString "stable@en"})
...
(def fileType_documentation
  ...
  {:db/ident       :spdx/fileType_documentation,
   :rdf/type       [:spdx/FileType :owl/NamedIndividual],
   :rdfs/comment   #rdf/langString "The file serves as documentation.@en",
   :vs/term_status #rdf/langString "stable@en"})
...
(def fileType_spdx
  ...
  {:db/ident       :spdx/fileType_spdx,
   :rdf/type       [:spdx/FileType :owl/NamedIndividual],
   :rdfs/comment   #rdf/langString "The file is an SPDX document.@en",
   :vs/term_status #rdf/langString "stable@en"})
...
(def licenseExceptionText
  ...
  {:db/ident       :spdx/licenseExceptionText,
   :rdf/type       :owl/DatatypeProperty,
   :rdfs/comment   #rdf/langString "Full text of the license exception.@en",
   :rdfs/domain    :spdx/LicenseException,
   :rdfs/range     :xsd/string,
   :vs/term_status #rdf/langString "stable@en"})
...
(def licenseText
  ...
  {:db/ident       :spdx/licenseText,
   :rdf/type       :owl/DatatypeProperty,
   :rdfs/comment   #rdf/langString "Full text of the license.@en",
   :rdfs/domain    :spdx/License,
   :rdfs/range     :xsd/string,
   :vs/term_status #rdf/langString "stable@en"})
...
(def licenseTextHtml
  ...
  {:db/ident       :spdx/licenseTextHtml,
   :rdf/type       :owl/DatatypeProperty,
   :rdfs/comment   #rdf/langString "License text in HTML format@en",
   :rdfs/domain    :spdx/ListedLicense,
   :rdfs/range     :xsd/string,
   :vs/term_status #rdf/langString "stable@en"})
...
(def name
  ...
  {:db/ident       :spdx/name,
   :rdf/type       :owl/DatatypeProperty,
   :rdfs/comment   #rdf/langString "Identify name of this SpdxElement.@en",
   :rdfs/domain    :spdx/SpdxElement,
   :rdfs/range     :xsd/string,
   :vs/term_status #rdf/langString "stable@en"})
...
(def purpose_application
  ...
  {:db/ident       :spdx/purpose_application,
   ...
   :rdfs/comment   #rdf/langString "The package is a software application.@en",
   :vs/term_status #rdf/langString "stable@en"})
...
(def purpose_framework
  ...
  {:db/ident       :spdx/purpose_framework,
   :rdf/type       [:spdx/Purpose :owl/NamedIndividual],
   :rdfs/comment   #rdf/langString "The package is a software framework.@en",
   :vs/term_status #rdf/langString "stable@en"})
...
(def purpose_library
  ...
  {:db/ident       :spdx/purpose_library,
   :rdf/type       [:spdx/Purpose :owl/NamedIndividual],
   :rdfs/comment   #rdf/langString "The package is a software library.@en",
   :vs/term_status #rdf/langString "stable@en"})
...
(def referenceCategory
  ...
  {:db/ident       :spdx/referenceCategory,
   :rdf/type       :owl/ObjectProperty,
   :rdfs/comment   #rdf/langString "Category for the external reference@en",
...
(def relatedSpdxElement
  ...
  {:db/ident       :spdx/relatedSpdxElement,
   :rdf/type       :owl/ObjectProperty,
   :rdfs/comment   #rdf/langString "A related SpdxElement.@en",
...
(def spdxDocument
  ...
  {:db/ident       :spdx/spdxDocument,
   :rdf/type       :owl/ObjectProperty,
   :rdfs/comment   #rdf/langString "A property containing an SPDX document.@en",
   :rdfs/domain    :spdx/ExternalDocumentRef,
...
(def timestamp
  ...
  {:db/ident     :spdx/timestamp,
   :rdf/type     :owl/DatatypeProperty,
   :rdfs/comment #rdf/langString "Timestamp@en",
   :rdfs/domain  :spdx/CrossRef,
   :rdfs/range   :xsd/dateTime})
...
(def url
  ...
  {:db/ident     :spdx/url,
   :rdf/type     :owl/DatatypeProperty,
   :rdfs/comment #rdf/langString "URL Reference@en",
   :rdfs/domain  :spdx/CrossRef,
   :rdfs/range   :xsd/anyURI})
