  ...
  {:db/ident        :spdx/Annotation,
   ...
   :rdfs/subClassOf [{:owl/onDataRange :xsd/string,
                     ...
                     {:owl/onClass    :spdx/AnnotationType,
                      ...
                      :rdf/type       :owl/Restriction}
                     :spdx/Annotation],
   :vs/term_status  #voc/lstr "stable@en"})
...
(def ChecksumAlgorithm
  ...
  {:db/ident       :spdx/ChecksumAlgorithm,
   :rdf/type       :owl/Class,
   :rdfs/comment   #voc/lstr "Algorighm for Checksums.@en",
   :vs/term_status #voc/lstr "stable@en"})
...
(def FileType
  ...
  {:db/ident       :spdx/FileType,
   :rdf/type       :owl/Class,
   :rdfs/comment   #voc/lstr "Type of file.@en",
   :vs/term_status #voc/lstr "stable@en"})
...
(def LicenseException
  ...
  {:db/ident        :spdx/LicenseException,
   :rdf/type        :owl/Class,
   :rdfs/comment    #voc/lstr "An exception to a license.@en",
   :rdfs/subClassOf [{:owl/onDataRange :xsd/string,
...
(def ReferenceCategory
  ...
  {:db/ident       :spdx/ReferenceCategory,
   :rdf/type       :owl/Class,
   :rdfs/comment   #voc/lstr "Category used for ExternalRef@en",
   :vs/term_status #voc/lstr "stable@en"})
...
(def RelationshipType
  ...
  {:db/ident       :spdx/RelationshipType,
   :rdf/type       :owl/Class,
   :rdfs/comment   #voc/lstr "Type of relationship.@en",
   :vs/term_status #voc/lstr "stable@en"})
  ...
  {:db/ident :spdx/Review,
   ...
   :rdfs/subClassOf [{:owl/maxQualifiedCardinality 1,
                     ...
                     {:owl/onDataRange :xsd/dateTime,
                      ...
                      :rdf/type        :owl/Restriction}
                     :spdx/Review],
   :vs/term_status #voc/lstr "deprecated@en"})
...
(def annotationType
  ...
  {:db/ident       :spdx/annotationType,
   :rdf/type       :owl/ObjectProperty,
   :rdfs/comment   #voc/lstr "Type of the annotation.@en",
   :rdfs/domain    :spdx/Annotation,
...
(def artifactOf
  ...
  {:db/ident :spdx/artifactOf,
   ...
   [#voc/lstr
    ...
    #voc/lstr "Deprecated as of version 2.1@en"],
   :rdfs/domain :spdx/SpdxElement,
...
(def checksumAlgorithm_adler32
  ...
  {:db/ident       :spdx/checksumAlgorithm_adler32,
   ...
   :rdfs/comment   #voc/lstr "Indicates the algorithm used was ADLER32.@en",
   :vs/term_status #voc/lstr "stable@en"})
...
(def checksumAlgorithm_blake2b256
  ...
  {:db/ident       :spdx/checksumAlgorithm_blake2b256,
   :rdf/type       [:spdx/ChecksumAlgorithm :owl/NamedIndividual],
   :rdfs/comment   #voc/lstr "Indicates the algorithm used was BLAKE2b-256.@en",
   :vs/term_status #voc/lstr "stable@en"})
...
(def checksumAlgorithm_blake2b384
  ...
  {:db/ident       :spdx/checksumAlgorithm_blake2b384,
   :rdf/type       [:spdx/ChecksumAlgorithm :owl/NamedIndividual],
   :rdfs/comment   #voc/lstr "Indicates the algorithm used was BLAKE2b-384.@en",
   :vs/term_status #voc/lstr "stable@en"})
...
(def checksumAlgorithm_blake2b512
  ...
  {:db/ident       :spdx/checksumAlgorithm_blake2b512,
   :rdf/type       [:spdx/ChecksumAlgorithm :owl/NamedIndividual],
   :rdfs/comment   #voc/lstr "Indicates the algorithm used was BLAKE2b-512.@en",
   :vs/term_status #voc/lstr "stable@en"})
...
(def checksumAlgorithm_blake3
  ...
  {:db/ident       :spdx/checksumAlgorithm_blake3,
   :rdf/type       [:spdx/ChecksumAlgorithm :owl/NamedIndividual],
   :rdfs/comment   #voc/lstr "Indicates the algorithm used was BLAKE3.@en",
   :vs/term_status #voc/lstr "stable@en"})
...
(def checksumAlgorithm_md5
  ...
  {:db/ident       :spdx/checksumAlgorithm_md5,
   :rdf/type       [:spdx/ChecksumAlgorithm :owl/NamedIndividual],
   :rdfs/comment   #voc/lstr "Indicates the algorithm used was MD5@en",
   :vs/term_status #voc/lstr "stable@en"})
...
(def checksumAlgorithm_md6
  ...
  {:db/ident       :spdx/checksumAlgorithm_md6,
   :rdf/type       [:spdx/ChecksumAlgorithm :owl/NamedIndividual],
   :rdfs/comment   #voc/lstr "Indicates the algorithm used was MD6@en",
   :vs/term_status "stable"})
...
(def checksumAlgorithm_sha224
  ...
  {:db/ident       :spdx/checksumAlgorithm_sha224,
   :rdf/type       [:spdx/ChecksumAlgorithm :owl/NamedIndividual],
   :rdfs/comment   #voc/lstr "Indicates the algorithm used was SHA224@en",
   :vs/term_status #voc/lstr "stable@en"})
...
(def checksumAlgorithm_sha256
  ...
  {:db/ident       :spdx/checksumAlgorithm_sha256,
   :rdf/type       [:spdx/ChecksumAlgorithm :owl/NamedIndividual],
   :rdfs/comment   #voc/lstr "Indicates the algorithm used was SHA256@en",
   :vs/term_status #voc/lstr "stable@en"})
...
(def checksumAlgorithm_sha384
  ...
  {:db/ident       :spdx/checksumAlgorithm_sha384,
   :rdf/type       [:spdx/ChecksumAlgorithm :owl/NamedIndividual],
   :rdfs/comment   #voc/lstr "Indicates the algorithm used was SHA384@en",
   :vs/term_status #voc/lstr "stable@en"})
...
(def checksumAlgorithm_sha3_256
  ...
  {:db/ident       :spdx/checksumAlgorithm_sha3_256,
   :rdf/type       [:spdx/ChecksumAlgorithm :owl/NamedIndividual],
   :rdfs/comment   #voc/lstr "Indicates the algorithm used was SHA3-256.@en",
   :vs/term_status #voc/lstr "stable@en"})
...
(def checksumAlgorithm_sha3_384
  ...
  {:db/ident       :spdx/checksumAlgorithm_sha3_384,
   :rdf/type       [:spdx/ChecksumAlgorithm :owl/NamedIndividual],
   :rdfs/comment   #voc/lstr "Indicates the algorithm used was SHA3-384.@en",
   :vs/term_status #voc/lstr "stable@en"})
...
(def checksumAlgorithm_sha3_512
  ...
  {:db/ident       :spdx/checksumAlgorithm_sha3_512,
   :rdf/type       [:spdx/ChecksumAlgorithm :owl/NamedIndividual],
   :rdfs/comment   #voc/lstr "Indicates the algorithm used was SHA3-512.@en",
   :vs/term_status #voc/lstr "stable@en"})
...
(def checksumAlgorithm_sha512
  ...
  {:db/ident       :spdx/checksumAlgorithm_sha512,
   :rdf/type       [:spdx/ChecksumAlgorithm :owl/NamedIndividual],
   :rdfs/comment   #voc/lstr "Indicates the algorithm used was SHA512@en",
   :vs/term_status #voc/lstr "stable@en"})
...
(def date
  ...
  {:db/ident           :spdx/date,
   :rdf/type           :owl/DatatypeProperty,
   :rdfs/comment       #voc/lstr "A date-time stamp.@en",
...
(def externalReferenceSite
  ...
  {:db/ident :spdx/externalReferenceSite,
   :rdf/type :owl/DatatypeProperty,
   :rdfs/comment
   #voc/lstr "Website for the maintainers of the external reference site@en",
   :rdfs/domain :spdx/ReferenceType,
   :rdfs/range :xsd/anyURI,
   :vs/term_status #voc/lstr "stable@en"})
...
(def fileName
  ...
  {:db/ident :spdx/fileName,
   :rdf/type :owl/DatatypeProperty,
   :rdfs/comment
   #voc/lstr "The name of the file relative to the root of the package.@en",
   :rdfs/domain :spdx/File,
   :rdfs/range :xsd/string,
...
(def fileType
  ...
  {:db/ident       :spdx/fileType,
   :rdf/type       :owl/ObjectProperty,
   :rdfs/comment   #voc/lstr "The type of the file.@en",
   :rdfs/domain    :spdx/File,
   :vs/term_status "stable"})
...
(def fileType_archive
  ...
  {:db/ident       :spdx/fileType_archive,
   :rdf/type       [:spdx/FileType :owl/NamedIndividual],
   :rdfs/comment   #voc/lstr "Indicates the file is an archive file.@en",
   :vs/term_status #voc/lstr "stable@en"})
...
(def fileType_documentation
  ...
  {:db/ident       :spdx/fileType_documentation,
   :rdf/type       [:spdx/FileType :owl/NamedIndividual],
   :rdfs/comment   #voc/lstr "The file serves as documentation.@en",
   :vs/term_status #voc/lstr "stable@en"})
...
(def fileType_other
  ...
  {:db/ident :spdx/fileType_other,
   :rdf/type [:spdx/FileType :owl/NamedIndividual],
   :rdfs/comment
   #voc/lstr "Indicates the file is not a source, archive or binary file.@en",
   :vs/term_status #voc/lstr "stable@en"})
...
(def fileType_source
  ...
  {:db/ident       :spdx/fileType_source,
   :rdf/type       [:spdx/FileType :owl/NamedIndividual],
   :rdfs/comment   #voc/lstr "Indicates the file is a source code file.@en",
   :vs/term_status #voc/lstr "stable@en"})
...
(def fileType_spdx
  ...
  {:db/ident       :spdx/fileType_spdx,
   :rdf/type       [:spdx/FileType :owl/NamedIndividual],
   :rdfs/comment   #voc/lstr "The file is an SPDX document.@en",
   :vs/term_status #voc/lstr "stable@en"})
...
(def fileType_text
  ...
  {:db/ident :spdx/fileType_text,
   :rdf/type [:spdx/FileType :owl/NamedIndividual],
   :rdfs/comment
   #voc/lstr "The file is human readable text file (MIME type of text/*).@en",
   :vs/term_status #voc/lstr "stable@en"})
...
(def isValid
  ...
  {:db/ident     :spdx/isValid,
   :rdf/type     :owl/DatatypeProperty,
   :rdfs/comment #voc/lstr "True if the URL is a valid well formed URL@en",
   :rdfs/domain  :spdx/CrossRef,
   :rdfs/range   :xsd/boolean})
...
(def isWayBackLink
  ...
  {:db/ident :spdx/isWayBackLink,
   :rdf/type :owl/DatatypeProperty,
   :rdfs/comment
   #voc/lstr "True if the License SeeAlso URL points to a Wayback archive@en",
   :rdfs/domain :spdx/CrossRef,
   :rdfs/range :xsd/boolean})
...
(def licenseExceptionTemplate
  ...
  {:db/ident       :spdx/licenseExceptionTemplate,
   :rdf/type       :owl/DatatypeProperty,
   :rdfs/comment   #voc/lstr "Template for matching license exception text@en",
   :rdfs/domain    :spdx/LicenseException,
   :rdfs/range     :xsd/string,
   :vs/term_status #voc/lstr "stable@en"})
...
(def licenseExceptionText
  ...
  {:db/ident       :spdx/licenseExceptionText,
   :rdf/type       :owl/DatatypeProperty,
   :rdfs/comment   #voc/lstr "Full text of the license exception.@en",
   :rdfs/domain    :spdx/LicenseException,
   :rdfs/range     :xsd/string,
   :vs/term_status #voc/lstr "stable@en"})
...
(def licenseText
  ...
  {:db/ident       :spdx/licenseText,
   :rdf/type       :owl/DatatypeProperty,
   :rdfs/comment   #voc/lstr "Full text of the license.@en",
   :rdfs/domain    :spdx/License,
   :rdfs/range     :xsd/string,
   :vs/term_status #voc/lstr "stable@en"})
...
(def licenseTextHtml
  ...
  {:db/ident       :spdx/licenseTextHtml,
   :rdf/type       :owl/DatatypeProperty,
   :rdfs/comment   #voc/lstr "License text in HTML format@en",
   :rdfs/domain    :spdx/ListedLicense,
   :rdfs/range     :xsd/string,
   :vs/term_status #voc/lstr "stable@en"})
...
(def name
  ...
  {:db/ident           :spdx/name,
   :rdf/type           :owl/DatatypeProperty,
   :rdfs/comment       #voc/lstr "Identify name of this SpdxElement.@en",
   :rdfs/domain        :spdx/SpdxElement,
   :rdfs/range         :xsd/string,
...
(def order
  ...
  {:db/ident     :spdx/order,
   :rdf/type     :owl/DatatypeProperty,
   :rdfs/comment #voc/lstr "The ordinal order of this element within a list@en",
   :rdfs/domain  :spdx/CrossRef,
...
(def packageVerificationCodeValue
  ...
  {:db/ident :spdx/packageVerificationCodeValue,
   :rdf/type :owl/DatatypeProperty,
   :rdfs/comment
   #voc/lstr "The actual package verification code as a hex encoded value.@en",
   :rdfs/domain :spdx/PackageVerificationCode,
   :rdfs/range :xsd/hexBinary,
   :vs/term_status #voc/lstr "stable@en"})
...
(def purpose_application
  ...
  {:db/ident       :spdx/purpose_application,
   ...
   :rdfs/comment   #voc/lstr "The package is a software application.@en",
   :vs/term_status #voc/lstr "stable@en"})
...
(def purpose_framework
  ...
  {:db/ident       :spdx/purpose_framework,
   :rdf/type       [:spdx/Purpose :owl/NamedIndividual],
   :rdfs/comment   #voc/lstr "The package is a software framework.@en",
   :vs/term_status #voc/lstr "stable@en"})
...
(def purpose_library
  ...
  {:db/ident       :spdx/purpose_library,
   :rdf/type       [:spdx/Purpose :owl/NamedIndividual],
   :rdfs/comment   #voc/lstr "The package is a software library.@en",
   :vs/term_status #voc/lstr "stable@en"})
...
(def purpose_operatingSystem
  ...
  {:db/ident       :spdx/purpose_operatingSystem,
   :rdf/type       [:spdx/Purpose :owl/NamedIndividual],
   :rdfs/comment   #voc/lstr "The package refers to an operating system.@en",
   :vs/term_status #voc/lstr "stable@en"})
...
(def purpose_other
  ...
  {:db/ident :spdx/purpose_other,
   :rdf/type [:spdx/Purpose :owl/NamedIndividual],
   :rdfs/comment
   #voc/lstr "The package doesn't fit into other purpose defined terms.@en",
   :vs/term_status #voc/lstr "stable@en"})
...
(def purpose_source
  ...
  {:db/ident       :spdx/purpose_source,
   :rdf/type       [:spdx/Purpose :owl/NamedIndividual],
   :rdfs/comment   #voc/lstr "The package is a collection of source files.@en",
   :vs/term_status #voc/lstr "stable@en"})
...
(def referenceCategory
  ...
  {:db/ident       :spdx/referenceCategory,
   :rdf/type       :owl/ObjectProperty,
   :rdfs/comment   #voc/lstr "Category for the external reference@en",
...
(def relatedSpdxElement
  ...
  {:db/ident       :spdx/relatedSpdxElement,
   :rdf/type       :owl/ObjectProperty,
   :rdfs/comment   #voc/lstr "A related SpdxElement.@en",
...
(def relationshipType
  ...
  {:db/ident :spdx/relationshipType,
   :rdf/type :owl/ObjectProperty,
   :rdfs/comment
   #voc/lstr "Describes the type of relationship between two SPDX elements.@en",
   :rdfs/domain :spdx/Relationship,
...
(def relationshipType_describedBy
  ...
  {:db/ident :spdx/relationshipType_describedBy,
   :rdf/type [:spdx/RelationshipType :owl/NamedIndividual],
   :rdfs/comment
   #voc/lstr "Is to be used an SPDXRef-A is described by SPDXRef-Document.@en",
   :vs/term_status #voc/lstr "stable@en"})
...
(def relationshipType_dynamicLink
  ...
  {:db/ident :spdx/relationshipType_dynamicLink,
   :rdf/type [:spdx/RelationshipType :owl/NamedIndividual],
   :rdfs/comment
   #voc/lstr "Is to be used when SPDXRef-A dynamically links to SPDXRef-B.@en",
   :vs/term_status #voc/lstr "stable@en"})
...
(def relationshipType_hasPrerequisite
  ...
  {:db/ident :spdx/relationshipType_hasPrerequisite,
   :rdf/type [:spdx/RelationshipType :owl/NamedIndividual],
   :rdfs/comment
   #voc/lstr "Is to be used when SPDXRef-A has as a prerequisite SPDXRef-B.@en",
   :vs/term_status #voc/lstr "stable@en"})
...
(def relationshipType_prerequisiteFor
  ...
  {:db/ident :spdx/relationshipType_prerequisiteFor,
   :rdf/type [:spdx/RelationshipType :owl/NamedIndividual],
   :rdfs/comment
   #voc/lstr "Is to be used when SPDXRef-A is a prerequisite for SPDXRef-B@en",
   :vs/term_status #voc/lstr "stable@en"})
...
(def relationshipType_staticLink
  ...
  {:db/ident :spdx/relationshipType_staticLink,
   :rdf/type [:spdx/RelationshipType :owl/NamedIndividual],
   :rdfs/comment
   #voc/lstr "Is to be used when SPDXRef-A statically links to SPDXRef-B.@en",
   :vs/term_status #voc/lstr "stable@en"})
...
(def relationshipType_testOf
  ...
  {:db/ident :spdx/relationshipType_testOf,
   :rdf/type [:spdx/RelationshipType :owl/NamedIndividual],
   :rdfs/comment
   #voc/lstr "Is to be used when SPDXRef-A is used for testing SPDXRef-B.@en",
   :vs/term_status #voc/lstr "stable@en"})
...
(def snippetName
  ...
  {:db/ident :spdx/snippetName,
   :rdf/type :owl/DatatypeProperty,
   :rdfs/comment
   #voc/lstr "Identify a specific snippet in a human convenient manner.@en",
   :rdfs/domain :spdx/Snippet,
   :rdfs/range :xsd/string,
...
(def spdxDocument
  ...
  {:db/ident       :spdx/spdxDocument,
   :rdf/type       :owl/ObjectProperty,
   :rdfs/comment   #voc/lstr "A property containing an SPDX document.@en",
   :rdfs/domain    :spdx/ExternalDocumentRef,
...
(def summary
  ...
  {:db/ident       :spdx/summary,
   :rdf/type       :owl/DatatypeProperty,
   :rdfs/comment   #voc/lstr "Provides a short description of the package.@en",
   :rdfs/domain    :spdx/Package,
   :rdfs/range     :xsd/string,
   :vs/term_status #voc/lstr "stable@en"})
...
(def timestamp
  ...
  {:db/ident     :spdx/timestamp,
   :rdf/type     :owl/DatatypeProperty,
   :rdfs/comment #voc/lstr "Timestamp@en",
   :rdfs/domain  :spdx/CrossRef,
   :rdfs/range   :xsd/dateTime})
...
(def url
  ...
  {:db/ident     :spdx/url,
   :rdf/type     :owl/DatatypeProperty,
   :rdfs/comment #voc/lstr "URL Reference@en",
   :rdfs/domain  :spdx/CrossRef,
   :rdfs/range   :xsd/anyURI})
