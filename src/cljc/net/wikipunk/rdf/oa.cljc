(ns net.wikipunk.rdf.oa
  ...
  {:dc11/title "Web Annotation Ontology",
   ...
   :prov/wasRevisionOf
   {:xsd/anyURI "http://www.openannotation.org/spec/core/20130208/oa.owl"},
   ...
   :rdfs/seeAlso {:xsd/anyURI "http://www.w3.org/TR/annotation-vocab/"},
   :xsd/anyURI "http://www.w3.org/ns/oa#"})
