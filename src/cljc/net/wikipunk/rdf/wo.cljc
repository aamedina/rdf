(ns net.wikipunk.rdf.wo
  ...
  {:dc11/creator {:rdfa/uri "http://foaf.me/zazi#me"},
   ...
   :dc11/title #rdf/langString "Weighting Ontology@en",
...
(def max_weight
  ...
  {:db/ident           :wo/max_weight,
   ...
   :rdfs/comment       #rdf/langString "A maximum weight of a scale.@en",
   :rdfs/domain        :wo/Scale,
   :rdfs/isDefinedBy   {:rdfa/uri "http://purl.org/ontology/wo/core#"},
   :rdfs/label         #rdf/langString "has max weight@en",
...
(def min_weight
  ...
  {:db/ident           :wo/min_weight,
   :rdf/type           [:rdf/Property
                        :owl/DatatypeProperty
                        :owl/FunctionalProperty],
   :rdfs/comment       #rdf/langString "A minimum weight of a scale.@en",
   :rdfs/domain        :wo/Scale,
   :rdfs/isDefinedBy   {:rdfa/uri "http://purl.org/ontology/wo/core#"},
   :rdfs/label         #rdf/langString "has min weight@en",
   :rdfs/range         :xsd/decimal,
...
(def step_size
  ...
  {:db/ident :wo/step_size,
   ...
   :rdfs/domain :wo/Scale,
   :rdfs/isDefinedBy {:rdfa/uri "http://purl.org/ontology/wo/core#"},
   :rdfs/label #rdf/langString "has step size@en",
   :rdfs/range :xsd/decimal,
   :vs/term_status #rdf/langString "unstable@en"})
...
(def weight
  ...
  {:db/ident :wo/weight,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://purl.org/ontology/wo/core#"},
   :rdfs/label #rdf/langString "has weight@en",
...
(def weight_value
  ...
  {:db/ident         :wo/weight_value,
   :rdf/type         [:owl/FunctionalProperty
                      :owl/DatatypeProperty
                      :rdf/Property],
   :rdfs/comment     #rdf/langString "The specific value of a weight.@en",
   :rdfs/domain      :wo/Weight,
   :rdfs/isDefinedBy {:rdfa/uri "http://purl.org/ontology/wo/core#"},
   :rdfs/label       #rdf/langString "has weight value@en",
   :rdfs/range       :xsd/decimal,
   :vs/term_status   #rdf/langString "testing@en"})
