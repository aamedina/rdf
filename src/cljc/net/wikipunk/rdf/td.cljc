(ns net.wikipunk.rdf.td
  ...
  {:dcterms/author "https://vcharpenay.link/#me",
   ...
   :dcterms/title #voc/lstr "Thing Description Ontology@en",
...
(def observeAllProperties
  ...
  {:db/ident :td/observeAllProperties,
   :rdf/type [:td/OperationType :schema/Enumeration :rdfs/Resource],
   :rdfs/comment
   #voc/lstr "Operation type of forms used to observe all property values@en",
   :rdfs/isDefinedBy "https://www.w3.org/2019/wot/td",
...
(def queryAction
  ...
  {:db/ident :td/queryAction,
   :rdf/type [:td/OperationType :schema/Enumeration :rdfs/Resource],
   :rdfs/comment
   #voc/lstr "Operation type of forms used to query the status of an action@en",
   :rdfs/isDefinedBy "https://www.w3.org/2019/wot/td",
...
(def subscribeAllEvents
  ...
  {:db/ident :td/subscribeAllEvents,
   :rdf/type [:td/OperationType :schema/Enumeration :rdfs/Resource],
   :rdfs/comment
   #voc/lstr "Operation type of forms used to subscribe to all event types@en",
   :rdfs/isDefinedBy "https://www.w3.org/2019/wot/td",
...
(def supportContact
  ...
  {:db/ident :td/supportContact,
   ...
   :rdfs/seeAlso ["http://schema.org/contactPoint"]})
...
(def unobserveAllProperties
  ...
  {:db/ident :td/unobserveAllProperties,
   :rdf/type [:td/OperationType :schema/Enumeration :rdfs/Resource],
   :rdfs/comment
   #voc/lstr "Operation type of forms used to unobserve all property value@en",
   :rdfs/isDefinedBy "https://www.w3.org/2019/wot/td",
...
(def unobserveProperty
  ...
  {:db/ident :td/unobserveProperty,
   :rdf/type [:td/OperationType :schema/Enumeration :rdfs/Resource],
   :rdfs/comment
   #voc/lstr "Operation type of forms used to unobserve a property value@en",
   :rdfs/isDefinedBy "https://www.w3.org/2019/wot/td",
...
(def versionInfo
  ...
  {:db/ident         :td/versionInfo,
   :rdf/type         :owl/AnnotationProperty,
   :rdfs/comment     #voc/lstr "Provides version information.@en",
   :rdfs/isDefinedBy "https://www.w3.org/2019/wot/td",
   :rdfs/label       "versionInfo",
   :rdfs/seeAlso     ["http://schema.org/version"]})
