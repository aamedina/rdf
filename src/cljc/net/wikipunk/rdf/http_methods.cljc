...
(def CONNECT
  ...
  {:db/ident :http-methods/CONNECT,
   ...
   :dcterms/title #xsd/langString "CONNECT@en",
...
(def DELETE
  ...
  {:db/ident :http-methods/DELETE,
   ...
   :dcterms/title #xsd/langString "DELETE@en",
   :rdf/type :http/Method,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.ietf.org/rfc/rfc2616.txt"}})
...
(def GET
  ...
  {:db/ident :http-methods/GET,
   ...
   :dcterms/title #xsd/langString "GET@en",
   :rdf/type :http/Method,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.ietf.org/rfc/rfc2616.txt"}})
...
(def HEAD
  ...
  {:db/ident :http-methods/HEAD,
   ...
   :dcterms/title #xsd/langString "HEAD@en",
   :rdf/type :http/Method,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.ietf.org/rfc/rfc2616.txt"}})
...
(def OPTIONS
  ...
  {:db/ident :http-methods/OPTIONS,
   ...
   :dcterms/title #xsd/langString "OPTIONS@en",
   :rdf/type :http/Method,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.ietf.org/rfc/rfc2616.txt"}})
...
(def PATCH
  ...
  {:db/ident :http-methods/PATCH,
   ...
   :dcterms/title #xsd/langString "PATCH@en",
   :rdf/type :http/Method,
...
(def POST
  ...
  {:db/ident :http-methods/POST,
   ...
   :dcterms/title #xsd/langString "POST@en",
   :rdf/type :http/Method,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.ietf.org/rfc/rfc2616.txt"}})
...
(def PUT
  ...
  {:db/ident :http-methods/PUT,
   ...
   :dcterms/title #xsd/langString "PUT@en",
   :rdf/type :http/Method,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.ietf.org/rfc/rfc2616.txt"}})
...
(def TRACE
  ...
  {:db/ident :http-methods/TRACE,
   ...
   :dcterms/title #xsd/langString "TRACE@en",
   :rdf/type :http/Method,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.ietf.org/rfc/rfc2616.txt"}})