...
(def ^{:private true} ma
  ...
  {:db/ident       :degrees/ma,
   ...
   :rdfs/comment   {:rdf/language "en",
                    :rdf/value    "masters degree in arts"},
   :rdfs/label     {:rdf/language "en",
                    :rdf/value    "M.A."},
   :vs/term_status "stable"})
...
(def ^{:private true} ms
  ...
  {:db/ident       :degrees/ms,
   :rdf/type       [:owl/NamedIndividual :bibo/ThesisDegree :owl/Thing],
   :rdfs/comment   {:rdf/language "en",
                    :rdf/value    "masters degree in science"},
   :rdfs/label     {:rdf/language "en",
                    :rdf/value    "M.S."},
   :vs/term_status "stable"})
...
(def ^{:private true} localityName
  {:db/ident :schema/localityName,
   ...
   :skos/scopeNote
   {:rdf/language "en",
    :rdf/value    "Used to name the locality of a publisher, an author, etc."}})
...
(def ^{:private true} forthcoming
  ...
  {:db/ident       :status/forthcoming,
   :rdf/type       [:owl/NamedIndividual :bibo/DocumentStatus :owl/Thing],
   :rdfs/comment   {:rdf/language "en",
                    :rdf/value    "Document to be published"},
   :rdfs/label     {:rdf/language "en",
                    :rdf/value    "forthcoming"},
   :vs/term_status "stable"})
...
(def ^{:private true} nonPeerReviewed
  ...
  {:db/ident       :status/nonPeerReviewed,
   :rdf/type       [:owl/NamedIndividual :bibo/DocumentStatus :owl/Thing],
   :rdfs/comment   {:rdf/language "en",
                    :rdf/value    "A document that is not peer reviewed"},
   :rdfs/label     {:rdf/language "en",
                    :rdf/value    "non peer reviewed"},
   :vs/term_status "stable"})
...
(def ^{:private true} unpublished
  ...
  {:db/ident       :status/unpublished,
   :rdf/type       [:owl/NamedIndividual :bibo/DocumentStatus :owl/Thing],
   :rdfs/comment   {:rdf/language "en",
                    :rdf/value    "Unpublished document"},
   :rdfs/label     {:rdf/language "en",
                    :rdf/value    "unpublished"},
   :vs/term_status "stable"})
