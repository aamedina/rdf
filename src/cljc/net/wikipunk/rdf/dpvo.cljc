(ns net.wikipunk.rdf.dpvo
  ...
  {:dcat/downloadURL "resources/dpv-owl/dpv.ttl",
   ...
   :vann/preferredNamespacePrefix #xsd/string "dpvo",
   :vann/preferredNamespaceUri #xsd/string "https://w3id.org/dpv/dpv-owl#"})
...
(def AuditConditionallyApproved
  ...
  {:db/ident :dpvo/AuditConditionallyApproved,
   ...
   :rdf/type
   [:dpvo/AuditStatus :owl/NamedIndividual :dpvo/Context :dpvo/Status],
   :rdfs/comment
   #xsd/langString
...
(def CloudLocation
  ...
  {:db/ident :dpvo/CloudLocation,
   ...
   :rdfs/subClassOf
   [:dpvo/RemoteLocation :dpvo/Location :dpvo/LocationLocality],
   :vs/term_status #xsd/langString "modified@en"})
...
(def CounterMoneyLaundering
  ...
  {:db/ident :dpvo/CounterMoneyLaundering,
   ...
   :rdfs/subClassOf
   [:dpvo/FraudPreventionAndDetection :dpvo/Purpose :dpvo/EnforceSecurity],
   :vs/term_status #xsd/langString "accepted@en"})
...
(def DataSubProcessor
  ...
  {:db/ident :dpvo/DataSubProcessor,
   ...
   :rdfs/subClassOf
   [:dpvo/DataProcessor :dpvo/Recipient :dpvo/Entity :dpvo/LegalEntity],
   :vs/term_status #xsd/langString "accepted@en"})
...
(def DataTransferLegalBasis
  ...
  {:db/ident :dpvo/DataTransferLegalBasis,
   :dcterms/created #xsd/date #inst "2021-09-08T00:00:00.000-04:00",
   :dcterms/creator [#xsd/string "Georg P Krogg" #xsd/string "David Hickey"],
   :dcterms/description
   #xsd/langString
...
(def DeliveryOfGoods
  ...
  {:db/ident :dpvo/DeliveryOfGoods,
   ...
   :rdfs/subClassOf
   [:dpvo/RequestedServiceProvision :dpvo/Purpose :dpvo/ServiceProvision],
   :vs/term_status #xsd/langString "accepted@en"})
...
(def Harm
  ...
  {:db/ident            :dpvo/Harm,
   ...
   :rdfs/subClassOf     [:dpvo/Damage :dpvo/Impact :dpvo/Consequence],
   :vs/term_status      #xsd/langString "changed@en"})
...
(def InternationalOrganisation
  ...
  {:db/ident :dpvo/InternationalOrganisation,
   :dcterms/created #xsd/date #inst "2022-03-23T00:00:00.000-04:00",
   :dcterms/creator [#xsd/string "Julian Flake" #xsd/string "Georg P. Krog"],
   :dcterms/description
   #xsd/langString
...
(def OptimisationForConsumer
  ...
  {:db/ident :dpvo/OptimisationForConsumer,
   ...
   :rdfs/subClassOf
   [:dpvo/ServiceOptimisation :dpvo/Purpose :dpvo/ServiceProvision],
   :vs/term_status #xsd/langString "accepted@en"})
...
(def PersonnelHiring
  ...
  {:db/ident :dpvo/PersonnelHiring,
   ...
   :rdfs/subClassOf
   [:dpvo/PersonnelManagement :dpvo/Purpose :dpvo/HumanResourceManagement],
   :vs/term_status #xsd/langString "accepted@en"})
...
(def PrivateLocation
  ...
  {:db/ident :dpvo/PrivateLocation,
   ...
   :rdfs/subClassOf [:dpvo/LocalLocation :dpvo/Location :dpvo/LocationLocality],
   :vs/term_status #xsd/langString "accepted@en"})
...
(def SellDataToThirdParties
  ...
  {:db/ident :dpvo/SellDataToThirdParties,
   ...
   :rdfs/subClassOf [:dpvo/SellProducts :dpvo/Purpose :dpvo/ServiceProvision],
   :vs/term_status #xsd/langString "accepted@en"})
