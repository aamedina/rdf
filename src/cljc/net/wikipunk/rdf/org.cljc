...
(def hasPost
  {:db/ident :org/hasPost,
   ...
   :rdfs/comment
   #{{:rdf/language "en",
      :rdf/value    "Indicates a Post which exists within the Organization."}
     {:rdf/language "es",
      :rdf/value    "Posición que existe en una organización."}
     {:rdf/language "it",
      :rdf/value    "Indica il Post che è presente in una Organization."}
     {:rdf/language "fr",
      :rdf/value    "Indicate un Poste qui existe dans l'Organisation."}
     {:rdf/language "ja",
