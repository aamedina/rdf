(ns net.wikipunk.rdf.org
  {:dcterms/contributor [{:foaf/mbox "emontiel@fi.upm.es",
   ...
   :dcterms/title [#rdf/langString "Core organization ontology@en"
                   #rdf/langString "Ontología de organizaciones@es"
...
(def ChangeEvent
  {:db/ident :org/ChangeEvent,
   ...
   :rdfs/label [#rdf/langString "Change Event@en"
                #rdf/langString "Evento di cambiamento@it"
...
(def Head
  {:db/ident :org/Head,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label [#rdf/langString "directora ejecutiva@es"
                #rdf/langString "responsabile@it"
                #rdf/langString "head@en"
                #rdf/langString "director ejecutivo@es"
                #rdf/langString "responsable@fr"],
   :skos/prefLabel [#rdf/langString "responsable@fr"
                    #rdf/langString "head@en"
                    #rdf/langString "responsabile@it"]})
...
(def Membership
  {:db/ident :org/Membership,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label [#rdf/langString "Membership@en"
                #rdf/langString "Appartenenza@it"
                #rdf/langString "Engagement@fr"
                #rdf/langString "membresía@es"],
...
(def Organization
  {:db/ident :org/Organization,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label [#rdf/langString "Organizzazione@it"
                #rdf/langString "Organisation@fr"
                #rdf/langString "Organization@en"
                #rdf/langString "organización@es"],
...
(def OrganizationalCollaboration
  {:db/ident :org/OrganizationalCollaboration,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label [#rdf/langString "Partenariat@fr"
                #rdf/langString "Collaborazione@it"
...
(def OrganizationalUnit
  {:db/ident :org/OrganizationalUnit,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label [#rdf/langString "OrganizationalUnit@en"
                #rdf/langString "unidad organizativa@es"
...
(def Post
  {:db/ident :org/Post,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label [#rdf/langString "Impiego@it"
                #rdf/langString "puesto@es"
                #rdf/langString "Poste@fr"
                #rdf/langString "Post@en"],
   :rdfs/subClassOf :rdfs/Resource})
...
(def Role
  {:db/ident :org/Role,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label [#rdf/langString "Rôle@fr"
                #rdf/langString "Role@en"
                #rdf/langString "actividad@es"
...
(def Site
  {:db/ident :org/Site,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label [#rdf/langString "Sede@it"
                #rdf/langString "Site@fr"
                #rdf/langString "Site@en"
                #rdf/langString "sede@es"],
   :rdfs/subClassOf :rdfs/Resource})
...
(def basedAt
  {:db/ident :org/basedAt,
   ...
   :rdfs/label [#rdf/langString "basé à@fr"
                #rdf/langString "based At@en"
                #rdf/langString "basata a@it"
...
(def changedBy
  {:db/ident :org/changedBy,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label [#rdf/langString "cambiata da@it"
                #rdf/langString "changed by@en"
                #rdf/langString "es modificado por@es"
                #rdf/langString "es modificada por@es"
                #rdf/langString "modifiée par@fr"],
...
(def classification
  {:db/ident :org/classification,
   ...
   :rdfs/domain :org/Organization,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label [#rdf/langString "classificazione@it"
                #rdf/langString "pertenece a la clasificación@es"
...
(def hasMember
  {:db/ident :org/hasMember,
   ...
   :rdfs/domain :org/Organization,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label [#rdf/langString "tiene miembro@es"
                #rdf/langString "ha membro@it"
                #rdf/langString "has member@en"
...
(def hasMembership
  {:db/ident :org/hasMembership,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label [#rdf/langString "appartenenza@it"
                #rdf/langString "tiene membresía@es"
                #rdf/langString "membership@en"
                #rdf/langString "engagement@fr"],
...
(def hasPost
  {:db/ident :org/hasPost,
   ...
   :rdfs/domain :org/Organization,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label [#rdf/langString "possède un poste@fr"
                #rdf/langString "post@en"
                #rdf/langString "tiene puesto@es"
                #rdf/langString "impiego@it"],
   :rdfs/range :org/Post})
...
(def hasPrimarySite
  {:db/ident :org/hasPrimarySite,
   ...
   :rdfs/domain :org/Organization,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label [#rdf/langString "tiene sede principal en@es"
                #rdf/langString "site principal@fr"
...
(def hasSite
  {:db/ident :org/hasSite,
   ...
   :rdfs/domain :org/Organization,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label [#rdf/langString "a un site@fr"
                #rdf/langString "ha sede@it"
                #rdf/langString "has site@en"
                #rdf/langString "tiene sede en@es"],
   :rdfs/range :org/Site})
...
(def hasSubOrganization
  {:db/ident :org/hasSubOrganization,
   ...
   :rdfs/domain :org/Organization,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label [#rdf/langString "has SubOrganization@en"
                #rdf/langString "tiene suborganización@es"
                #rdf/langString "a une Sous-Organization@fr"
...
(def hasUnit
  {:db/ident :org/hasUnit,
   ...
   :rdfs/domain :org/FormalOrganization,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label [#rdf/langString "contiene unidad@es"
                #rdf/langString "ha Unit@it"
                #rdf/langString "possède une Unité@fr"
                #rdf/langString "has Unit@en"],
...
(def headOf
  {:db/ident :org/headOf,
   ...
   :rdfs/domain :foaf/Agent,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label [#rdf/langString "responsabile di@it"
                #rdf/langString "responsable de@fr"
                #rdf/langString "head of@en"
...
(def heldBy
  {:db/ident         :org/heldBy,
   ...
   :rdfs/comment     [#rdf/langString
                      ...
                      #rdf/langString "ポストを保持するエージェントを示します。@ja"],
   :rdfs/domain      :org/Post,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label       [#rdf/langString "ocupado por@es"
                      #rdf/langString "occupé par@fr"
                      #rdf/langString "held by@en"
                      #rdf/langString "ricoperto da@it"],
   :rdfs/range       :foaf/Agent})
...
(def holds
  {:db/ident         :org/holds,
   ...
   :rdf/type         [:owl/ObjectProperty :rdf/Property],
   :rdfs/comment     [#rdf/langString "Puesto ocupado por algún agente.@es"
                      #rdf/langString
   ...
   :rdfs/domain      :foaf/Agent,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label       [#rdf/langString "holds@en"
                      #rdf/langString "ricopre@it"
                      #rdf/langString "occupe@fr"
                      #rdf/langString "ocupa@es"],
   :rdfs/range       :org/Post})
...
(def identifier
  {:db/ident :org/identifier,
   ...
   :rdfs/domain :org/Organization,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label [#rdf/langString "identifiant@fr"
                #rdf/langString "tiene identificador@es"
                #rdf/langString "identifier@en"
                #rdf/langString "identificatore@it"],
...
(def linkedTo
  {:db/ident :org/linkedTo,
   ...
   :rdfs/domain :org/Organization,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label [#rdf/langString "está relacionado con@es"
                #rdf/langString "linked to@en"
                #rdf/langString "está relacionada con@es"
                #rdf/langString "collegato a@it"
                #rdf/langString "relié à@fr"],
   :rdfs/range :org/Organization})
...
(def location
  {:db/ident :org/location,
   ...
   :rdfs/domain :foaf/Person,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label [#rdf/langString "está ubicada en@es"
                #rdf/langString "está ubicado en@es"
                #rdf/langString "luogo@it"
                #rdf/langString "localisation@fr"
                #rdf/langString "location@en"],
...
(def member
  {:db/ident :org/member,
   ...
   :rdfs/label [#rdf/langString "member@en"
                #rdf/langString "membre@fr"
                #rdf/langString "membro@it"
                #rdf/langString "es condición de miembro sobre agente@es"],
   :rdfs/range :foaf/Agent})
...
(def memberDuring
  {:db/ident :org/memberDuring,
   ...
   :rdfs/domain :org/Membership,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label [#rdf/langString "member During@en"
                #rdf/langString "durée d'engagement@fr"
...
(def memberOf
  {:db/ident :org/memberOf,
   ...
   :rdfs/domain :foaf/Agent,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label [#rdf/langString "membre de@fr"
                #rdf/langString "es miembro de@es"
                #rdf/langString "member of@en"
...
(def organization
  {:db/ident :org/organization,
   ...
   [#rdf/langString "Indica l'Organization in cui l'Agent è un membro.@it"
    ...
    #rdf/langString "Indicates Organization in which the Agent is a member.@en"
...
(def originalOrganization
  {:db/ident :org/originalOrganization,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label [#rdf/langString "es organización original@es"
                #rdf/langString "organizzazione originale@it"
                #rdf/langString "original organization@en"
...
(def postIn
  {:db/ident :org/postIn,
   ...
   :rdfs/domain :org/Post,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label [#rdf/langString "poste chez@fr"
                #rdf/langString "post in@en"
                #rdf/langString "es un puesto en@es"
                #rdf/langString "impiego in@it"],
   :rdfs/range :org/Organization})
...
(def purpose
  {:db/ident :org/purpose,
   ...
   :rdfs/domain :org/Organization,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label [#rdf/langString "but@fr"
                #rdf/langString "tiene objetivo@es"
                #rdf/langString "purpose@en"
...
(def remuneration
  {:db/ident :org/remuneration,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label [#rdf/langString "rémuneration@fr"
                #rdf/langString "remunerazione@it"
                #rdf/langString "recibe remuneración@es"
                #rdf/langString "remuneration@en"]})
...
(def reportsTo
  {:db/ident :org/reportsTo,
   ...
   :rdfs/domain {:owl/unionOf [:foaf/Agent :org/Post],
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label [#rdf/langString "riporta a@it"
                #rdf/langString "est subordonné à@fr"
                #rdf/langString "reports to@en"
                #rdf/langString "responde ante@es"],
...
(def resultedFrom
  {:db/ident :org/resultedFrom,
   ...
   :rdfs/domain :org/Organization,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label [#rdf/langString "resulted from@en"
                #rdf/langString "es el resultado de@es"
                #rdf/langString "issue de@fr"
                #rdf/langString "risultato da@it"],
   :rdfs/range :org/ChangeEvent,
...
(def resultingOrganization
  {:db/ident :org/resultingOrganization,
   ...
   :rdfs/domain :org/ChangeEvent,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label [#rdf/langString "resulted in@en"
                #rdf/langString "resulta en@es"
                #rdf/langString "risultato in@it"
                #rdf/langString "a donné naissance à@fr"],
   :rdfs/range :org/Organization})
...
(def siteAddress
  {:db/ident :org/siteAddress,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label [#rdf/langString "es la dirección de la sede@es"
                #rdf/langString "site Address@en"
...
(def siteOf
  {:db/ident :org/siteOf,
   ...
   :rdfs/domain :org/Site,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label [#rdf/langString "sede di@it"
                #rdf/langString "es sede de@es"
                #rdf/langString "site de@fr"
                #rdf/langString "site Of@en"],
   :rdfs/range :org/Organization})
...
(def transitiveSubOrganizationOf
  {:db/ident :org/transitiveSubOrganizationOf,
   ...
   :rdfs/domain :org/Organization,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label [#rdf/langString "transitive sub-organization@en"
                #rdf/langString "es suborganización de manera transitiva de@es"
                #rdf/langString "es suborganización de (transitiva)@es"
                #rdf/langString "sotto-Organization transitiva@it"
                #rdf/langString "sous-Organization transitive de@fr"],
   :rdfs/range :org/Organization})
...
(def unitOf
  {:db/ident :org/unitOf,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label [#rdf/langString "unit Of@en"
                #rdf/langString "unità di@it"
                #rdf/langString "es unidad de@es"
                #rdf/langString "unité de@fr"],
