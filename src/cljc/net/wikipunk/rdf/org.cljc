(ns net.wikipunk.rdf.org
  ...
  {:dcterms/contributor #{{:foaf/mbox "dguardiola@quinode.fr",
   ...
   :dcterms/title #{#rdf/langString "Ontología de organizaciones@es"
                    #rdf/langString "Core organization ontology@en"
                    #rdf/langString "Ontologie des organisations@fr"
                    #rdf/langString "Ontologia delle organizzazioni@it"},
   :owl/versionInfo "0.8",
   ...
   :rdfs/label #{#rdf/langString "Ontología de organizaciones@es"
                 #rdf/langString "Core organization ontology@en"
                 #rdf/langString "Ontologie des organisations@fr"
                 #rdf/langString "Ontologia delle organizzazioni@it"},
...
(def ChangeEvent
  ...
  {:db/ident :org/ChangeEvent,
   ...
   :rdfs/label #{#rdf/langString "Evento di cambiamento@it"
                 #rdf/langString "Change Event@en"
                 #rdf/langString "evento de cambio@es"
                 #rdf/langString "Évènement@fr"},
...
(def FormalOrganization
  ...
  {:db/ident :org/FormalOrganization,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label #{#rdf/langString "organización formal@es"
                 #rdf/langString "Formal Organization@en"
                 #rdf/langString "Organisation Formelle@fr"
                 #rdf/langString "Organizzazione formale@it"},
...
(def Head
  ...
  {:db/ident :org/Head,
   ...
   :rdf/type :org/Role,
   :rdfs/comment
   #{#rdf/langString "Actividad correspondiente a la propiedad `org:headOf`.@es"
     #rdf/langString "Un ruolo corrispondente alla proprietà `org:headOf`.@it"
     #rdf/langString "A role corresponding to the `org:headOf` property@en"
     #rdf/langString "Un rôle correspondant à la propriété `org:headOf`@fr"},
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label #{#rdf/langString "head@en" #rdf/langString "responsabile@it"
                 #rdf/langString "responsable@fr"
                 #rdf/langString "director ejecutivo@es"
                 #rdf/langString "directora ejecutiva@es"},
   :skos/prefLabel #{#rdf/langString "head@en" #rdf/langString "responsabile@it"
                     #rdf/langString "responsable@fr"}})
...
(def Membership
  ...
  {:db/ident :org/Membership,
   ...
   #{#rdf/langString
     ...
     #rdf/langString "組織のエージェントの構成員の本質を示します。@ja"},
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label
   #{#rdf/langString "Engagement@fr" #rdf/langString "Appartenenza@it"
     #rdf/langString "Membership@en" #rdf/langString "membresía@es"}})
...
(def Organization
  ...
  {:db/ident :org/Organization,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label
   #{#rdf/langString "organización@es" #rdf/langString "Organizzazione@it"
     #rdf/langString "Organization@en" #rdf/langString "Organisation@fr"},
...
(def OrganizationalCollaboration
  ...
  {:db/ident :org/OrganizationalCollaboration,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label #{#rdf/langString "Collaborazione@it"
                 #rdf/langString "proyecto de cooperación empresarial@es"
                 #rdf/langString "Partenariat@fr"
                 #rdf/langString "Endeavour@en"},
...
(def OrganizationalUnit
  ...
  {:db/ident :org/OrganizationalUnit,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label #{#rdf/langString "unidad organizativa@es"
                 #rdf/langString "Unità Organizzativa@it"
                 #rdf/langString "OrganizationalUnit@en"
                 #rdf/langString "Unité opérationnelle@fr"},
   :rdfs/subClassOf :org/Organization})
...
(def Post
  ...
  {:db/ident :org/Post,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label #{#rdf/langString "Post@en" #rdf/langString "Poste@fr"
                 #rdf/langString "puesto@es" #rdf/langString "Impiego@it"}})
...
(def Role
  ...
  {:db/ident :org/Role,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label #{#rdf/langString "Role@en" #rdf/langString "actividad@es"
                 #rdf/langString "Ruolo@it" #rdf/langString "Rôle@fr"},
...
(def Site
  ...
  {:db/ident :org/Site,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label #{#rdf/langString "Site@en" #rdf/langString "Sede@it"
                 #rdf/langString "sede@es" #rdf/langString "Site@fr"}})
...
(def basedAt
  ...
  {:db/ident :org/basedAt,
   ...
   :rdfs/comment
   #{#rdf/langString "人が基礎としているサイトを示します。人が複数のサイトを基礎としている可能性を制限しません。@ja"
     #rdf/langString
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label #{#rdf/langString "basé à@fr"
                 #rdf/langString "trabaja en la sede@es"
                 #rdf/langString "based At@en" #rdf/langString "basata a@it"},
   :rdfs/range :org/Site})
...
(def changedBy
  ...
  {:db/ident :org/changedBy,
   ...
   #{#rdf/langString
     ...
     #rdf/langString "この組織の変更のきっかけとなった出来事を示します。@ja"
     #rdf/langString
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label
   #{#rdf/langString "es modificado por@es" #rdf/langString "cambiata da@it"
     #rdf/langString "changed by@en" #rdf/langString "modifiée par@fr"
     #rdf/langString "es modificada por@es"},
...
(def classification
  ...
  {:db/ident :org/classification,
   ...
   :rdfs/domain :org/Organization,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label #{#rdf/langString "pertenece a la clasificación@es"
                 #rdf/langString "classification@fr"
                 #rdf/langString "classificazione@it"
                 #rdf/langString "classification@en"},
...
(def hasMember
  ...
  {:db/ident :org/hasMember,
   ...
   :rdfs/domain :org/Organization,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label #{#rdf/langString "has member@en" #rdf/langString "ha membro@it"
                 #rdf/langString "tiene miembro@es"
                 #rdf/langString "possède un membre@fr"},
...
(def hasMembership
  ...
  {:db/ident :org/hasMembership,
   ...
   #{#rdf/langString
     ...
     #rdf/langString "エージェントが担う構成員関係を示します。@ja"
     #rdf/langString
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label #{#rdf/langString "tiene membresía@es"
                 #rdf/langString "engagement@fr" #rdf/langString "membership@en"
                 #rdf/langString "appartenenza@it"},
...
(def hasPost
  ...
  {:db/ident :org/hasPost,
   :rdf/type #{:owl/ObjectProperty :rdf/Property},
   :rdfs/comment
   #{#rdf/langString "Indicate un Poste qui existe dans l'Organisation.@fr"
     #rdf/langString "Indicates a Post which exists within the Organization.@en"
     #rdf/langString "Posición que existe en una organización.@es"
     #rdf/langString "組織内に存在するポストを示します。@ja"
     #rdf/langString "Indica il Post che è presente in una Organization.@it"},
   :rdfs/domain :org/Organization,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label #{#rdf/langString "tiene puesto@es"
                 #rdf/langString "possède un poste@fr"
                 #rdf/langString "impiego@it" #rdf/langString "post@en"},
   :rdfs/range :org/Post})
...
(def hasPrimarySite
  ...
  {:db/ident :org/hasPrimarySite,
   ...
   #{#rdf/langString
     ...
     #rdf/langString "組織の主要サイトを示します。組織の窓口となりえるデフォルトの手段ですが、正式な本部とは限りません。@ja"
     #rdf/langString
   ...
   :rdfs/domain :org/Organization,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label #{#rdf/langString "site principal@fr"
                 #rdf/langString "sede principale@it"
                 #rdf/langString "primary Site@en"
                 #rdf/langString "tiene sede principal en@es"},
   :rdfs/range :org/Site,
...
(def hasRegisteredSite
  ...
  {:db/ident :org/hasRegisteredSite,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label #{#rdf/langString "sede legale@it"
                 #rdf/langString "tiene sede registrada en@es"
                 #rdf/langString "registered Site@en"
                 #rdf/langString "siège social@fr"},
   :rdfs/range :org/Site,
...
(def hasSite
  ...
  {:db/ident :org/hasSite,
   ...
   :rdfs/domain :org/Organization,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label #{#rdf/langString "tiene sede en@es"
                 #rdf/langString "a un site@fr" #rdf/langString "ha sede@it"
                 #rdf/langString "has site@en"},
   :rdfs/range :org/Site})
...
(def hasSubOrganization
  ...
  {:db/ident :org/hasSubOrganization,
   ...
   #{#rdf/langString
     ...
     #rdf/langString "組織または組織単位の階層的包含を表わします。この組織のサブパートまたは子である組織を示します。@ja"
     #rdf/langString
   ...
   :rdfs/domain :org/Organization,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label #{#rdf/langString "a une Sous-Organization@fr"
                 #rdf/langString "ha sotto-Organization@it"
                 #rdf/langString "tiene suborganización@es"
                 #rdf/langString "has SubOrganization@en"},
...
(def hasUnit
  ...
  {:db/ident :org/hasUnit,
   ...
   :rdf/type #{:owl/ObjectProperty :rdf/Property},
   :rdfs/comment
   #{#rdf/langString "例えば、より大きな組織内の部局など、この組織の一部である単位を示します。@ja"
     #rdf/langString
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label
   #{#rdf/langString "possède une Unité@fr" #rdf/langString "ha Unit@it"
     #rdf/langString "contiene unidad@es" #rdf/langString "has Unit@en"},
...
(def headOf
  ...
  {:db/ident :org/headOf,
   ...
   #{#rdf/langString
     ...
     #rdf/langString "人（または他のエージェント）が組織のリーダーや正式なトップであることを示します。@ja"
     #rdf/langString
   ...
   :rdfs/domain :foaf/Agent,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label #{#rdf/langString "head of@en"
                 #rdf/langString "responsable de@fr"
                 #rdf/langString "responsabile di@it"
                 #rdf/langString "es director ejecutivo de@es"},
   :rdfs/range :org/Organization,
...
(def heldBy
  ...
  {:db/ident         :org/heldBy,
   :rdf/type         #{:owl/ObjectProperty :rdf/Property},
   :rdfs/comment     #{#rdf/langString "ポストを保持するエージェントを示します。@ja"
                       #rdf/langString "Indica un Agent che ricopre un Post.@it"
                       #rdf/langString
                        "Indicate un Agent qui occupe le Poste.@fr"
                       #rdf/langString "Agente que ocupa un puesto.@es"
                       #rdf/langString
                        "Indicates an Agent which holds a Post.@en"},
   :rdfs/domain      :org/Post,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label       #{#rdf/langString "ricoperto da@it"
                       #rdf/langString "occupé par@fr"
                       #rdf/langString "held by@en"
                       #rdf/langString "ocupado por@es"},
   :rdfs/range       :foaf/Agent})
...
(def holds
  ...
  {:db/ident         :org/holds,
   ...
   :rdfs/comment     #{#rdf/langString
                       ...
                       #rdf/langString "あるエージェントによって保持されているポストを示します。@ja"
                       #rdf/langString
                        "Indicate un Poste occupé par un Agent.@fr"
                       #rdf/langString "Puesto ocupado por algún agente.@es"
                       #rdf/langString
                        "Indicates a Post held by some Agent.@en"},
   :rdfs/domain      :foaf/Agent,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label       #{#rdf/langString "occupe@fr" #rdf/langString "holds@en"
                       #rdf/langString "ricopre@it" #rdf/langString "ocupa@es"},
   :rdfs/range       :org/Post})
...
(def identifier
  ...
  {:db/ident :org/identifier,
   ...
   #{#rdf/langString
     ...
     #rdf/langString "組織を一意に識別するために使用できる会社登録番号などの識別子を与えます。@ja"},
   :rdfs/domain :org/Organization,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label
   #{#rdf/langString "identifiant@fr" #rdf/langString "tiene identificador@es"
     #rdf/langString "identifier@en" #rdf/langString "identificatore@it"},
...
(def linkedTo
  ...
  {:db/ident :org/linkedTo,
   ...
   #{#rdf/langString
     ...
     #rdf/langString "2つの組織の任意の関係を示します。@ja"},
   :rdfs/domain :org/Organization,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label
   #{#rdf/langString "linked to@en" #rdf/langString "está relacionada con@es"
     #rdf/langString "relié à@fr" #rdf/langString "está relacionado con@es"
     #rdf/langString "collegato a@it"},
   :rdfs/range :org/Organization})
...
(def location
  ...
  {:db/ident :org/location,
   ...
   #{#rdf/langString
     ...
     #rdf/langString "例えば、内部配送目的のメール・ストップ（Mail Stop）などの、組織内の人の位置記述を提供します。@ja"
     #rdf/langString
   ...
   :rdfs/domain :foaf/Person,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label #{#rdf/langString "luogo@it" #rdf/langString "location@en"
                 #rdf/langString "está ubicada en@es"
                 #rdf/langString "localisation@fr"
                 #rdf/langString "está ubicado en@es"},
...
(def member
  ...
  {:db/ident :org/member,
   ...
   :rdfs/comment
   #{#rdf/langString "構成員関係に含まれている人（または、組織を含んでいる他のエージェント）を示します。@ja"
     #rdf/langString
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label #{#rdf/langString "es condición de miembro sobre agente@es"
                 #rdf/langString "membro@it" #rdf/langString "membre@fr"
                 #rdf/langString "member@en"},
   :rdfs/range :foaf/Agent})
...
(def memberDuring
  ...
  {:db/ident :org/memberDuring,
   ...
   #{#rdf/langString
     ...
     #rdf/langString "構成員が有効である／であった期間を示すためのオプションのプロパティー。@ja"
     #rdf/langString
      "Optional property to indicate the interval for which the membership is/was valid.@en"},
   :rdfs/domain :org/Membership,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label #{#rdf/langString "durée d'engagement@fr"
                 #rdf/langString "member During@en"
                 #rdf/langString "es miembro durante@es"
                 #rdf/langString "membro durante@it"}})
...
(def memberOf
  ...
  {:db/ident :org/memberOf,
   ...
   :rdfs/domain :foaf/Agent,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label #{#rdf/langString "member of@en" #rdf/langString "membre de@fr"
                 #rdf/langString "es miembro de@es"
                 #rdf/langString "membro di@it"},
   :rdfs/range :org/Organization})
...
(def organization
  ...
  {:db/ident :org/organization,
   :rdf/type #{:owl/ObjectProperty :rdf/Property :owl/FunctionalProperty},
   :rdfs/comment
   #{#rdf/langString "エージェントがメンバーである組織を示します。@ja"
     #rdf/langString "Indique l'Organization dont l'agent est membre.@fr"
     #rdf/langString "Indica l'Organization in cui l'Agent è un membro.@it"
     #rdf/langString
      "Organización a la que pertenece el agente en calidad de miembro.@es"
     #rdf/langString
      "Indicates Organization in which the Agent is a member.@en"},
   :rdfs/domain :org/Membership,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label #{#rdf/langString "es condición de miembro sobre organización@es"
                 #rdf/langString "organizzazione@it"
                 #rdf/langString "organisation@fr"
                 #rdf/langString "organization@en"},
   :rdfs/range :org/Organization})
...
(def originalOrganization
  ...
  {:db/ident :org/originalOrganization,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label #{#rdf/langString "original organization@en"
                 #rdf/langString "es organización original@es"
                 #rdf/langString "organisation originelle@fr"
                 #rdf/langString "organizzazione originale@it"},
   :rdfs/range :org/Organization,
...
(def postIn
  ...
  {:db/ident :org/postIn,
   ...
   :rdf/type #{:owl/ObjectProperty :rdf/Property},
   :rdfs/comment
   #{#rdf/langString "Indica l'Organization in cui il Post è presente.@it"
     #rdf/langString "Indicates the Organization in which the Post exists.@en"
     #rdf/langString "Organización en la que existe el puesto.@es"
     #rdf/langString "Indicate l'Organisation dans laquelle le Poste existe.@fr"
     #rdf/langString "ポストが存在する組織を示します。@ja"},
   :rdfs/domain :org/Post,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label #{#rdf/langString "es un puesto en@es"
                 #rdf/langString "post in@en" #rdf/langString "impiego in@it"
                 #rdf/langString "poste chez@fr"},
   :rdfs/range :org/Organization})
...
(def purpose
  ...
  {:db/ident :org/purpose,
   ...
   :rdfs/domain :org/Organization,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label #{#rdf/langString "but@fr" #rdf/langString "purpose@en"
                 #rdf/langString "obiettivo@it"
                 #rdf/langString "tiene objetivo@es"}})
...
(def remuneration
  ...
  {:db/ident :org/remuneration,
   ...
   #{#rdf/langString
     ...
     #rdf/langString "役割に関係する給料やその他の報酬を示します。@ja"
     #rdf/langString
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label
   #{#rdf/langString "remuneration@en" #rdf/langString "recibe remuneración@es"
     #rdf/langString "remunerazione@it" #rdf/langString "rémuneration@fr"}})
...
(def reportsTo
  ...
  {:db/ident :org/reportsTo,
   ...
   :rdfs/domain {:owl/unionOf [:foaf/Agent :org/Post],
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label #{#rdf/langString "responde ante@es"
                 #rdf/langString "riporta a@it" #rdf/langString "reports to@en"
                 #rdf/langString "est subordonné à@fr"},
...
(def resultedFrom
  ...
  {:db/ident :org/resultedFrom,
   ...
   #{#rdf/langString
     ...
     #rdf/langString "この組織になった（導いた、作成された）きっかけとなった出来事を示します。@ja"
     #rdf/langString
      "Evento que tiene como resultado la creación de una organización.@es"},
   :rdfs/domain :org/Organization,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label #{#rdf/langString "issue de@fr" #rdf/langString "risultato da@it"
                 #rdf/langString "resulted from@en"
                 #rdf/langString "es el resultado de@es"},
   :rdfs/range :org/ChangeEvent,
...
(def resultingOrganization
  ...
  {:db/ident :org/resultingOrganization,
   ...
   :rdf/type #{:owl/ObjectProperty :rdf/Property},
   :rdfs/comment
   #{#rdf/langString "出来事の結果、作成、変更された組織を示します。@ja"
     #rdf/langString
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label
   #{#rdf/langString "a donné naissance à@fr" #rdf/langString "resulted in@en"
     #rdf/langString "risultato in@it" #rdf/langString "resulta en@es"},
   :rdfs/range :org/Organization})
...
(def role
  ...
  {:db/ident :org/role,
   ...
   :rdfs/domain {:owl/unionOf [:org/Membership :org/Post],
                 :rdf/type    :owl/Class},
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label #{#rdf/langString "ruolo@it" #rdf/langString "rôle@fr"
                 #rdf/langString "desempeña la actividad de@es"
...
(def roleProperty
  ...
  {:db/ident :org/roleProperty,
   ...
   :rdfs/domain :org/Role,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label #{#rdf/langString "ruolo (proprietà)@it"
                 #rdf/langString "desempeña la actividad de (propiedad)@es"
                 #rdf/langString "role (property)@en"
                 #rdf/langString "rôle (propriété)@fr"},
...
(def siteAddress
  ...
  {:db/ident :org/siteAddress,
   ...
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label #{#rdf/langString "site Address@en"
                 #rdf/langString "adresse du Site@fr"
                 #rdf/langString "indirizzo della sede@it"
                 #rdf/langString "es la dirección de la sede@es"}})
...
(def siteOf
  ...
  {:db/ident :org/siteOf,
   ...
   #{#rdf/langString
     ...
     #rdf/langString "あるサイトである存在感を持っている組織を示します。@ja"
     #rdf/langString
   ...
   :rdfs/domain :org/Site,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label #{#rdf/langString "es sede de@es" #rdf/langString "sede di@it"
                 #rdf/langString "site de@fr" #rdf/langString "site Of@en"},
   :rdfs/range :org/Organization})
...
(def subOrganizationOf
  ...
  {:db/ident :org/subOrganizationOf,
   ...
   :rdf/type #{:owl/ObjectProperty :rdf/Property},
   :rdfs/comment
   #{#rdf/langString "組織または組織単位の階層的包含を表わします。この組織を含む組織を示します。@ja"
     #rdf/langString
   ...
   :rdfs/domain :org/Organization,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label #{#rdf/langString "sous-Organization de@fr"
                 #rdf/langString "es suborganización de@es"
                 #rdf/langString "sotto-Organization di@it"
                 #rdf/langString "subOrganization of@en"},
   :rdfs/range :org/Organization,
...
(def transitiveSubOrganizationOf
  ...
  {:db/ident :org/transitiveSubOrganizationOf,
   ...
   :rdfs/domain :org/Organization,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label #{#rdf/langString "sous-Organization transitive de@fr"
                 #rdf/langString "sotto-Organization transitiva@it"
                 #rdf/langString "es suborganización de (transitiva)@es"
                 #rdf/langString "transitive sub-organization@en"
                 #rdf/langString
                  "es suborganización de manera transitiva de@es"},
   :rdfs/range :org/Organization})
...
(def unitOf
  ...
  {:db/ident :org/unitOf,
   ...
   #{#rdf/langString
     ...
     #rdf/langString "例えば、より大きな組織内の部局など、この単位がその一部分である組織を示します。@ja"},
   :rdfs/domain :org/OrganizationalUnit,
   :rdfs/isDefinedBy {:rdfa/uri "http://www.w3.org/ns/org"},
   :rdfs/label #{#rdf/langString "unit Of@en" #rdf/langString "es unidad de@es"
                 #rdf/langString "unità di@it" #rdf/langString "unité de@fr"},
