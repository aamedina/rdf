...
(defmethod infer-datomic-cardinality :jsonschema/exclusiveMinimum [_] :db.cardinality/one)
(defmethod infer-datomic-cardinality :jsonschema/exclusiveMaximum [_] :db.cardinality/one)
(defmethod infer-datomic-cardinality :jsonschema/propertyName [_] :db.cardinality/one)
(defmethod infer-datomic-cardinality :jsonschema/minimum [_] :db.cardinality/one)
(defmethod infer-datomic-cardinality :jsonschema/maximum [_] :db.cardinality/one)
(defmethod infer-datomic-cardinality :jsonschema/minItems [_] :db.cardinality/one)
(defmethod infer-datomic-cardinality :jsonschema/maxItems [_] :db.cardinality/one)
(defmethod infer-datomic-cardinality :jsonschema/minLength [_] :db.cardinality/one)
(defmethod infer-datomic-cardinality :jsonschema/maxLength [_] :db.cardinality/one)
(defmethod infer-datomic-cardinality :jsonschema/multipleOf [_] :db.cardinality/one)
(defmethod infer-datomic-cardinality :jsonschema/readOnly [_] :db.cardinality/one)
(defmethod infer-datomic-cardinality :jsonschema/uniqueItems [_] :db.cardinality/one)
(defmethod infer-datomic-cardinality :jsonschema/writeOnly [_] :db.cardinality/one)
